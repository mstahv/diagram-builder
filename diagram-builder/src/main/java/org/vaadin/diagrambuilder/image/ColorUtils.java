...
public class ColorUtils {
     ...
     *
     * @param first  The first color to test.
     * @param second The second color to test.
     ...
     * @param rgb   The RGB value to test.
     * @param fuzzy The fuzziness of the match, i.e. the largest allowed
