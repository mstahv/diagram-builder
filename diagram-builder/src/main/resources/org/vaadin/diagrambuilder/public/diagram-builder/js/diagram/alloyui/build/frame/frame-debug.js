YUI.add('frame', function (Y, NAME) {
    ...
    Y.extend(Frame, Y.Plugin.Base, {
         ...
         * @param {String} cont The container to act as a delegate, if no "sel" passed, the body is assumed as the
         *     container.
        ...
        hide: function () {
            ...
            return this;
                  ...
                  * @deprecated
                  */
                 //HTML: '<iframe border="0" frameBorder="0" marginWidth="0" marginHeight="0" leftMargin="0"
                 // topMargin="0" allowTransparency="true" width="100%" height="99%"></iframe>',
                 /**
                  ...
                  * @static
                  * @method getDocType
                  * @description Parses document.doctype and generates a DocType to match the parent page, if
                  *     supported.
                  * For IE8, it grabs document.all[0].nodeValue and uses that. For IE < 8, it falls back to
                  *     Frame.DOC_TYPE.
                 ...
                 getDocType: function () {
                     ...
                     if (dt) {
                         str =
                             '<!DOCTYPE ' + dt.name + ((dt.publicId) ? ' ' + dt.publicId : '') + ((dt.systemId) ? ' '
                             + dt.systemId : '') + '>';
                     } else {
                         if (Y.config.doc.all) {
                  ...
                  * @static
                  * @property DOC_TYPE
                  * @description The DOCTYPE to prepend to the new document when created. Should match the one on the
                  *     page being served.
                  * @type String
                  */
                 ...
                 ATTRS: {
                     ...
                     /**
                      * @attribute use
                      * @description Array of modules to include in the scoped YUI instance at render time. Default:
                      *     ['none', 'selector-css2']
                      * @writeonce
                      * @type Array
                      */
