YUI.add('aui-toggler-base', function (A, NAME) {
    ...
    var Toggler = A.Component.create({
                                         ...
                                         headerEventHandler: function (event, instance) {
                                             if (event.type === instance.get('toggleEvent') || event.isKey('enter')
                                                 || event.isKey('space')) {
                                                 return instance.toggle();
                                             }
                                             else if (event.isKey('down') || event.isKey('right') || event.isKey(
                                                 'num_plus')) {
                                                 return instance.expand();
                                             }
                                             else if (event.isKey('up') || event.isKey('left') || event.isKey('esc')
                                                      || event.isKey('num_minus')) {
                                         ...
                                         prototype: {
                                             ...
                                             bindUI: function () {
                                                 ...
                                                 var eventHandles = [
                                                     instance.on('expandedChange',
                                                                 A.bind(instance._onExpandedChange, instance))
                                                 ];

                                                 if (instance.get('bindDOMEvents')) {
                                                     eventHandles.push(
                                                         header.on([instance.get('toggleEvent'), 'keydown'],
                                                                   A.rbind(Toggler.headerEventHandler, null, instance))
                                                     );
                                                 }
