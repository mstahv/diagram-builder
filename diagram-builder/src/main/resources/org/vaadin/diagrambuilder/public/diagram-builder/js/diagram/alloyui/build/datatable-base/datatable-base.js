                ...
                if (!this._eventHandles.legacyFeatureProps) {
                    this._eventHandles.legacyFeatureProps = this.view.after({
                                                                                renderHeader: function (e) {
                                                                                    ...
                                                                                    // This is here so that subscribers
                                                                                    // to renderHeader etc have access
                                                                                    // to this._tableNode from the DT
                                                                                    // instance
                                                                                    self._tableNode =
                                                                                ...
                                                                                // FIXME: guarantee that the properties
                                                                                // are available, even if the
                                                                                // configured (or omitted) views don't
                                                                                // create them
                                                                                renderTable: function () {
                                                                                    var contentBox = this.get(
                                                                                        'container');
                                                                                    ...
                                                                                    // FIXME: _captionNode isn't
                                                                                    // available until after
                                                                                    // renderTable unless in the
                                                                                    // renderX subs I look for it under
                                                                                    // the container's parentNode (to
                                                                                    // account for scroll breaking out
                                                                                    // the caption table).
                                                                                    self._captionNode =
                                                                                        this.captionNode ||
