YUI.add('aui-scheduler-view-day', function (A, NAME) {
    ...
    var Lang = A.Lang,
        ...
        TPL_SCHEDULER_VIEW_DAY_RESIZER = '<div class="' + CSS_SCHEDULER_VIEW_DAY_RESIZER + '">' +
                                         '<div class="' + [CSS_SCHEDULER_VIEW_DAY_ICON_GRIP_HORIZONTAL,
        ...
        TPL_SCHEDULER_VIEW_DAY_TABLE = '<table cellspacing="0" cellpadding="0" class="' + CSS_SCHEDULER_VIEW_DAY_TABLE +
                                       ...
                                       '<td height="0" class="' + [CSS_SCHEDULER_VIEW_DAY_TABLE_COL,
                ...
                ' ') + '"></td>' +
                                       ...
                                       '<td class="' + [CSS_SCHEDULER_VIEW_DAY_TABLE_COL,
                                                        CSS_SCHEDULER_VIEW_DAY_TABLE_COLTIME].join(' ') +
                                       '"></td>' +
                                       '</tr>' +
                                       '</tbody>' +
                                       '</table>',
    ...
    var SchedulerDayView = A.Component.create({
                                                  ...
                                                  ATTRS: {
                                                      ...
                                                      filterFn: {
                                                          value: function (evt) {
                                                              return (evt.get('visible') && evt.getHoursDuration() <= 24
                                                                      && !evt.get('allDay'));
                                                          }
                                                      },
                                                  ...
                                                  prototype: {
                                                      ...
                                                      /**
                                                       * Construction logic executed during `SchedulerDayView`
                                                      ...
                                                      bindUI: function () {
                                                          ...
                                                          instance.headerTableNode.delegate(
                                                              'click',
                                                              A.bind(instance._onClickDaysHeader, instance), '.'
                                                                                                             + CSS_SCHEDULER_VIEW_DAY_HEADER_DAY);
                                                      ...
                                                      /**
                                                       * Calculates and returns the value needed to get the `top`
                                                       * property give a `date`.
                                                       *
                                                       * @method calculateTop
                                                       * @param {Date} date
                                                       * @return {Number} The value needed to get the `top` property
                                                       *     give a
                                                       *     `date`.
                                                       */
                                                      ...
                                                      /**
                                                       * Returns the value of the date that follows the day view's
                                                       * current date.
                                                       *
                                                       * @method getNextDate
                                                       * @return {Date}
                                                      ...
                                                      /**
                                                       * Returns the value of the date that preceeds the day view's
                                                       * current date.
                                                       *
                                                       * @method getPrevDate
                                                       * @return {Date}
                                                       ...
                                                       * @param {Date} date
                                                       * @return {Number} The column `Node` determined by a given
                                                       *     `Date`.
                                                       */
                                                       ...
                                                       * @param {Date} date
                                                       * @return {Number} The column shim `Node` determined by a given
                                                       *     `Date`.
                                                       */
                                                      ...
                                                      getYCoordTime: function (top) {
                                                          ...
                                                          // Isolate the decimals and convert to minutes:
                                                          // (prop*100)%100*0.6.
                                                      ...
                                                      plotEvent: function (evt) {
                                                          ...
                                                          if (endShim) {
                                                              if (endShim.compareTo(startShim)
                                                                  || evt.isDayBoundaryEvent()) {
                                                                  paddingNode.hide();
                                                              }
                                                              else {
                                                      ...
                                                      /**
                                                       * Syncs the `SchedulerView` `eventsIntersection` instance.
                                                       * Lifecycle.
                                                       *
                                                      ...
                                                      syncEventTopUI: function (evt) {
                                                          ...
                                                          evt.get('node').item(0).setStyle(
                                                              'top', instance.calculateTop(evt.get('startDate'))
                                                                     + 'px');
                                                       ...
                                                       * @param {Array} xy The XY coords to compare to the starting XY
                                                       *     coords
                                                       */
                                                      ...
                                                      /**
                                                       * Returns a collection of `SchedulerEvents` as the parameter
                                                       * `events` that intersect with `evt`.
                                                       *
                                                       ...
                                                       *
                                                       * @method getTickY
                                                       * @return {Number} The nearest multiple of 10 to half the height
                                                       *     of this `SchedulerView`.
                                                       */
                                                      getTickY: function () {
                                                          var instance = this;
                                                      ...
                                                      _bindMouseEvents: function () {
                                                          ...
                                                          this.columnData.delegate(
                                                              'mouseenter', A.bind(this._onMouseEnterEvent, this), '.'
                                                                                                                   + CSS_SCHEDULER_EVENT);

                                                          this.columnData.delegate(
                                                              'mouseleave', A.bind(this._onMouseLeaveEvent, this), '.'
                                                                                                                   + CSS_SCHEDULER_EVENT);
                                                      ...
                                                      /**
                                                       * Binds the listener that updates the current time marker every
                                                       * minute.
                                                       *
                                                      ...
                                                      /**
                                                       * Aligns the dragging `SchedulerEvent` to the X axis while bound
                                                       * to the Y axis on the `activeColumn`.
                                                       *
                                                      ...
                                                      /**
                                                       * Aligns the dragging `SchedulerEvent` to the Y axis by either
                                                       * setting the end date if the event is a `resize`, or moves the
                                                       * event otherwise.
                                                       *
                                                      ...
                                                      /**
                                                       * Move the red line representing the current time to a specific
                                                       * point, determined by the given {Date} object.
                                                       *
                                                      ...
                                                      _onEventDragStart: function () {
                                                          ...
                                                          if (draggingEvent) {
                                                              ...
                                                              instance.startColNumber =
                                                                  startColumn ? toNumber(
                                                                      startColumn.attr('data-colnumber')) : 0;
                                                          }
                                                      },
                                                      ...
                                                      _onGestureMoveTableCol: function (event) {
                                                          ...
                                                          if (creationStartDate) {
                                                              ...
                                                              if (instance._delta !== delta) {
                                                                  if (delta > 0) {
                                                                      var newDelta = down ? Math.max(delta,
                                                                                                     recorder.get(
                                                                                                         'duration'))
                                                                                          : delta;
                                                              ...
                                                              buffer.push(
                                                                  Lang.sub(
                                                                      TPL_SCHEDULER_VIEW_DAY_TABLE_TIME, {
                                                                          hour: isoTime ? DateMath.toIsoTimeString(hour)
                                                                                        : DateMath.toUsTimeString(hour,
                                                                                                                  false,
                                                                                                                  true)
                                                                      }
                                                                  )
