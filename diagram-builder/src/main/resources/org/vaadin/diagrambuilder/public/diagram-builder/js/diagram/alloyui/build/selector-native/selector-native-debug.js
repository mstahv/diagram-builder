        ...
        var Selector = {
            ...
            _nativeQuery: function (selector, root, one) {
                ...
                try {
                    ...
                    //Y.log('native query error; reverting to brute query with: ' + selector, 'info',
                    // 'selector-native');
             ...
             * @param {HTMLElement} root optional A node to start the query from. Defaults to the parent document of
             *     the node.
