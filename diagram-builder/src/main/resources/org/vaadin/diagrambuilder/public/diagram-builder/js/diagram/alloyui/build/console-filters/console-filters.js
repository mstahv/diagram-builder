YUI.add('console-filters', function (Y, NAME) {
     ...
     *
     * <p>This plugin adds the ability to control which Console entries display by filtering on category and source.
     * Two groups of checkboxes are added to the Console footer, one for categories and the other for sources.  Only
     * those messages that match a checked category or source are displayed.</p>
     *
...
// Some common strings and functions
    ...
    Y.namespace('Plugin').ConsoleFilters = Y.extend(ConsoleFilters, Y.Plugin.Base,
                                                    ...
                                                    {
                                                        /**
                                                         * Collection of all log messages passed through since the
                                                         * plugin's instantiation.  This holds all messages regardless
                                                         * of filter status. Used as a single source of truth for
                                                         * repopulating the Console body when filters are changed.
                                                         *
                                                         * @property _entries
                                                         * @type Array
                                                         * @protected
                                                        ...
                                                        /**
                                                         * Initialize entries collection and attach listeners to host
                                                         * events and methods.
                                                         *
                                                         * @method initializer
                                                         * @protected
                                                         ...
                                                         */
                                                        destructor: function () {
                                                            //TODO: grab last {consoleLimit} entries and update the
                                                            // console with them (no filtering)
                                                            this._entries = [];
                                                        ...
                                                        /**
                                                         * Adds the category and source filter sections to the Console
                                                         * footer.
                                                         *
                                                         * @method renderUI
                                                         * @protected
                                                        ...
                                                        renderUI: function () {
                                                            ...
                                                            if (foot) {
                                                                ...
                                                                this._categories =
                                                                    foot.appendChild(Y.Node.create(html));
                                                        ...
                                                        /**
                                                         * Binds to checkbox click events and internal attribute change
                                                         * events to maintain the UI state.
                                                         *
                                                         * @method bindUI
                                                         * @protected
                                                         */
                                                        bindUI: function () {
                                                            this._categories.on('click',
                                                                                Y.bind(this._onCategoryCheckboxClick,
                                                                                       this));

                                                            this._sources.on('click',
                                                                             Y.bind(this._onSourceCheckboxClick, this));
                                                        ...
                                                        /**
                                                         * Updates the UI to be in accordance with the current state of
                                                         * the plugin.
                                                         *
                                                         * @method syncUI
                                                         */
                                                        ...
                                                        /**
                                                         * Ensures a filter is set up for any new categories or sources
                                                         * and collects the messages in _entries.  If the message is
                                                         * stamped with a category or source that is currently being
                                                         * filtered out, the message will not pass to the Console's
                                                         * print buffer.
                                                         *
                                                         * @method _onEntry
                                                        ...
                                                        /**
                                                         * Flushes the cached entries after a call to the Console's
                                                         * clearConsole().
                                                         *
                                                         ...
                                                         * changes value (e.g. visible => hidden).  Updates the
                                                         * appropriate checkbox's checked state if necessary.
                                                         *
                                                        ...
                                                        /**
                                                         * Flushes the Console's print buffer of any entries that have
                                                         * a category or source that is currently being excluded.
                                                         *
                                                        ...
                                                        _filterBuffer: function () {
                                                            ...
                                                            for (i = buffer.length - 1; i >= 0; --i) {
                                                                if (!cats[buffer[i].category]
                                                                    || !srcs[buffer[i].source]) {
                                                                    start = start || i;
                                                                } else if (start) {
                                                        ...
                                                        /**
                                                         * Repopulates the Console with entries appropriate to the
                                                        ...
                                                        refreshConsole: function () {
                                                            ...
                                                            if (body) {
                                                                ...
                                                                for (i = entries.length - 1; i >= 0 && remaining >= 0;
                                                                     --i) {
                                                                    e = entries[i];
                                                        ...
                                                        /**
                                                         * Updates the checked property of a filter checkbox of the
                                                         * specified type. If no checkbox is found for the input
                                                         * params, one is created.
                                                         *
                                                         * @method _uiSetCheckbox
                                                         * @param type {String} 'category' or 'source'
                                                         * @param item {String} the name of the filter (e.g. 'info',
                                                         *     'event')
                                                         * @param checked {Boolean} value to set the checkbox's checked
                                                         *     property
                                                         * @protected
                                                         */
                                                        ...
                                                        _onCategoryCheckboxClick: function (e) {
                                                            ...
                                                            if (t.hasClass(ConsoleFilters.CHROME_CLASSES.filter)) {
                                                                ...
                                                                if (cat && cat in this.get(CATEGORY)) {
                                                                    this.set(CATEGORY_DOT + cat, t.get(CHECKED),
                                                                                                 {fromUI: true});
                                                                }
                                                            }
                                                        },
                                                        ...
                                                        _onSourceCheckboxClick: function (e) {
                                                            ...
                                                            if (t.hasClass(ConsoleFilters.CHROME_CLASSES.filter)) {
                                                                ...
                                                                if (src && src in this.get(SOURCE)) {
                                                                    this.set(SOURCE_DOT + src, t.get(CHECKED),
                                                                                               {fromUI: true});
                                                                }
                                                            }
                                                        },
                                                        ...
                                                        /**
                                                         * Hides any number of categories from the UI.  Convenience
                                                         * method for myConsole.filter.set('category.foo', false);
                                                         * set('category.bar', false); and so on.
                                                         *
                                                         * @method hideCategory
                                                        ...
                                                        /**
                                                         * Shows any number of categories in the UI.  Convenience
                                                         * method for myConsole.filter.set('category.foo', true);
                                                         * set('category.bar', true); and so on.
                                                         *
                                                         * @method showCategory
                                                         * @param cat* {String} 1..n categories to allow to display in
                                                         *     the UI
                                                         */
                                                        ...
                                                        /**
                                                         * Hides any number of sources from the UI.  Convenience method
                                                         * for myConsole.filter.set('source.foo', false);
                                                         * set('source.bar', false); and so on.
                                                         *
                                                         * @method hideSource
                                                        ...
                                                        /**
                                                         * Shows any number of sources in the UI.  Convenience method
                                                         * for myConsole.filter.set('source.foo', true);
                                                         * set('source.bar', true); and so on.
                                                         *
                                                         * @method showSource
                                                         * @param src* {String} 1..n sources to allow to display in the
                                                         *     UI
                                                         */
                                                        ...
                                                        /**
                                                         * Creates a checkbox and label from the
                                                         * ConsoleFilters.FILTER_TEMPLATE for the provided type and
                                                         * name.  The checkbox and label are appended to the container
                                                         * node passes as the first arg.
                                                         *
                                                         * @method _createCheckbox
                                                         * @param container {Node} the parentNode of the new checkbox
                                                         *     and label
                                                        ...
                                                        /**
                                                         * Validates category updates are objects and the subattribute
                                                         * is not too deep.
                                                         *
                                                        ...
                                                        _validateCategory: function (cat, v) {
                                                            return Y.Lang.isObject(v, true) && cat.split(/\./).length
                                                                   < 3;
                                                        },

                                                        /**
                                                         * Validates source updates are objects and the subattribute is
                                                         * not too deep.
                                                         *
                                                        ...
                                                        _validateSource: function (src, v) {
                                                            return Y.Lang.isObject(v, true) && src.split(/\./).length
                                                                   < 3;
                                                        },

                                                        /**
                                                         * Setter method for cacheLimit attribute.  Basically a
                                                         * validator to ensure numeric input.
                                                         *
                                                    ...
                                                    // Y.Plugin.ConsoleFilters static properties
                                                    {
                                                        ...
                                                        /**
                                                         * The namespace hung off the host object that this plugin will
                                                         * inhabit.
                                                         *
                                                         * @property NS
                                                         * @type String
                                                        ...
                                                        /**
                                                         * Markup template used to create the container for the
                                                         * category filters.
                                                         *
                                                        ...
                                                        /**
                                                         * Markup template used to create the container for the source
                                                         * filters.
                                                         *
                                                        ...
                                                        /**
                                                         * Markup template used to create the category and source
                                                         * filter checkboxes.
                                                         *
                                                         ...
                                                         */
                                                        FILTER_TEMPLATE:
                                                        // IE8 and FF3 don't permit breaking _between_ nowrap elements.
                                                        //  IE8 doesn't understand (non spec) wbr tag, nor does it
                                                        // create text nodes for spaces in innerHTML strings.  The
                                                        // thin-space entity suffices to create a breakable point.
                                                        ...
                                                        ATTRS: {
                                                            ...
                                                            /**
                                                             * <p>Map of entry categories to their visibility status.
                                                             * Update a particular category's visibility by setting the
                                                             * subattribute to true
                                                             * (visible) or false (hidden).</p>
                                                             *
                                                             * <p>For example, yconsole.filter.set('category.info',
                                                             * false) to hide log entries with the category/logLevel of
                                                             * 'info'.</p>
                                                             *
                                                             * <p>Similarly, yconsole.filter.get('category.warn') will
                                                             * return a boolean indicating whether that category is
                                                             * currently being included in the UI.</p>
                                                             *
                                                             * <p>Unlike the YUI instance configuration's logInclude
                                                             * and logExclude properties, filtered entries are only
                                                             * hidden from the UI, but can be made visible again.</p>
                                                             *
                                                             * @attribute category
                                                             * @type Object
                                                             */
                                                            ...
                                                            /**
                                                             * <p>Map of entry sources to their visibility status.
                                                             * Update a particular sources's visibility by setting the
                                                             * subattribute to true
                                                             * (visible) or false (hidden).</p>
                                                             *
                                                             * <p>For example, yconsole.filter.set('sources.slider',
                                                             * false) to hide log entries originating from
                                                             * Y.Slider.</p>
                                                             *
                                                             * @attribute source
                                                             * @type Object
                                                            ...
                                                            /**
                                                             * Maximum number of entries to store in the message cache.
                                                             *  Use this to limit the memory footprint in environments
                                                             * with heavy log usage. By default, there is no limit
