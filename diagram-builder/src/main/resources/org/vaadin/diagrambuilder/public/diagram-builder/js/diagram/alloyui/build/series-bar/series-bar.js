                        ...
                        if (renderer && renderer !== undefined) {
                            renderer.set("y", (ys[n] - seriesSize / 2));
                                    ...
                                    ATTRS: {
                                        ...
                                        /**
                                         * Indicates the direction of the category axis that the bars are plotted
                                         * against.
                                         *
                                         * @attribute direction
                                         * @type String
                                         ...
                                         * `MarkerSeries`. Below are the default values:
                                         *  <dl>
                                         ...
                                         * the marker fill. The default value is 1.</dd>
                                         *          </dl>
                                         *      </dd>
                                         ...
                                         *              <dt>alpha</dt><dd>Number from 0 to 1 indicating the opacity of
                                         * the marker border. The default value is 1.</dd>
                                         *              <dt>weight</dt><dd>Number indicating the width of the border.
                                         * The default value is 1.</dd>
                                         *          </dl>
                                         *      </dd>
                                         *      <dt>height</dt><dd>indicates the width of the marker. The default value
                                         * is 12.</dd>
                                         *      <dt>over</dt><dd>hash containing styles for markers when highlighted by
                                         * a `mouseover` event. The default values for each style is null. When an over
                                         * style is not set, the non-over value will be used. For example, the default
                                         * value for `marker.over.fill.color` is equivalent to
