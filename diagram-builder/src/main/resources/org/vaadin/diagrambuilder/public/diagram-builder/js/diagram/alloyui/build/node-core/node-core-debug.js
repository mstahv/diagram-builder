...
// end "globals"
     ...
     * @class NodeList
     * @constructor
     * @param nodes {String|element|Node|Array} A selector, DOM element, Node, list of DOM elements, or list of Nodes
     *     with which to populate this NodeList.
     */
     ...
     * @param {String} [altName] An alternative name to use for the method added to NodeList, which may differ from the
     *     name of the original host object. Has no effect if <em>name</em> is an array of method names.
     */
...
// e.g. Y.all('input').get('parentNode');
    ...
    var Y_NodeList = Y.NodeList,
        ...
        ArrayMethods = {
             ...
             * @param {Number} end Zero-based index at which to end extraction. slice extracts up to but not including
             *     end.
             ...
             *     0, no elements are removed. In this case, you should specify at least one new element. If no howMany
             *     parameter is specified (second syntax above, which is a SpiderMonkey extension), all elements after
             *     index are removed.
