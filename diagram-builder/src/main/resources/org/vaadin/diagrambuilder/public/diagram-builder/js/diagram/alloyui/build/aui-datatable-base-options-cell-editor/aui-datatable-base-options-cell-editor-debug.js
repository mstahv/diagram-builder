YUI.add('aui-datatable-base-options-cell-editor', function (A, NAME) {
    ...
    BaseOptionsCellEditor = A.Component.create({
                                                   ...
                                                   ATTRS: {
                                                       /**
                                                        * Static property of input formatter for modifying the data
                                                        * values for showing on the UI.
                                                        *
                                                       ...
                                                       /**
                                                        * Indicates if the options Edit Container is hidden on the
                                                        * `save` event.
                                                        *
                                                               ...
                                                               return {
                                                                   'uniqueValue': {
                                                                       condition: function (fieldValue, fieldNode) {
                                                                           ...
                                                                           var validate = function (validateNode,
                                                                                                    nodelist, recurse) {
                                                                           ...
                                                                           return validate(fieldNode,
                                                                                           inputValueNodelist, true);
                                                                       },
                                                       ...
                                                       /**
                                                        * Static property of output formatter for modifying the data
                                                        * values for output.
                                                        *
                                                        * Default `null` Function will not modify the value.
                                                        *
                                                   ...
                                                   prototype: {
                                                       ...
                                                       EDIT_OPTION_ROW_TEMPLATE: '<div class="form-inline '
                                                                                 + CSS_CELLEDITOR_EDIT_OPTION_ROW + '">'
                                                                                 +
                                                                                 '<div class="form-group">' +
                                                                                 '<span class="'
                                                                                 + [CSS_CELLEDITOR_EDIT_DD_HANDLE,
                                                                                    CSS_ICON,
                                                                                    CSS_ICON_GRIP_DOTTED_VERTICAL].join(
                                                           ' ') + '"></span>' +
                                                                                 '</div>' +
                                                                                 '<div class="form-group">' +
                                                                                 ...
                                                                                 +
                                                                                 '<input class="'
                                                                                 + CSS_CELLEDITOR_EDIT_INPUT_NAME
                                                       ...
                                                       initializer: function () {
                                                           ...
                                                           A.FormValidator.addCustomRules(
                                                               instance.get('optionsValidatorCustomRules'));
                                                       },

                                                       /**
                                                        * Adds a new option to the `A.BaseOptionsCellEditor`.
                                                        *
                                                        * If `name` or `value` is omitted, a blank string is used in
                                                        * it's place.
                                                        *
                                                        * @method addNewOption
                                                        * @param name
                                                       ...
                                                       /**
                                                        * Removes the given `optionRow` Node from
                                                        * `A.BaseOptionsCellEditor`.
                                                        *
                                                        * @method removeOption
                                                        * @param optionRow
                                                       ...
                                                       saveOptions: function () {
                                                           ...
                                                           if (editContainer && !editContainer.hasAttribute('hidden')) {
                                                               var names = editContainer.all('.'
                                                                                             + CSS_CELLEDITOR_EDIT_INPUT_NAME);
                                                               var values = editContainer.all('.'
                                                                                              + CSS_CELLEDITOR_EDIT_INPUT_VALUE);
                                                               var options = {};
                                                       ...
                                                       _createOptions: function (val) {
                                                           ...
                                                           var optionsNodeList = A.NodeList.create(
                                                               optionsBuffer.join(''));
                                                           var wrappersNodeList = A.NodeList.create(
                                                               wrappersBuffer.join(''));
                                                        ...
                                                        * @protected
                                                        * @return {String} HTML string for the
                                                        *     `A.BaseOptionsCellEditor`.
                                                        */
                                                        ...
                                                        * @protected
                                                        * @return {String} HTML string for the
                                                        *     `A.BaseOptionsCellEditor` input option.
                                                        */
                                                       ...
                                                       /**
                                                        * Default callback for `initEdit` event of
                                                        * `A.BaseOptionsCellEditor`.
                                                        *
                                                       ...
                                                       _defInitEditFn: function () {
                                                           ...
                                                           editContainer.delegate('click',
                                                                                  A.bind(instance._onEditLinkClickEvent,
                                                                                         instance), '.' +
                                                                                                    CSS_CELLEDITOR_EDIT_LINK);
                                                           editContainer.delegate('keydown',
                                                                                  A.bind(instance._onEditKeyEvent,
                                                                                         instance), 'input');
                                                       ...
                                                       /**
                                                        * Updates the option state on the UI on event `click` on the
                                                        * edit link.
                                                        *
                                                       ...
                                                       _onEditLinkClickEvent: function (event) {
                                                           ...
                                                           else if (currentTarget.test('.'
                                                                                       + CSS_CELLEDITOR_EDIT_HIDE_OPTION)) {
                                                               instance.toggleEdit();
                                                           }
                                                           else if (currentTarget.test('.'
                                                                                       + CSS_CELLEDITOR_EDIT_DELETE_OPTION)) {
                                                       ...
                                                       /**
                                                        * Listen to `keydown` event on `A.BaseOptionsCellEditor` to
                                                       ...
                                                       _syncEditOptionsUI: function () {
                                                           ...
                                                           instance.editContainer.setContent(
                                                               instance._createEditBuffer());
                                                       },
                                                       ...
                                                       /**
                                                        * Sets the `selectedAttrName` (`selected`) attribute on the
                                                        * option elements matching `val`.
                                                        *
                                                        * @method _uiSetValue
                                                       ...
                                                       _uiSetValue: function (val) {
                                                           ...
                                                           if (optionsNodeList && optionsNodeList.size()) {
                                                               optionsNodeList.set(instance.get('selectedAttrName'),
                                                                                   false);
                                                               ...
                                                               if (L.isValue(val)) {
                                                                   ...
                                                                   A.Array.each(val, function (value) {
                                                                       optionsNodeList.filter('[value="' + AEscape.html(
                                                                           L.trim(value)) + '"]').set(instance.get(
