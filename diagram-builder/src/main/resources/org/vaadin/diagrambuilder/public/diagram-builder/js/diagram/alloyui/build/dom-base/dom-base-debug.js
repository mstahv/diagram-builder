    ...
    Y.mix(Y_DOM, {
        ...
        setAttribute: function (el, attr, val, ieAttr) {
            if (el && attr && el.setAttribute) {
                ...
                Y.log('bad input to setAttribute', 'warn', 'dom');
            }
        },
        ...
        getAttribute: function (el, attr, ieAttr) {
            ...
            if (el && attr && el.getAttribute) {
                ...
                ret =
                    (el.tagName === "BUTTON" && attr === 'value') ? Y_DOM.getValue(el) : el.getAttribute(attr, ieAttr);
                ...
                Y.log('bad input to getAttribute', 'warn', 'dom');
            }
            return ret;
        },
