    ...
    Y.mix(Mutable.prototype, {
        ...
        _defAddColumnFn: function (e) {
            ...
            if (cols) {
                ...
                Y.log('addColumn index not findable', 'warn', 'datatable');
            }
        },
        ...
        _defModifyColumnFn: function (e) {
            ...
            if (column) {
                ...
                Y.log('Could not locate column index to modify column', 'warn', 'datatable');
            }
        },
            ...
            if (column) {
                ...
                if (fromIndex > -1) {
                    ...
                    if (toCols) {
                        ...
                        Y.log('Column [' + e.column + '] could not be moved. Destination index invalid for moveColumn',
                            'warn', 'datatable');
                    }
                }
            } else {
                Y.log('Column [' + e.column + '] not found for moveColumn', 'warn', 'datatable');
            }
        },
        ...
        _defRemoveColumnFn: function (e) {
            ...
            if (column) {
                ...
                Y.log('Could not locate column [' + e.column + '] for removeColumn', 'warn', 'datatable');
            }
        },
