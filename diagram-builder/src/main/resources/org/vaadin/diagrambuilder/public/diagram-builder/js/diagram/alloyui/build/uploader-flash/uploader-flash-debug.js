...
// Shorthands for external modules
     ...
     * @param {Object} p_oAttributes (optional) Configuration parameters for the Flash application and values for
     *     Flashvars to be passed to the SWF. The p_oAttributes object allows the following additional properties:
     *        <dl>
     *          <dt>version : String</dt>
     *          <dd>The minimum version of Flash required on the user's machine.</dd>
     *          <dt>fixedAttributes : Object</dt>
     *          <dd>An object literal containing one or more of the following String keys and their values:
     *     <code>align,
     *              allowFullScreen, allowNetworking, allowScriptAccess, base, bgcolor, menu, name, quality, salign,
     *     scale, tabindex, wmode.</code> event from the thumb</dd>
     *        </dl>
     */
    ...
    function SWF(p_oElement /*:String*/, swfURL /*:String*/, p_oAttributes /*:Object*/) {
        ...
        if (oElement && (isFlashVersionRight || shouldExpressInstall) && flashURL) {
            ...
            objstring += "</object>";
            //using innerHTML as setHTML/setContent causes some issues with ExternalInterface for IE versions of the
            // player
    ...
    Y.extend(FileFlash, Y.Base, {
            ...
            if (event.id === this.get("id")) {
                switch (event.type) {
                    ...
                    case "uploadcomplete":
                        ...
                        /**
                         * Signals that this file's upload has completed, but data has not yet been received from the
                         * server.
                         *
         ...
         * @param parameters {Object} (optional) A set of key-value pairs to send as variables along with the file
         *     upload HTTP request.
         * @param fileFieldName {String} (optional) The name of the POST variable that should contain the uploaded file
         *     ('Filedata' by default)
         */
            ...
            if (this.get("uploader")) {
                ...
                this.fire("uploadcancel");
                 ...
                 ATTRS: {
                     ...
                     /**
                      * The date that the file wrapped by FileFlash was created on. This value is supplied by the Flash
                      * player uploader.
                      *
                     ...
                     /**
                      * The date that the file wrapped by FileFlash was last modified on. This value is supplied by the
                      * Flash player uploader.
                      *
    ...
    Y.UploaderFlash = Y.extend(UploaderFlash, Y.Widget, {
                                   ...
                                   initializer: function () {
                                        ...
                                        *      <dt>percentLoaded</dt>
                                        *          <dd>The fraction of the file list that has been uploaded, out of
                                        *     100</dd>
                                        *  </dl>
                                        */
                                        ...
                                        *  <dl>
                                        *      <dt>file</dt>
                                        *          <dd>The pointer to the instance of `Y.File` whose upload has been
                                        *     completed.</dd>
                                        *      <dt>originEvent</dt>
                                        ...
                                        *      <dt>file</dt>
                                        *          <dd>The pointer at the instance of Y.FileFlash that returned the
                                        *     error.</dd>
                                        *      <dt>source</dt>
                                        *          <dd>The source of the upload error, either "io" or "http"</dd>
                                        *      <dt>message</dt>
                                        *          <dd>The message that accompanied the error. Corresponds to the text
                                        *     of the error in cases where source is "io", and to the HTTP status for
                                   ...
                                   /**
                                    * Attaches keyboard bindings to enabling tabbing to and from the instance of the
                                    * Flash player in the Uploader widget. If the previous and next elements are
                                    * specified, the keyboard bindings enable the user to tab from the
                                    * `tabElements["from"]` node to the Flash-powered "Select Files" button, and to the
                                    * `tabElements["to"]` node.
                                    *
                                    * @method _attachTabElements
                                    * @protected
                                    * @param ev {Event} Optional event payload if called as a `tabElementsChange`
                                    *     handler.
                                    */
                                   _attachTabElements: function () {
                                       if (this.get("tabElements") !== null && this.get("tabElements").from !== null && this.get("tabElements").to
                                           !== null) {
                                    ...
                                    * @protected
                                    * @param state {String} The name of the state enumerated in `buttonClassNames`
                                    *     attribute from which to derive the needed class name.
                                   ...
                                   /**
                                    * Syncs the state of the `fileFilters` attribute between the instance of
                                    * UploaderFlash and the Flash player.
                                    *
                                    ...
                                    * @param url {String} The URL to upload the file to.
                                    * @param [postVars] {Object} A set of key-value pairs to send as variables along
                                    *     with the file upload HTTP request. If not specified, the values from the
                                    *     attribute `postVarsPerFile` are used instead.
                                    */
                               ...
                               {
                                   /**
                                    * The template for the Flash player container. Since the Flash player container
                                    * needs to completely overlay the &lquot;Select Files&rqot; control, it's
                                    * positioned absolutely, with width and height set to 100% of the parent.
                                    *
                                    * @property FLASH_CONTAINER
                                    * @type {String}
                                    * @static
                                    * @default '<div id="{swfContainerId}" style="position:absolute; top:0px; left:
                                    *     0px; margin: 0; padding: 0; border: 0; width:100%; height:100%"></div>'
                                    */
                                    ...
                                    * @type {String}
                                    * @static
                                    * @default "<button type='button' class='yui3-button'
                                    *     tabindex='-1'>{selectButtonLabel}</button>"
                                    */
                                   ...
                                   ATTRS: {
                                        ...
                                        * <ul>
                                        *   <li> <strong>`hover`</strong>: the class corresponding to mouse hovering
                                        * over the "Select Files" button.</li>
                                        *   <li> <strong>`active`</strong>: the class corresponding to mouse down state
                                        * of the "Select Files" button.</li>
                                        *   <li> <strong>`disabled`</strong>: the class corresponding to the disabled
                                        * state of the "Select Files" button.</li>
                                        *   <li> <strong>`focus`</strong>: the class corresponding to the focused state
                                        * of the "Select Files" button.</li>
                                        * </ul>
        ...
        *          }
                                       ...
                                       /**
                                        * The action  performed when an upload error occurs for a specific file being
                                        * uploaded. The possible values are:
                                        * <ul>
                                        *   <li> <strong>`UploaderQueue.CONTINUE`</strong>: the error is ignored and
                                        * the upload process is continued.</li>
                                        *   <li> <strong>`UploaderQueue.STOP`</strong>: the upload process is stopped
                                        * as soon as any other parallel file uploads are finished.</li>
                                        *   <li> <strong>`UploaderQueue.RESTART_ASAP`</strong>: the file is added back
                                        * to the front of the queue.</li>
                                        *   <li> <strong>`UploaderQueue.RESTART_AFTER`</strong>: the file is added to
        ...
        * }
                                       ...
                                       /**
                                        * The URL to which file upload requested are POSTed. Only used if a different
                                        * url is not passed to the upload method call.
                                        *
                                        * @attribute uploadURL
                                        * @type {String}
                                        * @default ""
