...
// doesn't use NodeList.importMethod because we need real Nodes (not tmpNode)
     ...
     * @method unplug
     * @for NodeList
     * @param {String | Function} plugin The namespace of the plugin, or the plugin class with the static NS namespace
     *     property defined. If not provided, all registered plugins are unplugged.
     * @chainable
     */
