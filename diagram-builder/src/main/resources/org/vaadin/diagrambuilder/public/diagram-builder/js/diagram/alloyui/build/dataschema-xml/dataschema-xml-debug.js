    ...
    SchemaXML = {
        ...
        apply: function (schema, data) {
            ...
            if (xmldoc && okNodeType[xmldoc.nodeType] && schema) {
                ...
                Y.log("XML data could not be schema-parsed: " + Y.dump(data) + " " + Y.dump(data), "error",
                                                                                                   "dataschema-xml");
        ...
        _getXPathResult: function (locator, context, xmldoc) {
            ...
            if (!Lang.isUndefined(xmldoc.evaluate)) {
                return xmldoc.evaluate(locator, context, xmldoc.createNSResolver(
                    context.ownerDocument ? context.ownerDocument.documentElement : context.documentElement), 0, null);
