YUI.add('series-base', function (Y, NAME) {
    ...
    Y.SeriesBase = Y.Base.create("seriesBase", Y.Base, [Y.Renderer], {
        ...
        /**
         * Collection of default colors used for area fills, histogram fills and pie fills in a series when not
         * specified by user.
         *
        ...
        _getDefaultColor: function (index, type) {
            ...
            return colors[type][index];
                                     ...
                                     ATTRS: {
                                          ...
                                          * a reference to the `Graphic` instance that the series is drawn into will be
                                          * returned.
                                          *
                                          * @attribute chart
                                          * @type ChartBase
                                         ...
                                         /**
                                          * Indicates whether or not markers for a series will be grouped and rendered
                                          * in a single complex shape instance.
                                          *
