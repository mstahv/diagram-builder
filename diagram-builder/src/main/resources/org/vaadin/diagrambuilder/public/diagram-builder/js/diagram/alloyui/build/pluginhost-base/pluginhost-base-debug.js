                ...
                if (Plugin && Plugin.NS) {
                    ...
                    if (this.hasPlugin(ns)) {
                        ...
                        if (this[ns].setAttrs) {
                            ...
                            Y.log("Attempt to replug an already attached plugin, and we can't setAttrs, because it's not Attribute based: "
                                  + ns, "warn", "PluginHost");
                        }
                    } else {
                        // Create new instance
                    ...
                    Y.log("Attempt to plug in an invalid plugin. Host:" + this + ", Plugin:" + Plugin, "error",
                                                                                                       "PluginHost");
                }
            }
            return this;
