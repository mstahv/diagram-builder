YUI.add('recordset-base', function (Y, NAME) {
    ...
    var Record = Y.Base.create('record', Y.Base, [], {
                                    ...
                                    *
                                    * @param field {string} (optional) The key to retrieve the value from. If not
                                    *     supplied, the entire object is returned.
                                    * @method getValue
                                    * @public
                                    */
    ...
    var ArrayList = Y.ArrayList,
        ...
        Recordset = Y.Base.create('recordset', Y.Base, [], {
            ...
            initializer: function () {
                ...
                // 1. Instantiating new Y.Recordset() will not go into the setter of "records", and so it is necessary
                // to create this._items in the initializer. 2. Instantiating new Y.Recordset({records: [{...}]}) will
                // call the setter of "records" and create this._items. In this case, we don't want that to be
                // overwritten by [].
                if (!this._items) {
                    this._items = [];
                }
            ...
            /**
             * Adds one or more Records to the RecordSet at the given index. If index is null, then adds the Records to
             * the end of the RecordSet.
             *
             * @method add
             * @param {Record|Object|Array} oData A Y.Record instance, An object literal of data or an array of object
             *     literals
