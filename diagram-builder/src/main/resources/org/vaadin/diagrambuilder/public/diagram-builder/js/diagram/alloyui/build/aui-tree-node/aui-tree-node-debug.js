YUI.add('aui-tree-node', function (A, NAME) {
    ...
    var TreeNode = A.Component.create({
                                          ...
                                          prototype: {
                                              ...
                                              _createNodeContainer: function () {
                                                  ...
                                                  var nodeContainer = instance.get('container') || A.Node.create(
                                                      NODE_CONTAINER_TPL);
                                              ...
                                              _syncHitArea: function () {
                                                  ...
                                                  if (instance.get('alwaysShowHitArea')
                                                      || instance.getChildrenLength()) {
                                                  ...
                                                  if (ownerTree) {
                                                      ...
                                                      var expanded = instance.get('expanded'),
                                                          ...
                                                          icon = instance.isLeaf() ?
                                                                 cssClasses.iconLeaf :
                                                                 (expanded ? cssClasses.iconExpanded
                                                                           : cssClasses.iconCollapsed),
                                                    ...
                                                    if (ownerTree) {
                                                        if (!instance.get('io')) {
                                                            var io = A.clone(
                                                                ...
                                                                true,
                                                                function (value) {
                                                                    if (isFunction(value) && (value.defaultFn
                                                                                              || value.wrappedFn)) {
                                                                        return false;
                                                                    }
    ...
    var TreeNodeTask = A.Component.create({
                                              ...
                                              prototype: {
                                                  ...
                                                  /**
                                                   * Adds the class `tree-node-child-unchecked` to all checked ancestor
                                                   * TreeNodeTasks.
                                                   *
                                                      ...
                                                      instance.eachParent(
                                                          function (parentNode) {
                                                              if (isTreeNodeTask(parentNode)
                                                                  ...
                                                                  parentNode.get('contentBox')
                                                                      .addClass(CSS_TREE_NODE_CHILD_UNCHECKED);
                                                              }
                                                          }
                                                      );
                                                  },
                                                  ...
                                                  /**
                                                   * Removes the class `tree-node-child-unchecked` from ancestor
                                                   * TreeNodeTasks, when all descendant TreeNodeTasks are checked.
                                                   *
                                                      ...
                                                      instance.eachParent(
                                                          function (parentNode) {
                                                              if (isTreeNodeTask(parentNode)
                                                                  ...
                                                                  parentHasUncheckedDescendants =
                                                                      A.Array.some(children, function (child) {
                                                                          if ((child !== instance)
                                                                              && !child.isChecked()) {
                                                                              return true;
                                                                          }
                                                                  ...
                                                                  if (!parentHasUncheckedDescendants) {
                                                                      parentNode.get('contentBox')
                                                                          .removeClass(CSS_TREE_NODE_CHILD_UNCHECKED);
                                                                  }
                                                              }
                                                          }
                                                      );
