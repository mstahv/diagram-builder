YUI.add('io-form', function (Y, NAME) {
     ...
     * @param {Object|String} [options.extra] Extra values to include. May be a query string or an object with
     *     key/value pairs.
     * @return {String}
     */
    Y.IO.stringify = function (form, options) {
        ...
        var s = Y.IO.prototype._serialize({
                                          ...
                                          options.extra && typeof options.extra === 'object' ? Y.QueryString.stringify(
                    ...
                    switch (e.type) {
                        ...
                        case 'select-one':
                            if (e.selectedIndex > -1) {
                                ...
                                data[item++] =
                                    n + eUC(o.attributes.value && o.attributes.value.specified ? o.value : o.text);
                            }
                            break;
                            ...
                            if (e.selectedIndex > -1) {
                                for (j = e.selectedIndex, jl = e.options.length; j < jl; ++j) {
                                    ...
                                    if (o.selected) {
                                        data[item++] =
                                            n + eUC(
                                            o.attributes.value && o.attributes.value.specified ? o.value : o.text);
                                    }
                                }
                            }
                            break;
