...
if (!__coverage__['build/aui-datatable-text-cell-editor/aui-datatable-text-cell-editor.js']) {
    __coverage__['build/aui-datatable-text-cell-editor/aui-datatable-text-cell-editor.js'] =
        {
            "path": "build/aui-datatable-text-cell-editor/aui-datatable-text-cell-editor.js",
            "s": {"1": 0, "2": 0, "3": 0, "4": 0},
            "b": {},
            "f": {"1": 0},
            "fnMap": {
            ...
            "statementMap": {
                ...
                "4": {"start": {"line": 41, "column": 0}, "end": {"line": 41, "column": 34}}
            },
            "branchMap": {},
            "code": ["(function () { YUI.add('aui-datatable-text-cell-editor', function (A, NAME) {", "",
                     ...
                     " * @constructor", " */", "var TextCellEditor = A.Component.create({", "", "    /**",
...
__cov_LCUE3DJU3VZEZzLkTi0j3w.s['1']++;
YUI.add('aui-datatable-text-cell-editor', function (A, NAME) {
    __cov_LCUE3DJU3VZEZzLkTi0j3w.f['1']++;
    __cov_LCUE3DJU3VZEZzLkTi0j3w.s['2']++;
    var CSS_FORM_CONTROL = A.getClassName('form', 'control'),
        CSS_CELLEDITOR_ELEMENT = A.getClassName('celleditor', 'element');
    __cov_LCUE3DJU3VZEZzLkTi0j3w.s['3']++;
    ...
    __cov_LCUE3DJU3VZEZzLkTi0j3w.s['4']++;
    A.TextCellEditor = TextCellEditor;
}, '3.1.0', {'requires': ['aui-datatable-base-options-cell-editor']});
