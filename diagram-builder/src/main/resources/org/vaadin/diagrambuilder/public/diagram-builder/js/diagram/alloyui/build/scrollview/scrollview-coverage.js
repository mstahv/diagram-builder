...
if (!__coverage__['build/scrollview/scrollview.js']) {
    __coverage__['build/scrollview/scrollview.js'] =
        {
            ...
            "statementMap": {
                "1": {"start": {"line": 1, "column": 0}, "end": {"line": 21, "column": 76}},
                "2": {"start": {"line": 18, "column": 0}, "end": {"line": 18, "column": 57}}
            },
            "branchMap": {},
            "code": ["(function () { YUI.add('scrollview', function (Y, NAME) {", "", "/**", " * <p>",
...
__cov_8Cr3iTxZe95VDY3sT56igw.s['1']++;
YUI.add('scrollview', function (Y, NAME) {
    __cov_8Cr3iTxZe95VDY3sT56igw.f['1']++;
    __cov_8Cr3iTxZe95VDY3sT56igw.s['2']++;
    Y.Base.plug(Y.ScrollView, Y.Plugin.ScrollViewScrollbars);
}, 'patched-v3.18.1', {'requires': ['scrollview-base', 'scrollview-scrollbars']});
