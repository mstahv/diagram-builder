YUI.add('aui-scheduler-event-recorder', function (A, NAME) {
            ...
            var SchedulerEventRecorder = A.Component.create({
                                                                ...
                                                                ATTRS: {
                                                                    ...
                                                                    /**
                                                                     * Determines whether a new event will take place
                                                                     * all day. When enabled, the event will not
                                                                     * contain 24-hour clock date inputs.
                                                                     *
                                                                     * @attribute allDay
                                                                     * @default false
                                                                     * @type {Boolean}
                                                                    ...
                                                                    /**
                                                                     * Determines the content of this Scheduler event
                                                                     * recorder's body section.
                                                                     *
                                                                     * @attribute content
                                                                     */
                                                                    content: {},
                                                                    ...
                                                                    /**
                                                                     * A scheduler `event` is the wrapper object that
                                                                     * contains an `event` title, start and end times
                                                                     * and a description.
                                                                     *
                                                                     * @attribute event
                                                                     */
                                                                    ...
                                                                    /**
                                                                     * Contains the scheduler event recorder's
                                                                     * `popover` instance.
                                                                     *
                                                                     * @attribute popover
                                                                     * @type {Object}
                                                                    ...
                                                                    /**
                                                                     * Collection of strings used to label elements of
                                                                     * the UI. This attribute defaults to `{}` unless
                                                                     * the attribute is set. When this attribute is
                                                                     * set, the passed value merges with a
                                                                    ...
                                                                    /**
                                                                     * Contains the `SchedulerEventRecorder`'s body
                                                                     * template.
                                                                     *
                                                                    ...
                                                                    /**
                                                                     * Contains the `SchedulerEventRecorder`'s header
                                                                     * template.
                                                                     *
                                                                ...
                                                                /**
                                                                 * Static property used to define which component it
                                                                 * extends.
                                                                 *
                                                                 * @property EXTENDS
                                                                 * @type {Object}
                                                                ...
                                                                prototype: {
                                                                    ...
                                                                    /**
                                                                     * Construction logic executed during
                                                                     * `SchedulerEventRecorder` instantiation.
                                                                     * Lifecycle.
                                                                     *
                                                                     * @method initializer
                                                                     * @protected
                                                                    ...
                                                                    /**
                                                                     * Returns the formatted date including start and
                                                                     * end hours if the event is not `allDay`.
                                                                     *
                                                                     * @method getFormattedDate
                                                                     * @return {String} Formated date including start
                                                                     *     and end hours if the event is not `allDay`.
                                                                     */
                                                                    ...
                                                                    /**
                                                                     * Returns this Scheduler event recorder's
                                                                     * `content`, and dates.
                                                                     *
                                                                     * @method getTemplateData
                                                                     * @return {Object} Copy of this events `content`,
                                                                     *     `date`, `endDate` and
                                                                     *     `startDate`.
                                                                     */
                                                                    ...
                                                                    /**
                                                                     * Returns an updated event and also merges in any
                                                                     * additional attributes passed in as `optAttrMap`.
                                                                     *
                                                                     * @method getUpdatedSchedulerEvent
                                                                     * @param {Object} optAttrMap (optional) Attributes
                                                                     *     map.
                                                                     * @return {Object} schedulerEvent (optional)
                                                                     *     Attributes map.
                                                                     */
                                                                    ...
                                                                    /**
                                                                     * Hides this Scheduler event recorder's `popover`
                                                                     * component.
                                                                     *
                                                                     * @method hidePopover
                                                                     */
                                                                    ...
                                                                    /**
                                                                     * Loads template data into the Scheduler event
                                                                     * recorder's form.
                                                                     *
                                                                     * @method populateForm
                                                                     */
                                                                    ...
                                                                    /**
                                                                     * Converts this event recorder's form node object
                                                                     * to a string.
                                                                     *
                                                                     * @method serializeForm
                                                                     * @return {String} A stringified copy of this
                                                                     *     event recorder's form.
                                                                     */
                                                                    ...
                                                                    /**
                                                                     * Returns the `toolbar` belonging to the event
                                                                     * recorder `footer`.
                                                                     *
                                                                    ...
                                                                    _handleEscapeEvent: function (event) {
                                                                        ...
                                                                        if (instance.popover.get('rendered') && (event.keyCode
                                                                                                                 === A.Event.KeyMap.ESC)) {
                                                                            instance.fire('cancel');
                                                                    ...
                                                                    /**
                                                                     * Renders this `EventRecorder`'s `popover`
                                                                     * component.
                                                                     *
                                                                    ...
                                                                    /**
                                                                     * Replaces this `SchedulerEventRecorder`'s
                                                                     * `popover` component with the given 'popover'
                                                                     * value.
                                                                     *
                                                                     * @method _renderPopover
                                                                     * @protected
                                                                     * @param {Object} val The new `popover`.
                                                                     * @return {Object} The new `popover` value merged
                                                                     *     some default popover configuration
                                                                     *     properties.
                                                                     */
