YUI.add('recordset-sort', function (Y, NAME) {
    ...
    Y.mix(RecordsetSort, {
        ...
        ATTRS: {
            ...
            /**
             * @description The last properties used to sort. Consists of an object literal with the keys "field",
             *     "desc", and "sorter"
             *
    ...
    Y.extend(RecordsetSort, Y.Plugin.Base, {
         ...
         * @param desc {boolean} True if you want sort order to be descending, false if you want sort order to be
         *     ascending
         * @public
         */
        ...
        /**
         * @description Resorts the recordset based on the last-used sort parameters (stored in 'lastSortProperties'
         *     ATTR)
         *
         * @method resort
         * @public
        ...
        /**
         * @description Sorts the recordset based on the last-used sort parameters, but flips the order. (ie:
         *     Descending becomes ascending, and vice versa).
         *
         * @method flip
         * @public
         */
