    ...
    Y.mix(Table.prototype, {
        ...
        _initCoreEvents: function () {
            this._eventHandles.coreAttrChanges = this.after({
                                                                ...
                                                                recordTypeChange: Y.bind('_afterRecordTypeChange',
                                                                                         this),
            ...
            function process(cols) {
                ...
                for (i = 0, len = cols.length; i < len; ++i) {
                    ...
                    if (key && !map[key]) {
                        ...
                        Y.log('Key of column matches existing key or name: ' + key, 'warn', NAME);
                    }
                    if (map[col._id]) {
                        Y.log('Key of column matches existing key or name: ' + col._id, 'warn', NAME);
                    }
