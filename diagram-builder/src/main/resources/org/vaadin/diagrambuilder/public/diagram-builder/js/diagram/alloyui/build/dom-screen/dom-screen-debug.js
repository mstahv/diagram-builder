YUI.add('dom-screen', function (Y, NAME) {
    ...
    (function (Y) {
        ...
        Y.mix(Y_DOM, {
                        ...
                        if (node && node.tagName) {
                            ...
                            if (inDoc) {
                                ...
                                if (win && 'pageXOffset' in win) {
                                    ...
                                    scrollLeft =
                                        (SCROLL_NODE) ? doc[SCROLL_NODE].scrollLeft : Y_DOM.docScrollX(node, doc);
                                    scrollTop =
                                        (SCROLL_NODE) ? doc[SCROLL_NODE].scrollTop : Y_DOM.docScrollY(node, doc);
                                }
             ...
             * The element must be part of the DOM tree to have page coordinates (display:none or elements not appended
             * return false).
             * @method setXY
             * @param element The target element
             ...
             * The element(s) must be part of the DOM tree to have page coordinates (display:none or elements not
    ...
    (function (Y) {
        ...
        Y.mix(DOM, {
             ...
             * @param {Object} altRegion An object literal containing the region for the first element if we already
             *     have the data (for performance e.g. DragDrop)
             * @return {Object} Object literal containing the following intersection data: (top, right, bottom, left,
             *     area, yoff, xoff, inRegion)
             */
             ...
             * @param {Object} altRegion An object literal containing the region for this node if we already have the
             *     data (for performance e.g. DragDrop)
            ...
            /**
             * Returns an Object literal containing the following about the visible region of viewport: (top, right,
             * bottom, left)
             * @method viewportRegion
             * @for DOM
             * @return {Object} Object literal containing the following about the visible region of the viewport: (top,
             *     right, bottom, left)
             */
