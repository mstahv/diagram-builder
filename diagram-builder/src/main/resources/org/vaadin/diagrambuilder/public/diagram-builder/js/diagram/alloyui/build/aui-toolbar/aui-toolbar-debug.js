                                       ...
                                       prototype: {
                                           ...
                                           bindUI: function () {
                                               ...
                                               boundingBox.delegate(
                                                   ['click', 'mousemove', 'focus'], this._onUserInitInteraction, '.'
                                                                                                                 + CSS_BTN_TOOLBAR
                                                                                                                 + ', .'
                                                                                                                 + CSS_BTN,
                                                   this);
                                           ...
                                           _initEnclosingWidgetIfNeeded: function (seed, event) {
                                               ...
                                               groupNode =
                                                   seed.ancestor('.' + CSS_BTN_GROUP + ', ' + CSS_BTN_GROUP_VERTICAL,
                                                       true);
                                               if (groupNode) {
