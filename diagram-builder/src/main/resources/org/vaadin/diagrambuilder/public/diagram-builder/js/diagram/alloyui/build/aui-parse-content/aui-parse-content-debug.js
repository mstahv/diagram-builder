YUI.add('aui-parse-content', function (A, NAME) {
    ...
    var ParseContent = A.Component.create({
                                              ...
                                              prototype: {
                                                   ...
                                                   * @param {String} data The script content which should be added to
                                                   *     the queue
                                                   * @protected
                                                   */
                                                  ...
                                                  /**
                                                   * Bind listeners on the `insert` and `setContent` methods of the
                                                   * Node
                                                   * instance where you are plugging the ParseContent. These listeners
                                                   * are responsible for intercept the HTML passed and parse them.
                                                   *
                                                   * @method _bindAOP
                                                   * @protected
                                                   */
                                                  ...
                                                  _extractScripts: function (content) {
                                                      ...
                                                      // For PADDING_NODE, instead of fixing all tags in the content to
                                                      // be "XHTML"-style, we make the firstChild be a valid non-empty
                                                      // tag, then we remove it later
                                                  ...
                                                  _dispatch: function (output) {
                                                      ...
                                                      output.js.each(function (node) {
                                                          ...
                                                          if (src) {
                                                              ...
                                                              scriptContent.push(dom.text || dom.textContent
                                                                                 || dom.innerHTML || '');
                                                          }
                                                      });
