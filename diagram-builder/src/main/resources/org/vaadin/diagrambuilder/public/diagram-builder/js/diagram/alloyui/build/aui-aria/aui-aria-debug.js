                                      ...
                                      prototype: {
                                          ...
                                          isValidAttribute: function (attrName) {
                                              ...
                                              return (instance.get('validateW3C')
                                                      ? A.Plugin.Aria.W3C_ATTRIBUTES[attrName] : true);
                                          },
                                          ...
                                          isValidRole: function (roleName) {
                                              ...
                                              return (instance.get('validateW3C') ? A.Plugin.Aria.W3C_ROLES[roleName]
                                                                                  : true);
                                          },
                                          ...
                                          setAttribute: function (attrName, attrValue, node) {
                                              ...
                                              if (instance.isValidAttribute(attrName)) {
                                                  (node || instance.get('attributeNode')).set('aria-' + attrName,
                                                      attrValue);
