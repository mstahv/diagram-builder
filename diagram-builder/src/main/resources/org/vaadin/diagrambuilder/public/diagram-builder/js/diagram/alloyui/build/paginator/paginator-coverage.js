...
if (!__coverage__['build/paginator/paginator.js']) {
    __coverage__['build/paginator/paginator.js'] =
        {
            ...
            "statementMap": {
                "1": {"start": {"line": 1, "column": 0}, "end": {"line": 75, "column": 50}},
                "2": {"start": {"line": 69, "column": 0}, "end": {"line": 72, "column": 2}}
            },
            "branchMap": {},
            "code": ["(function () { YUI.add('paginator', function (Y, NAME) {", "", "/**",
                     ...
                     " remain available for use later on or used in isolation if it is the only piece", " you need.",
                     ...
                     " desired class and mixing in `Paginator`. This is displayed in the following", " example:", "",
                     " <pre><code>", " YUI().use('paginator-url', 'widget', function (Y){",
                     "     var MyPaginator = Y.Base.create('my-paginator', Y.Widget, [Y.Paginator], {", "",
                     "        renderUI: function () {", "            var numbers = '',",
                     ...
                     "            }, 'a', this);", "", "            this.after('pageChange', function (e) {",
                     ...
                     "                    totalItems: 100,", "                    pageUrl: '?pg={page}'",
                     "                });", "", "     myPg.render();", " });", " </code></pre>", "",
                     " @module paginator", " @main paginator", " @class Paginator", " @constructor", " @since 3.11.0",
                     " */", "", "Y.Paginator = Y.mix(", "    Y.Base.create('paginator', Y.Base, [Y.Paginator.Core]),",
                     "    Y.Paginator", ");", "", "", "}, 'patched-v3.18.1', {\"requires\": [\"paginator-core\"]});",
                     "", "}());"]
        };
}
var __cov_ZdY6Pu0_MB6gZTkNaF0I0w = __coverage__['build/paginator/paginator.js'];
__cov_ZdY6Pu0_MB6gZTkNaF0I0w.s['1']++;
