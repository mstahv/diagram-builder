YUI.add('slider-base', function (Y, NAME) {
    ...
    Y.SliderBase = Y.extend(SliderBase, Y.Widget, {
        ...
        renderThumb: function () {
            ...
            return Y.Node.create(
                Y.Lang.sub(this.THUMB_TEMPLATE, {
                    ...
                    thumbAriaLabelId: this.getClassName('label', Y.guid()) // get unique id for specifying a label for
                                                                           // ARIA
                }));
        },
        ...
        /**
         * sets the Slider's value in response to left or right key events when a meta (mac command/apple) key is also
         * pressed
         *
        ...
        /**
         * Bounding box template that will contain the Slider's DOM subtree.  &lt;span&gt;s are used to support
         ...
         * @type {String}
         * @default &lt;span class="{railClass}">&lt;span class="{railMinCapClass}">&lt;/span>&lt;span
         *     class="{railMaxCapClass}">&lt;/span>&lt;/span>
         */
         ...
         * @type {String}
         * @default &lt;span class="{thumbClass}" tabindex="-1">&lt;img src="{thumbShadowUrl}" alt="Slider thumb
         *     shadow" class="{thumbShadowClass}">&lt;img src="{thumbImageUrl}" alt="Slider thumb"
         *     class="{thumbImageClass}">&lt;/span>
         */
        THUMB_TEMPLATE: '<span class="{thumbClass}" aria-labelledby="{thumbAriaLabelId}" aria-valuetext="" aria-valuemax="" aria-valuemin="" aria-valuenow="" role="slider" tabindex="0">'
                        +   // keyboard access jeff     tabindex="-1"
