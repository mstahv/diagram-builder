YUI.add('aui-scheduler-view-agenda', function (A, NAME) {
    ...
    var Lang = A.Lang,
        ...
        TPL_EVENTS_HEADER = '<div class="' + [CSS_HEADER, CSS_CLEARFIX].join(' ') +
                            ...
                            + '" data-timestamp="{timestamp}">{extra}</a>' +
                            '</div>',
    ...
    var SchedulerAgendaView = A.Component.create({
                                                     ...
                                                     ATTRS: {
                                                         ...
                                                         /**
                                                          * Determines the content of Scheduler view agenda's body
                                                          * section.
                                                          *
                                                         ...
                                                         /**
                                                          * Contains the function that formats the info label small
                                                          * date.
                                                          *
                                                         ...
                                                         /**
                                                          * Contains the collection of strings used to label elements
                                                          * of the UI.
                                                          *
                                                          * @attribute strings
                                                          * @type {Object}
                                                     ...
                                                     prototype: {
                                                          ...
                                                          *     Undefined keys are interpreted as unlimited sides of
                                                          *     the interval.
                                                          */
                                                         ...
                                                         /**
                                                          * Returns the value of the date that follows the agenda
                                                          * view's current date.
                                                          *
                                                          * @method getNextDate
                                                          * @return {Date}
                                                         ...
                                                         /**
                                                          * Returns the value of the date that preceeds the agenda
                                                          * view's current date.
                                                          *
                                                          * @method getPrevDate
                                                          * @return {Date}
                                                         ...
                                                         plotEvents: function () {
                                                             ...
                                                             instance.set(
                                                                 ...
                                                                 A.Lang.sub(
                                                                     TPL_INFO, {
                                                                         day: infoDayDateFormatter.call(instance,
                                                                                                        viewDate),
                                                                         labelBig: infoLabelBigDateFormatter.call(
                                                                             instance, viewDate),
                                                                         labelSmall: infoLabelSmallDateFormatter.call(
                                                                             instance, viewDate)
                                                                     }
                                                                 )
                                                             );
                                                                     ...
                                                                     function (ts, index) {
                                                                         ...
                                                                         events.push(
                                                                             A.Lang.sub(TPL_EVENTS_HEADER, {
                                                                                 day: headerDayDateFormatter.call(
                                                                                     instance, date),
                                                                                 extra: headerExtraDateFormatter.call(
                                                                                     instance, date),
                                                                                 firstClassName: (index === 0)
                                                                                                 ? CSS_HEADER_FIRST
                                                                                                 : '',
                                                                                 lastClassName: (index === daysLength
                                                                                                 - 1) ? CSS_HEADER_LAST
                                                                                                      : '',
                                                                                 timestamp: ts
                                                                             })
                                                         ...
                                                         /**
                                                          * Updated the plotted events to display the new, right amount
                                                          * of days.
                                                          *
                                                          * Note that the events should still be set into the
                                                          * scheduler. If, for example, one sets events pertaining to
                                                          * 30 days into the scheduler and then set `daysCount` to 60,
                                                          * obviously there is no way to the view to know about more
                                                          * events.
                                                          *
