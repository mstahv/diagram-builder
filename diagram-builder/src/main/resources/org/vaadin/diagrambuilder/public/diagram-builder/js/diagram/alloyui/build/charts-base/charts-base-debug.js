YUI.add('charts-base', function (Y, NAME) {
    ...
    Y.Gridlines = Y.Base.create("gridlines", Y.Base, [Y.Renderer], {
                                ...
                                },
                                {
                                    ATTRS: {
                                        ...
                                        /**
                                         * Indicates the number of gridlines to display. If no value is set, gridlines
                                         * will equal the number of ticks in the corresponding axis.
                                         *
                                         * @attribute count
                                         * @type Number
                                         */
    ...
    Y.Graph = Y.Base.create("graph", Y.Widget, [Y.Renderer], {
         ...
         * @param {Array} Collection of `CartesianSeries` instances or objects container `CartesianSeries` attributes
         *     values.
         * @private
         */
        ...
        /**
         * Creates a `CartesianSeries` instance from an object containing attribute key value pairs. The key value
         * pairs include attributes for the specific series and a type value which defines the type of series to be
         * used.
         *
         * @method createSeries
            ...
            if (this._gridlines) {
                ...
                this._gridlines = null;
                                ...
                                ATTRS: {
                                    ...
                                    /**
                                     * Collection of series. When setting the `seriesCollection` the array can contain
                                     * a combination of either
                                     * `CartesianSeries` instances or object literals with properties that will define
                                     * a series.
                                     *
                                        ...
                                        getter: function () {
                                            if (!this._background) {
                                                this._backgroundGraphic =
                                                    new Y.Graphic({render: this.get("contentBox")});
                                    ...
                                    /**
                                     * Indicates whether or not markers for a series will be grouped and rendered in a
                                     * single complex shape instance.
                                     *
                                     ...
                                     *          <dl>
                                     *              <dt>fill</dt><dd>Defines the style properties for the fill.
                                     * Contains the following values:
                                     *                  <dl>
                                     *                      <dt>color</dt><dd>Color of the fill. The default value is
                                     * #faf9f2.</dd>
                                     *                      <dt>alpha</dt><dd>Number from 0 to 1 indicating the opacity
                                     * of the background fill. The default value is 1.</dd>
                                     *                  </dl>
                                     *              </dd>
                                     *              <dt>border</dt><dd>Defines the style properties for the border.
                                     * Contains the following values:
                                     *                  <dl>
                                     *                      <dt>color</dt><dd>Color of the border. The default value is
                                     * #dad8c9.</dd>
                                     *                      <dt>alpha</dt><dd>Number from 0 to 1 indicating the opacity
                                     * of the background border. The default value is 1.</dd>
                                     *                      <dt>weight</dt><dd>Number indicating the width of the
                                     * border. The default value is 1.</dd>
                                     *                  </dl>
                                     *              </dd>
                                     *          </dl>
                                     *      </dd>
    ...
    ChartBase.ATTRS = {
         ...
         *      <dt>hideEvent</dt><dd>Event that should trigger the removal of a tooltip (can be an event or an array
         * of events)</dd>
         *      <dt>styles</dt><dd>A hash of style properties that will be applied to the tooltip node</dd>
         *      <dt>show</dt><dd>Indicates whether or not to show the tooltip</dd>
         *      <dt>markerEventHandler</dt><dd>Displays and hides tooltip based on marker events</dd>
         *      <dt>planarEventHandler</dt><dd>Displays and hides tooltip based on planar events</dd>
         *      <dt>markerLabelFunction</dt><dd>Reference to the function used to format a marker event triggered
         * tooltip's text. The method contains the following arguments:
         *  <dl>
         ...
         *  </dl>
         *  The method returns an `HTMLElement` which is written into the DOM using `appendChild`. If you override this
         * method and choose to return an html string, you will also need to override the tooltip's `setTextFunction`
         * method to accept an html string.
         *  </dd>
         *  <dt>planarLabelFunction</dt><dd>Reference to the function used to format a planar event triggered tooltip's
         * text
         *  <dl>
         *      <dt>categoryAxis</dt><dd> `CategoryAxis` Reference to the categoryAxis of the chart.
         *      <dt>valueItems</dt><dd>Array of objects for each series that has a data point in the coordinate plane
         * of the event. Each object contains the following data:
         *  <dl>
         ...
         * method to accept an html string.
         *  </dd>
         *  <dt>setTextFunction</dt><dd>Method that writes content returned from `planarLabelFunction` or
         * `markerLabelFunction` into the the tooltip node. Has the following signature:
         *  <dl>
         *      <dt>label</dt><dd>The `HTMLElement` that the content is to be added.</dd>
         *      <dt>val</dt><dd>The content to be rendered into tooltip. This can be a `String` or `HTMLElement`. If an
         * HTML string is used, it will be rendered as a string.</dd>
         *  </dl>
         *  </dd>
         *  </dl>
         * @attribute tooltip
         ...
         *      <dt>planar</dt><dd>Events will be broadcasted when the mouse intersects the plane of any markers on the
         * chart.</dd>
        ...
        /**
         * Indicates whether or not markers for a series will be grouped and rendered in a single complex shape
         * instance.
         *
         * @attribute groupMarkers
         * @type Boolean
    ...
    ChartBase.prototype = {
        ...
        _itemRendered: function (e) {
            this._itemRenderQueue =
                this._itemRenderQueue.splice(1 + Y.Array.indexOf(this._itemRenderQueue, e.currentTarget), 1);
         ...
         * @param {Array} val Array of either `CartesianSeries` instances or objects containing series attribute key
         *     value pairs.
         * @private
         */
        ...
        bindUI: function () {
            ...
            if (interactionType === "marker") {
                //if touch capabilities, toggle tooltip on touchend. otherwise, the tooltip attribute's
                // hideEvent/showEvent types.
            ...
            var node = DOCUMENT.createElement("div"),
                ...
                tt = {
                    ...
                    markerEventHandler: function (e) {
                        var tt = this.get("tooltip"),
                            msg = tt.markerLabelFunction.apply(this, [e.categoryItem, e.valueItem, e.index, e.series,
                                                                      e.seriesIndex]);
                    ...
                    planarEventHandler: function (e) {
                        ...
                        msg =
                            tt.planarLabelFunction.apply(this,
                                                         [categoryAxis, e.valueItem, e.index, e.items, e.seriesIndex]);
                        this._showTooltip(msg, e.x + 10, e.y + 10);
                    }
                };
            node = Y.one(node);
         ...
         * @param {Array} valueItems Array of objects for each series that has a data point in the coordinate plane of
         *     the event. Each object contains the following data:
         *  <dl>
         *      <dt>axis</dt><dd>The value axis of the series.</dd>
         *      <dt>key</dt><dd>The key for the series.</dd>
         *      <dt>value</dt><dd>The value for the series item.</dd>
    ...
    Y.CartesianChart = Y.Base.create("cartesianChart", Y.Widget, [Y.ChartBase, Y.Renderer], {
        ...
        /**
         * When `interactionType` is set to `planar`, listens for mouse move events and fires `planarEvent:mouseover`
         * or `planarEvent:mouseout` depending on the position of the mouse in relation to data points on the `Chart`.
         *
        ...
        _planarEventDispatcher: function (e) {
            ...
            if (markerPlane) {
                ...
                /**
                 * Broadcasts when `interactionType` is set to `planar` and a series' marker plane has received a
                 * mouseover event.
                 *
                 *
                 ...
                 *   properties:
                 *  <dl>
                 *      <dt>categoryItem</dt><dd>An array of hashes, each containing information about the category
                 *     `Axis` of each marker whose plane has been intersected.</dd>
                 *      <dt>valueItem</dt><dd>An array of hashes, each containing information about the value `Axis` of
                 *     each marker whose plane has been intersected.</dd>
                 *      <dt>x</dt><dd>The x-coordinate of the mouse in relation to the Chart.</dd>
                 *      <dt>y</dt><dd>The y-coordinate of the mouse in relation to the Chart.</dd>
                 *      <dt>pageX</dt><dd>The x location of the event on the page (including scroll)</dd>
                 *      <dt>pageY</dt><dd>The y location of the event on the page (including scroll)</dd>
                 *      <dt>items</dt><dd>An array including all the series which contain a marker whose plane has been
                 *     intersected.</dd>
        ...
        /**
         * Queue of axes instances that will be updated. This method is used internally to determine when all axes have
         * been updated.
         *
         ...
         * @param {Array} val Array containing either `CartesianSeries` instances or objects containing data to
         *     construct series instances.
         * @return Array
         * @private
         */
            ...
            for (i = 0; i < l; ++i) {
                ...
                if (series instanceof Y.CartesianSeries) {
                    ...
                    if (series.type === "combo" ||
                        ...
                        if (showMarkers !== null) {
                            series.showMarkers =
                                (series.showMarkers !== null && series.showMarkers !== undefined) ? series.showMarkers
                                                                                                  : showMarkers;
                        }
                        if (showLines !== null) {
                            series.showLines =
                                (series.showLines !== null && series.showLines !== undefined) ? series.showLines
                                                                                              : showLines;
                        }
                    }
                    if (seriesStyles) {
        ...
        /**
         * Generates and returns a key-indexed object containing `Axis` instances or objects used to create `Axis`
         * instances.
         *
         * @method _parseAxes
        ...
        /**
         * Returns an object literal containing a categoryItem and a valueItem for a given series index. Below is the
         * structure of each:
         *
         ...
         *
         *  <dl>
         *      <dt>categoryItem</dt><dd>Object containing the following data related to the category axis of the
         *     series.
         *  <dl>
        ...
        _getTopOverflow: function (set1, set2, height) {
            ...
            if (set1) {
                ...
                for (; i < len; ++i) {
                    ...
                    overflow = Math.max(
                        overflow,
                        Math.abs(axis.getMaxLabelBounds().top) - axis.getEdgeOffset(axis.get("styles").majorTicks.count,
                                                                                    height)
                    );
                }
            }
        ...
        _getLeftOverflow: function (set1, set2, width) {
            ...
            if (set1) {
                ...
                for (; i < len; ++i) {
                    ...
                    overflow = Math.max(
                        overflow,
                        Math.abs(axis.getMinLabelBounds().left) - axis.getEdgeOffset(
                        axis.get("styles").majorTicks.count, width)
                    );
                }
            }
            if (set2) {
        ...
        _getBottomOverflow: function (set1, set2, height) {
            ...
            if (set1) {
                ...
                for (; i < len; ++i) {
                    ...
                    overflow = Math.max(
                        overflow,
                        axis.getMinLabelBounds().bottom - axis.getEdgeOffset(axis.get("styles").majorTicks.count,
                                                                             height)
                    );
                }
            }
        ...
        /**
         * Destructor implementation for the CartesianChart class. Calls destroy on all axes, series and the Graph
         * instance. Removes the tooltip and overlay HTML elements.
         *
         * @method destructor
         * @protected
         */
        ...
        _getAriaMessage: function (key) {
            ...
            if (key % 2 === 0) {
                ...
                if (categoryItem && valueItem && categoryItem.value && valueItem.value) {
                    msg += categoryItem.displayName +
                           ": " +
                           categoryItem.axis.formatLabel.apply(this, [categoryItem.value,
                                                                      categoryItem.axis.get("labelFormat")]) +
                           ", ";
            ...
            return msg;
                                         ...
                                         ATTRS: {
                                             /**
                                              * Indicates whether axis labels are allowed to overflow beyond the bounds
                                              * of the chart's content box.
                                              *
                                             ...
                                             /**
                                              * Style properties for the chart. Contains a key indexed hash of the
                                              * following:
                                              *  <dl>
                                              *      <dt>series</dt><dd>A key indexed hash containing references to the
                                              * `styles` attribute for each series in the chart. Specific style
                                              * attributes vary depending on the series:
                                              *      <ul>
                                              *          <li><a href="AreaSeries.html#attr_styles">AreaSeries</a></li>
                                              *          <li><a href="BarSeries.html#attr_styles">BarSeries</a></li>
                                              *          <li><a
                                              * href="ColumnSeries.html#attr_styles">ColumnSeries</a></li>
                                              *          <li><a
                                              * href="ComboSeries.html#attr_styles">ComboSeries</a></li>
                                              *          <li><a href="LineSeries.html#attr_styles">LineSeries</a></li>
                                              *          <li><a
                                              * href="MarkerSeries.html#attr_styles">MarkerSeries</a></li>
                                              *          <li><a
                                              * href="SplineSeries.html#attr_styles">SplineSeries</a></li>
                                              *      </ul>
                                              *      </dd>
                                              *      <dt>axes</dt><dd>A key indexed hash containing references to the
                                              * `styles` attribute for each axes in the chart. Specific style
                                              * attributes can be found in the <a href="Axis.html#attr_styles">Axis</a>
                                              * class.</dd>
                                              *      <dt>graph</dt><dd>A reference to the `styles` attribute in the
                                              * chart. Specific style attributes can be found in the
                                             ...
                                             /**
                                              * Axes to appear in the chart. This can be a key indexed hash of axis
                                              * instances or object literals used to construct the appropriate axes.
                                              *
                                              * @attribute axes
                                              * @type Object
                                              */
                                             ...
                                             /**
                                              * Collection of series to appear on the chart. This can be an array of
                                              * Series instances or object literals used to construct the appropriate
                                              * series.
                                              *
                                              * @attribute seriesCollection
                                              * @type Array
                                             ...
                                             /**
                                              * Direction of chart's category axis when there is no series collection
                                              * specified. Charts can be horizontal or vertical. When the chart type is
                                              * column, the chart is horizontal. When the chart type is bar, the chart
                                              * is vertical.
                                              *
                                              * @attribute direction
                                              * @type String
                                              ...
                                              * hash. If not specified, the categoryKey attribute value will be used.
                                              *
                                             ...
                                             /**
                                              * Indicates the key value used to identify a the series axis when an axis
                                              * not generated.
                                              *
    ...
    Y.PieChart = Y.Base.create("pieChart", Y.Widget, [Y.ChartBase], {
        ...
        _tooltipLabelFunction: function (categoryItem, valueItem, itemIndex, series) {
            ...
            msg.appendChild(DOCUMENT.createTextNode(categoryItem.displayName +
                                                    ": " + categoryItem.axis.get("labelFunction").apply(this,
                                                                                                        [categoryItem.value,
                                                                                                         categoryItem.axis.get(
                                                                                                             "labelFormat")])));
            msg.appendChild(DOCUMENT.createElement("br"));
            msg.appendChild(DOCUMENT.createTextNode(valueItem.displayName +
                                                    ": " + valueItem.axis.get("labelFunction").apply(this,
                                                                                                     [valueItem.value,
                                                                                                      valueItem.axis.get(
                                                                                                          "labelFormat")])));
            msg.appendChild(DOCUMENT.createElement("br"));
        ...
        _getAriaMessage: function (key) {
            ...
            if (categoryItem && valueItem) {
                msg += categoryItem.displayName +
                       ": " +
                       categoryItem.axis.formatLabel.apply(this,
                                                           [categoryItem.value, categoryItem.axis.get("labelFormat")]) +
                       ", ";
                msg += valueItem.displayName +
                       ": " + valueItem.axis.formatLabel.apply(this,
                                                               [valueItem.value, valueItem.axis.get("labelFormat")]) +
                       ", ";
            ...
            if (tooltipNode) {
                ...
                tooltipNode.remove(true);
                                   ...
                                   ATTRS: {
                                       ...
                                       /**
                                        * Collection of series to appear on the chart. This can be an array of Series
                                        * instances or object literals used to describe a Series instance.
                                        *
                                        * @attribute seriesCollection
                                        * @type Array
                                        */
