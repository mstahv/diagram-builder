YUI.add('series-candlestick', function (Y, NAME) {
     ...
     */
    /**
     * The CandlestickSeries class renders columns (candles) and lines (wicks) representing the open, high, low and
     * close values for a chart.
     *
    ...
    CandlestickSeries.ATTRS = {
        ...
        /**
         * Style properties used for drawing candles and wicks. This attribute is inherited from `RangeSeries`. Below
         ...
         *                      </dd>
         *                      <dt>alpha</dt><dd>Number from 0 to 1 indicating the opacity of the marker fill. The
         ...
         *                      <dt>alpha</dt><dd>Number from 0 to 1 indicating the opacity of the marker border. The
         * default value is 1.</dd>
         *                      <dt>weight</dt><dd>Number indicating the width of the border. The default value is
         * 0.</dd>
         *                  </dl>
         *              </dd>
         *          </dl>
         ...
         *          </dl>
         *      </dd>
         *      <dt>wick</dt><dd>Properties for the wick, which is a line drawn from the high point of the period to
         ...
         *              <dt>alpha</dt><dd>Number from 0 to 1 indicating the opacity of the wick. The default value is
         * 1.</dd>
         *          </dl>
         *      </dd>
         *  </dl>
