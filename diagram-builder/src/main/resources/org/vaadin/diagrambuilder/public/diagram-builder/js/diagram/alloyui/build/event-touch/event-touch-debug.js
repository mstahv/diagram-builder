    ...
    Y.DOMEventFacade.prototype._touch = function (e, currentTarget, wrapper) {
        ...
        if (e.targetTouches) {
            ...
            for (i = 0, l = e.targetTouches.length; i < l; ++i) {
                ...
                if (etCached) {
                    Y.log("Found native event in touches. Using same facade in targetTouches", "info", "event-touch");
                }
            }
        }
        ...
        if (e.changedTouches) {
            ...
            for (i = 0, l = e.changedTouches.length; i < l; ++i) {
                ...
                if (etCached) {
                    Y.log("Found native event in touches. Using same facade in changedTouches", "info", "event-touch");
                }
            }
        }
