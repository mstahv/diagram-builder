YUI.add('widget-parent', function (Y, NAME) {
        ...
        selected: {
            setter: function (value) {
                ...
                if (value === 1 && !this.get("multiple")) {
                    Y.log('The selected attribute can only be set to 1 if the "multiple" attribute is set to true.',
                          "error", "widget");
    ...
    Parent.prototype = {
        ...
        _defAddChildFn: function (event) {
            ...
            // (e.g. user passed in 10, and there are only 3 items, the actual index would be 3. We don't want to pass
            // 10 around in the event facade).
