    ...
    Y.Event.define(EVT_TAP, {
        ...
        _start: function (event, node, subscription, notifier, delegate) {
            ...
            //false in any case, so this block doesn't do anything.
                ...
                subscription[HANDLES.END] =
                    node.once(GESTURE_MAP.end, this._end, this, node, subscription, notifier, delegate, context);
                subscription[HANDLES.CANCEL] =
                    node.once(GESTURE_MAP.cancel, this.detach, this, node, subscription, notifier, delegate, context);
            }
