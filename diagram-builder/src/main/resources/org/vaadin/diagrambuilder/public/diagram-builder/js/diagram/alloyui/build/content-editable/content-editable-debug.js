YUI.add('content-editable', function (Y, NAME) {
    ...
    Y.extend(ContentEditable, Y.Plugin.Base, {
                  ...
                  * takes the current EventFacade and augments it to fire on the ContentEditable host. It adds two new
                  * properties to the EventFacade called frameX and frameY which adds the scroll and xy position of the
                  * ContentEditable element to the original pageX and pageY of the event so external nodes can be
                  * positioned over the element. In case of ContentEditable element these will be equal to pageX and
                  * pageY of the container.
                  * @private
                  * @method _onDomEvent
                  * @param {EventFacade} e
                  */
                     ...
                     Y.each(
                         ...
                         function (value, key) {
                             var fn = Y.bind(this._onDomEvent, this),
                                 kfn = ((Y.UA.ie && ContentEditable.THROTTLE_TIME > 0) ? Y.throttle(fn,
                                                                                                    ContentEditable.THROTTLE_TIME)
                                                                                       : fn);
                  ...
                  * @param {String, Node} cont The container to act as a delegate, if no "sel" passed, the container is
                  *     assumed.
                 ...
                 delegate: function (type, fn, cont, sel) {
                     ...
                     if (!inst) {
                         Y.log('Delegate events can not be attached until after the ready event has fired.', 'error',
                               'contenteditable');
             ...
             },
             {
                 ...
                 ATTRS: {
                     ...
                     /**
                      * Array of modules to include in the scoped YUI instance at render time. Default: ['node-base',
                      * 'editor-selection', 'stylesheet']
                      * @attribute use
                      * @writeonce
                      * @type Array
                      */
