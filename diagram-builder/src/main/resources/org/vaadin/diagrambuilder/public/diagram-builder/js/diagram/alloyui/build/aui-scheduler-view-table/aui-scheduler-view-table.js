YUI.add('aui-scheduler-view-table', function (A, NAME) {
    ...
    var Lang = A.Lang,
        ...
        TPL_SVT_EVENTS_OVERLAY_NODE = '<div class="' + CSS_SVT_EVENTS_OVERLAY_NODE + '">' +
                                      ...
                                      '<a href="javascript:;" class="' + CSS_SVT_EVENTS_OVERLAY_NODE_CLOSE
                                      + '">{label}</a>' +
                                      '</div>',
    ...
    var SchedulerTableView = A.Component.create({
                                                    ...
                                                    ATTRS: {
                                                        ...
                                                        /**
                                                         * Determines the content of Scheduler table view's body
                                                         * section.
                                                         *
                                                        ...
                                                        /**
                                                         * Contains the number of rows to display in the
                                                         * `SchedulerTableView`.
                                                         *
                                                         ...
                                                         *
                                                         * When a cell has more events than can be shown, it offers an
                                                         * option to open an overlay to see all of them by clicking in
                                                         * a "See x more" link. This overlay should be constrained by
                                                         * another element, lest it could be cropped or would resize
                                                         * the entire document.
                                                         *
                                                         * The default value is `true`, in which case the overlay is
                                                        ...
                                                        /**
                                                         * Indicates whether the height of the `SchedulerTableView` is
                                                         * fixed.
                                                         *
                                                        ...
                                                        /**
                                                         * Contains the collection of strings used to label elements of
                                                         * the UI.
                                                         *
                                                         * @attribute strings
                                                         * @type {Object}
                                                    ...
                                                    /**
                                                     * Contains an object hash, defining how attribute values are to be
                                                     * parsed from markup contained in the widget's bounding box.
                                                     *
                                                    ...
                                                    prototype: {
                                                        ...
                                                        /**
                                                         * Construction logic executed during `SchedulerTableView`
                                                        ...
                                                        bindUI: function () {
                                                            ...
                                                            instance.rowsContainerNode.delegate('click', A.bind(
                                                                instance._onClickMore, instance), '.' +
                                                                                                  CSS_SVT_MORE);
                                                        },

                                                        /**
                                                         * Renders the `SchedulerTableView` component instance.
                                                         * Lifecycle.
                                                         *
                                                         * @method renderUI
                                                         * @protected
                                                        ...
                                                        buildEventsRow: function (rowStartDate, rowEndDate,
                                                            ...
                                                            instance.loopDates(rowStartDate, rowEndDate,
                                                                               function (celDate, index) {
                                                                                   ...
                                                                                   if ((evtRenderedStack.length
                                                                                        < events.length) && displayRows
                                                                                       && (rowDisplayIndex
                                                                                           === (displayRows - 1))) {
                                                            ...
                                                            if (!rowDataTableNode) {
                                                                ...
                                                                while (!end) {
                                                                    ...
                                                                    if (rowNode) {
                                                                        ...
                                                                        rowDisplayIndex++;
                                                                        if (displayRows && rowDisplayIndex
                                                                            >= displayRows) {
                                                                            end = true;
                                                                        }
                                                                    }
                                                        ...
                                                        /**
                                                         * Builds a new row `Node` and appends a table grid `Node`.
                                                        ...
                                                        buildGridRowNode: function (rowIndex) {
                                                            ...
                                                            rowNode.append(
                                                                tableGridNode.toggleClass(CSS_SVT_TABLE_GRID_FIRST,
                                                                                          (rowIndex === 0))
                                                            );
                                                        ...
                                                        /**
                                                         * Returns the date interval in which this view shows events
                                                         * for.
                                                         *
                                                         * @method getDateInterval
                                                         * @return {Object} Object with 2 keys: startDate and endDate.
                                                         *     Undefined keys are interpreted as unlimited sides of the
                                                         *     interval.
                                                         */
                                                        ...
                                                        /**
                                                         * Returns the list of all events that intersect with a given
                                                         * date.
                                                         *
                                                         * @method getIntersectEvents
                                                         * @param {Date} date
                                                         * @return {Array} The list of all events that intersect with a
                                                         *     given date.
                                                         */
                                                        ...
                                                        /**
                                                         * Returns the value of the date that follows the
                                                         * `SchedulerTableView`'s
                                                         current date.
                                                         *
                                                         * @method getNextDate
                                                        ...
                                                        /**
                                                         * Applies a given function to each date between `startDate`
                                                         * and
                                                         * `endDate`.
                                                         *
                                                         * @method loopDates
                                                         ...
                                                         * @param {Date} endDate
                                                         * @param {Function} fn
                                                         * @param {String} incrementBy  The field constant to be used
                                                         *     for performing addition.
                                                         * @param {Number} factor   The ratio used to calculate the
                                                         *     number of units (measured in the field constant) to add
                                                         *     to the date.
                                                         */
                                                        loopDates: function (startDate, endDate, fn, incrementBy,
                                                            ...
                                                            for (index = 0; index < countDays; index++) {
                                                                ...
                                                                curDate =
                                                                    DateMath.add(curDate, (incrementBy || DateMath.DAY),
                                                                                 (factor || 1));
                                                            }
                                                        },
                                                        ...
                                                        /**
                                                         * Updates the `SchedulerTableView`'s `colHeaderDaysNode` to
                                                         * reflect any changes made to the instance attributes.
                                                         *
                                                        ...
                                                        /**
                                                         * Updates the `SchedulerTableView`'s column grid by moving
                                                         * styling to the current day cell `Node`.
                                                         *
                                                         * @method syncGridUI
                                                         */
                                                        syncGridUI: function () {
                                                        ...
                                                        /**
                                                         * Adds the given event to the stack for all dates between the
                                                         * given range.
                                                         *
                                                         ...
                                                         * @protected
                                                         * @return {Date} This `SchedulerTableView`'s date ending
                                                         *     interval.
                                                         */
                                                         ...
                                                         * @protected
                                                         * @return {Date} This `SchedulerTableView`'s date starting
                                                         *     interval.
                                                         */
                                                        ...
                                                        /**
                                                         * Finds the events that intersect each of the given dates, but
                                                         * without duplicating the event on different days. Events will
                                                         * show up on the day that first intersected with it.
                                                         *
                                                        ...
                                                        _findIntersections: function (startDate, endDate) {
                                                            ...
                                                            // Sort events by start date and time (they are sorted in a
                                                            // different way by default).
                                                            ...
                                                            while (i < events.length) {
                                                                ...
                                                                if (DateMath.after(currentDate, eventEndDate)) {
                                                                    ...
                                                                    // This is the first event that starts after the
                                                                    // current date. Let's jump to the next date then.
                                                                    currentDate =
                                                                        DateMath.add(currentDate, DateMath.DAY, 1);
                                                                    if (DateMath.after(currentDate, endDate)) {
                                                                        // The current date is past the last date we
                                                                        // want to find intersections for. Exit the
                                                                        // loop.
                                                                        break;
                                                                    }
                                                                }
                                                                    ...
                                                                    if (!filterFn || filterFn(events[i])) {
                                                                        this._addEventToAllDates(events[i], currentDate,
                                                                                                 endDate);
                                                                    }
                                                        ...
                                                        /**
                                                         * Returns the label that belongs to a given
                                                         * `A.SchedulerEvent`.
                                                         *
                                                         * @method _getEvtLabel
                                                        ...
                                                        /**
                                                         * Returns a unique string representation for a date
                                                         * (disregarding time).
                                                         *
                                                         * @method _getEvtRenderedStackKey
                                                         * @param {Date} date A date
                                                         * @protected
                                                         * @return {String} one string that uniquely represents the
                                                         *     date.
                                                         */
                                                         ...
                                                         * `right` values that determine a `SchedulerEvent`'s split
                                                         * information.
                                                         *
                                                         ...
                                                         * @param {Date} rowStartDate
                                                         * @param {Date} rowEndDate
                                                         * @return {Object} info An object containing the `colspan`,
                                                         *     `left` and
                                                         * `right` values that determine a `SchedulerEvent`'s split
                                                         *     information.
                                                         * @protected
                                                        ...
                                                        /**
                                                         * Returns either a `SchedulerEvent` that is not yet rendered
                                                         * and has a
                                                         * `startDate` that does not overlap with with a given
                                                         * `celDate` or is a continuation of an existing event.
                                                         *
                                                         ...
                                                         * @param {Date} rowEndDate
                                                         * @param {Date} celDate
                                                         * @return {A.SchedulerEvent|null} Either a `SchedulerEvent`
                                                         *     that is not yet rendered and has a`startDate` that does
                                                         *     not overlap with with a given `celDate` or is a
                                                        ...
                                                        _getRenderableEvent: function (events, rowStartDate, rowEndDate,
                                                            ...
                                                            for (i = 0; i < events.length; i++) {
                                                                ...
                                                                var isEventDateContinuation = DateMath.after(celDate,
                                                                                                             startDate)
                                                                                              && !DateMath.isDayOverlap(
                                                                        celDate,
                                                                        rowStartDate);
                                                                ...
                                                                if (!isRendered && (isEventStartDateDay
                                                                                    || isEventDateContinuation)) {
                                                                    return evt;
                                                                }
                                                            }
                                                         ...
                                                         * @param {Number} rowIndex
                                                         * @return {Node} tableGridNode The table grid `Node` from a
                                                         *     given
                                                         *     `rowIndex`.
                                                         * @protected
                                                         */
                                                        _getTableGridNode: function (rowIndex) {
                                                            var instance = this,
                                                                displayDaysInterval = instance.get(
                                                                    'displayDaysInterval'),
                                                        ...
                                                        /**
                                                         * Handles `SchedulerEvent` `click` events for the
                                                         * `SchedulerViewTable`.
                                                         *
                                                         * @method _onClickMore
                                                         * @param {EventFacade} event
                                                        ...
                                                        /**
                                                         * Renders this `SchedulerViewTable` event's `overlay`
                                                         * component.
                                                         *
                                                        ...
                                                        /**
                                                         * Updates a given `Node`'s UI with a given `evtSplitInfo`
                                                         * value. any changes made to the instance attributes.
                                                         *
                                                         * @method _syncEventNodeContainerUI
                                                         * @param {A.SchedulerEvent} evt A `Scheduler` event.
                                                         * @param node
                                                         * @param {Object} evtSplitInfo An object containing the
                                                         *     `colspan`,
                                                         *     `left` and `right` values that determine a
                                                         *     `SchedulerEvent`'s split information.
                                                         * @protected
                                                         */
                                                        ...
                                                        /**
                                                         * Updates a given `SchedulerEvent` `Node` with the given
                                                         * `celDate` and appends it to a given `container` `Node`.
                                                         *
