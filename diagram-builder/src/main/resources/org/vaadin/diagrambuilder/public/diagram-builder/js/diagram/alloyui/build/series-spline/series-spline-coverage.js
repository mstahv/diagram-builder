...
if (!__coverage__['build/series-spline/series-spline.js']) {
    __coverage__['build/series-spline/series-spline.js'] =
        {
            ...
            "statementMap": {
                "1": {"start": {"line": 1, "column": 0}, "end": {"line": 82, "column": 68}},
                "2": {"start": {"line": 20, "column": 0}, "end": {"line": 73, "column": 3}},
                "3": {"start": {"line": 30, "column": 8}, "end": {"line": 30, "column": 26}}
            },
            "branchMap": {},
            "code": ["(function () { YUI.add('series-spline', function (Y, NAME) {", "", "/**",
                     " * Provides functionality for creating a spline series.", " *", " * @module charts",
                     " * @submodule series-spline", " */", "/**",
                     " * SplineSeries renders a graph with data points connected by a curve.", " *",
                     " * @class SplineSeries", " * @extends LineSeries", " * @uses CurveUtil", " * @uses Lines",
                     ...
                     "        this.drawSpline();", "    }", "}, {", "\tATTRS : {", "        /**",
                     "         * Read-only attribute indicating the type of series.", "         *",
                     "         * @attribute type", "         * @type String", "         * @default spline",
                     "         */", "        type : {", "            value:\"spline\"", "        }", "", "        /**",
...
__cov_ci2Q0RhiaxC8Ql7UgRTbaw.s['1']++;
YUI.add('series-spline', function (Y, NAME) {
    __cov_ci2Q0RhiaxC8Ql7UgRTbaw.f['1']++;
    __cov_ci2Q0RhiaxC8Ql7UgRTbaw.s['2']++;
    Y.SplineSeries = Y.Base.create('splineSeries', Y.LineSeries, [Y.CurveUtil, Y.Lines], {
        drawSeries: function () {
            __cov_ci2Q0RhiaxC8Ql7UgRTbaw.f['2']++;
            __cov_ci2Q0RhiaxC8Ql7UgRTbaw.s['3']++;
            this.drawSpline();
        }
