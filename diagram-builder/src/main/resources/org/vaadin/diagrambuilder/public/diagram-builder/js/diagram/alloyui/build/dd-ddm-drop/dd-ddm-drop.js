YUI.add('dd-ddm-drop', function (Y, NAME) {
    ...
    Y.mix(Y.DD.DDM, {
        ...
        validDrops: [],
        /**
         * An object literal of Other Drop Targets that we encountered during this interaction (in the case of
         * overlapping Drop Targets)
         * @property otherDrops
         * @type {Object}
         */
        otherDrops: {},
        ...
        /**
         * This method will gather the area for all potential targets and see which has the hightest covered area and
         * return it.
         * @method getBestMatch
         * @param {Array} drops An Array of drops to scan for the best match.
         * @param {Boolean} all If present, it returns an Array. First item is best match, second is an Array of the
