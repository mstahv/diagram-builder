YUI.add('graphics-svg', function (Y, NAME) {
     ...
     * If the browser has <a href="http://www.w3.org/TR/SVG/">SVG</a> capabilities, the <a
     * href="Drawing.html">`Drawing`</a> class will point to the `SVGDrawing` class.
     *
     * @module graphics
     * @class SVGDrawing
     * @constructor
    ...
    Y.extend(SVGShape, Y.GraphicBase, Y.mix({
                                                ...
                                                addClass: function (className) {
                                                    ...
                                                    node.className.baseVal =
                                                        Y_LANG.trim([node.className.baseVal, className].join(' '));
                                                },
                                                ...
                                                removeClass: function (className) {
                                                    ...
                                                    classString =
                                                        classString.replace(new RegExp(className + ' '), className)
                                                 ...
                                                 *
                                                 * @method contains
                                                 * @param {SVGShape | HTMLElement} needle The possible node or
                                                 *     descendent
                                                ...
                                                createNode: function () {
                                                    var host = this,
                                                        node = DOCUMENT.createElementNS(
                                                            "http://www.w3.org/2000/svg", "svg:" + this._type),
                                                        id = host.get("id"),
                                                        name = host.name,
                                                    ...
                                                    Y.DOM.setAttribute(this.node, "shape-rendering",
                                                                       this.get("shapeRendering"));
                                                },
                                                ...
                                                _strokeChangeHandler: function () {
                                                    ...
                                                    if (stroke && stroke.weight && stroke.weight > 0) {
                                                        ...
                                                        dash =
                                                            Y_LANG.isArray(dashstyle) ? dashstyle.toString()
                                                                                      : dashstyle;
                                                        stroke.color = stroke.color || "#000000";
                                                        stroke.weight = stroke.weight || 1;
                                                        stroke.opacity =
                                                            Y_LANG.isNumber(strokeOpacity) ? strokeOpacity : 1;
                                                        ...
                                                        if (linejoin === "round" || linejoin === "bevel") {
                                                            ...
                                                            if (Y_LANG.isNumber(linejoin)) {
                                                                node.setAttribute("stroke-miterlimit",
                                                                                  Math.max(linejoin, 1));
                                                ...
                                                _fillChangeHandler: function () {
                                                    ...
                                                    if (fill) {
                                                        ...
                                                        if (type === "linear" || type === "radial") {
                                                            ...
                                                            fillOpacity =
                                                                Y_LANG.isNumber(fillOpacity) ? fillOpacity : 1;
                                                ...
                                                _setGradientFill: function (fill) {
                                                    var offset,
                                                        ...
                                                        type = fill.type,
                                                        gradientNode = graphic.getGradientNode("grad" + this.get("id"),
                                                            type),
                                                        stops = fill.stops,
                                                        w = this.get("width"),
                                                        h = this.get("height"),
                                                        ...
                                                        radCon = Math.PI / 180,
                                                        tanRadians = parseFloat(
                                                            parseFloat(Math.tan(rotation * radCon)).toFixed(8)),
                                                        i,
                                                        len,
                                                        def,
                                                        stop,
                                                    ...
                                                    if (isPath || (this._transforms && this._transforms.length > 0)) {
                                                        ...
                                                        if (isPath) {
                                                            ...
                                                            if (!(this instanceof Y.SVGPath)) {
                                                                tx =
                                                                    this._left + (transformOrigin[0] * this.get(
                                                                    "width"));
                                                                ty =
                                                                    this._top + (transformOrigin[1] * this.get(
                                                                    "height"));
                                                            }
                                                            normalizedMatrix.init(
                                                                {dx: x + this._left, dy: y + this._top});
                                                        }
    ...
    SVGShape.ATTRS = {
         ...
         *      crisp edges and geometric precision, but with geometric precision given more importance than speed and
         * crisp edges.</dd>
         *      <dt>optimizeSpeed</dt>
         *      <dd>Indicates that the user agent shall emphasize rendering speed over geometric precision and crisp
         * edges. This option will sometimes cause the user agent to turn off shape anti-aliasing.</dd>
         *      <dt>crispEdges</dt>
         ...
         * horizontal. Also, the user agent might adjust line positions and line widths to align edges with device
         * pixels.</dd>
     ...
     * If the browser has <a href="http://www.w3.org/TR/SVG/">SVG</a> capabilities, the <a
     * href="Ellipse.html">`Ellipse`</a> class will point to the `SVGEllipse` class.
     *
     * @module graphics
     * @class SVGEllipse
     * @constructor
     ...
     * If the browser has <a href="http://www.w3.org/TR/SVG/">SVG</a> capabilities, the <a
     * href="Circle.html">`Circle`</a> class will point to the `SVGCircle` class.
     *
     * @module graphics
     * @class SVGCircle
     * @constructor
     ...
     * If the browser has <a href="http://www.w3.org/TR/SVG/">SVG</a> capabilities, the <a
     * href="Graphic.html">`Graphic`</a> class will point to the `SVGGraphic` class.
     *
     * @module graphics
     * @class SVGGraphic
     * @constructor
