                                          ...
                                          prototype: {
                                              ...
                                              _delegateDOM: function () {
                                                  ...
                                                  boundingBox.delegate(
                                                      'mouseenter', A.bind(instance._onMouseEnterNodeEl, instance), '.'
                                                                                                                    + CSS_TREE_NODE_CONTENT);
                                                  boundingBox.delegate(
                                                      'mouseleave', A.bind(instance._onMouseLeaveNodeEl, instance), '.'
                                                                                                                    + CSS_TREE_NODE_CONTENT);
                                              },
                                              ...
                                              /**
                                               * Toggles the display of the 'A.TreeView' content (i.e. set the
                                               * select/unselect state).
                                               *
    ...
    var TreeViewDD = A.Component.create({
                                            ...
                                            prototype: {
                                                ...
                                                _updateNodeState: function (event) {
                                                    ...
                                                    if (!!dropTreeNode.get('draggable') && !dragNode.contains(
                                                        dropNode)) {
