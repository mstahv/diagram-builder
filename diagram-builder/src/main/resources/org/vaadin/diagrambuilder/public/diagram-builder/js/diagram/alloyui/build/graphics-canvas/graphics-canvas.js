YUI.add('graphics-canvas', function (Y, NAME) {
    ...
    /**
     * <a href="http://www.w3.org/TR/html5/the-canvas-element.html">Canvas</a> implementation of the <a
     * href="Drawing.html">`Drawing`</a> class.
     * `CanvasDrawing` is not intended to be used directly. Instead, use the <a href="Drawing.html">`Drawing`</a>
     * class.
     * If the browser lacks <a href="http://www.w3.org/TR/SVG/">SVG</a> capabilities but has
     * <a href="http://www.w3.org/TR/html5/the-canvas-element.html">Canvas</a> capabilities, the <a
     * href="Drawing.html">`Drawing`</a> class will point to the `CanvasDrawing` class.
     *
     * @module graphics
     * @class CanvasDrawing
     * @constructor
    ...
    CanvasDrawing.prototype = {
         ...
         * @param {Array} val An array containing data that can be parsed into a method and arguments. The value at
         *     zero-index of the array is a string reference of the drawing method that will be called. All subsequent
         *     indices are argument for that method. For example, `lineTo(10, 100)` would be structured as:
         * `["lineTo", 10, 100]`.
         * @private
         */
    ...
    Y.extend(CanvasShape, Y.GraphicBase, Y.mix({
                                                    ...
                                                    *
                                                    * @method _setGraphic
                                                    * @param {Graphic | Node | HTMLElement | String} render This param
                                                    *     is used to determine the graphic instance. If it is a
                                                    * `Graphic` instance, it will be assigned to the `graphic`
                                                    ...
                                                    *
                                                    * @method addClass
                                                    * @param {String} className the class name to add to the node's
                                                    *     class attribute
                                                    */
                                                   ...
                                                   /**
                                                    * Set the position of the shape in page coordinates, regardless of
                                                    * how the node is positioned.
                                                    *
                                                    * @method setXY
                                                    * @param {Array} Contains X & Y values for new position
                                                   ...
                                                   /**
                                                    * Determines whether the node is an ancestor of another HTML
                                                    * element in the DOM hierarchy.
                                                    *
                                                    * @method contains
                                                    * @param {CanvasShape | HTMLElement} needle The possible node or
                                                    *     descendent
                                                    * @return Boolean Whether or not this shape is the needle or its
                                                    *     ancestor.
                                                    */
                                                    ...
                                                    * @method compareTo
                                                    * @param {HTMLElement | Node} refNode The reference node to compare
                                                    *     to the node.
                                                   ...
                                                   /**
                                                    * Overrides default `on` method. Checks to see if its a dom
                                                    * interaction event. If so, return an event attached to the `node`
                                                   ...
                                                   _setStrokeProps: function (stroke) {
                                                       ...
                                                       if (stroke) {
                                                           ...
                                                           this._dashstyle =
                                                               (dashstyle && Y.Lang.isArray(dashstyle)
                                                                && dashstyle.length > 1) ? dashstyle : null;
                                                    ...
                                                    *
                                                    * @method set
                                                    * @param {String|Object} name The name of the attribute.
                                                    *     Alternatively, an object of key value pairs can be passed in
                                                    *     to set multiple attributes at once.
                                                    * @param {Any} value The value to set the attribute to. This value
                                                    *     is ignored if an object is received as the name param.
                                                    */
                                                   set: function () {
                                                       var host = this;
                                                   ...
                                                   /**
                                                    * Performs a translate on the y-coordinate. When translating x and
                                                    * y coordinates, use the `translate` method.
                                                    *
                                                    * @method translateY
                                                   ...
                                                   _addTransform: function (type, args) {
                                                       args = Y.Array(args);
                                                       this._transform =
                                                           Y_LANG.trim(this._transform + " " + type + "(" + args.join(
                                                               ", ") + ")");
                                                       args.unshift(type);
                                                   ...
                                                   _closePath: function () {
                                                       ...
                                                       if (this._methods) {
                                                           ...
                                                           for (i = 0; i < len; ++i) {
                                                               ...
                                                               args = methods[i];
                                                               argsLen =
                                                                   (args[0] === "quadraticCurveTo" || args[0]
                                                                    === "bezierCurveTo") ? args.length : 3;
                                                               for (j = 1; j < argsLen; ++j) {
                                                                   if (j % 2 === 0) {
                                                           ...
                                                           for (i = 0; i < len; ++i) {
                                                               ...
                                                               if (args && args.length > 0) {
                                                                   ...
                                                                   if (method) {
                                                                       ...
                                                                       else if (method && method === "lineTo"
                                                                                && this._dashstyle) {
                                                                           args.unshift(this._xcoords[i]
                                                                                        - this._left, this._ycoords[i]
                                                                                                      - this._top);
                                                    ...
                                                    * @param {Context} Reference to the context element of the canvas
                                                    *     instance.
                                                    * @private
                                                    */
                                                   ...
                                                   _drawDashedLine: function (xStart, yStart, xEnd, yEnd) {
                                                       ...
                                                       for (i = 0; i < segmentCount; ++i) {
                                                           ...
                                                           context.lineTo(xCurrent + Math.cos(radians)
                                                                          * dashsize, yCurrent + Math.sin(radians)
                                                                                      * dashsize);
                                                           xCurrent += xDelta;
                                                           yCurrent += yDelta;
                                                       }
                                                       ...
                                                       context.moveTo(xCurrent, yCurrent);
                                                       delta =
                                                           Math.sqrt((xEnd - xCurrent) * (xEnd - xCurrent) + (yEnd
                                                                                                              - yCurrent)
                                                                     * (yEnd - yCurrent));
                                                       ...
                                                       if (delta > dashsize) {
                                                           ...
                                                           context.lineTo(xCurrent + Math.cos(radians) * delta, yCurrent
                                                                                                                + Math.sin(
                                                                   radians) * delta);
                                                       }
                                                    ...
                                                    *
                                                    * Calculates the a new bounding box from the original corner
                                                    * coordinates (base on size and position) and the transform matrix.
                                                    * The calculated bounding box is used by the graphic instance to
                                                    * calculate its viewBox.
                                                    *
                                                    * @method getBounds
                                                    * @return Object
                                                    */
                                                   ...
                                                   _getContentRect: function (w, h, x, y) {
                                                       var transformOrigin = this.get("transformOrigin"),
                                                           ...
                                                           transforms = this.matrix.getTransformArray(
                                                               this.get("transform")),
                                                           matrix = new Y.Matrix(),
                                                           i,
    ...
    CanvasShape.ATTRS = {
        /**
         * An array of x, y values which indicates the transformOrigin in which to rotate the shape. Valid values range
         * between 0 and 1 representing a fraction of the shape's corresponding bounding box dimension. The default
         * value is [0.5, 0.5].
         *
        ...
        /**
         * <p>A string containing, in order, transform operations applied to the shape instance. The `transform` string
         ...
         *    </dl>
         * </p>
         * <p>Applying transforms through the transform attribute will reset the transform matrix and apply a new
         * transform. The shape class also contains corresponding methods for each transform that will apply the
         * transform to the current matrix. The below code illustrates how you might use the
         ...
         *      <dt>opacity</dt><dd>Number between 0 and 1 that indicates the opacity of the fill. The default value is
         * 1.</dd>
         ...
         *              <dt>opacity</dt><dd>Number between 0 and 1 that indicates the opacity of the stop. The default
         * value is 1. Note: No effect for IE 6 - 8</dd>
         *              <dt>offset</dt><dd>Number between 0 and 1 indicating where the color stop is positioned.</dd>
         *          </dl>
         *      </dd>
         *      <p>Linear gradients also have the following property:</p>
         *      <dt>rotation</dt><dd>Linear gradients flow left to right by default. The rotation property allows you
         * to change the flow by rotation. (e.g. A rotation of 180 would make the gradient pain from right to
         * left.)</dd>
         ...
         *  <dl>
         *      <dt>cx</dt><dd>
         *          <p>The x-coordinate of the center of the gradient circle. Determines where the color stop begins.
         * The default value 0.5.</p>
         *          <p><strong>Note: </strong>Currently, this property is not implemented for corresponding
         * `CanvasShape` and
         *          `VMLShape` classes which are used on Android or IE 6 - 8.</p>
         *      </dd>
         *      <dt>cy</dt><dd>
         *          <p>The y-coordinate of the center of the gradient circle. Determines where the color stop begins.
         * The default value 0.5.</p>
         *          <p><strong>Note: </strong>Currently, this property is not implemented for corresponding
         * `CanvasShape` and `VMLShape` classes which are used on Android or IE 6 - 8.</p>
         *      </dd>
         *  </dl>
         ...
         *      <dt>opacity</dt><dd>Number between 0 and 1 that indicates the opacity of the stroke. The default value
         * is 1.</dd>
         *      <dt>dashstyle</dt>Indicates whether to draw a dashed stroke. When set to "none", a solid stroke is
         * drawn. When set to an array, the first index indicates the length of the dash. The second index indicates
         * the length of gap.
         ...
         *              <dt>miter limit</dt><dd>An integer specifying the miter limit of a miter linejoin. If you want
         * to specify a linejoin of miter, you simply specify the limit as opposed to having separate miter and miter
         * limit values.</dd>
         *          </dl>
         *      </dd>
         *  </dl>
        ...
        /**
         * Represents an SVG Path string. This will be parsed and added to shape's API to represent the SVG data across
         * all implementations. Note that when using VML or SVG implementations, part of this content will be added to
         * the DOM using respective VML/SVG attributes. If your content comes from an untrusted source, you will need
    ...
    /**
     * <a href="http://www.w3.org/wiki/HTML/Elements/canvas">Canvas</a> implementation of the <a
     * href="Rect.html">`Rect`</a> class.
     * `CanvasRect` is not intended to be used directly. Instead, use the <a href="Rect.html">`Rect`</a> class.
     * If the browser lacks <a href="http://www.w3.org/TR/SVG/">SVG</a> capabilities but has
     * <a href="http://www.w3.org/wiki/HTML/Elements/canvas">Canvas</a> capabilities, the <a
     * href="Rect.html">`Rect`</a>
    ...
    /**
     * <a href="http://www.w3.org/TR/html5/the-canvas-element.html">Canvas</a> implementation of the <a
     * href="Ellipse.html">`Ellipse`</a> class.
     * `CanvasEllipse` is not intended to be used directly. Instead, use the <a href="Ellipse.html">`Ellipse`</a>
     * class.
     * If the browser lacks <a href="http://www.w3.org/TR/SVG/">SVG</a> capabilities but has
     * <a href="http://www.w3.org/TR/html5/the-canvas-element.html">Canvas</a> capabilities, the <a
     * href="Ellipse.html">`Ellipse`</a> class will point to the `CanvasEllipse` class.
     *
     * @module graphics
     * @class CanvasEllipse
     * @constructor
    ...
    /**
     * <a href="http://www.w3.org/TR/html5/the-canvas-element.html">Canvas</a> implementation of the <a
     * href="Circle.html">`Circle`</a> class.
     * `CanvasCircle` is not intended to be used directly. Instead, use the <a href="Circle.html">`Circle`</a> class.
     * If the browser lacks <a href="http://www.w3.org/TR/SVG/">SVG</a> capabilities but has
     * <a href="http://www.w3.org/TR/html5/the-canvas-element.html">Canvas</a> capabilities, the <a
     * href="Circle.html">`Circle`</a> class will point to the `CanvasCircle` class.
     *
     * @module graphics
     * @class CanvasCircle
     * @constructor
     ...
     * `CanvasGraphic` is not intended to be used directly. Instead, use the <a href="Graphic.html">`Graphic`</a>
     * class.
     * If the browser lacks <a href="http://www.w3.org/TR/SVG/">SVG</a> capabilities but has
     * <a href="http://www.w3.org/TR/html5/the-canvas-element.html">Canvas</a> capabilities, the <a
     * href="Graphic.html">`Graphic`</a> class will point to the `CanvasGraphic` class.
     *
     * @module graphics
     * @class CanvasGraphic
     * @constructor
    ...
    CanvasGraphic.ATTRS = {
        /**
         * Whether or not to render the `Graphic` automatically after to a specified parent node after init. This can
         * be a Node instance or a CSS selector string.
         *
         * @config render
         * @type Node | String
         */
        ...
        /**
         *  Object containing size and coordinate data for the content of a Graphic in relation to the graphic
         * instance's position.
         *
         ...
         *
         *  <dl>
         *      <dt>sizeContentToGraphic</dt><dd>The Graphic's width and height attributes are, either explicitly set
         * through the
         *      <code>width</code> and <code>height</code> attributes or are determined by the dimensions of the parent
         * element. The content contained in the Graphic will be sized to fit with in the Graphic instance's
         * dimensions. When using this setting, the <code>preserveAspectRatio</code> attribute will determine how the
         * contents are sized.</dd>
         *      <dt>sizeGraphicToContent</dt><dd>(Also accepts a value of true) The Graphic's width and height are
         * determined by the size and positioning of the content.</dd>
         *      <dt>false</dt><dd>The Graphic's width and height attributes are, either explicitly set through the
         * <code>width</code> and <code>height</code> attributes or are determined by the dimensions of the parent
         * element. The contents of the Graphic instance are not affected by this setting.</dd>
         *  </dl>
         *
         *
         *  @config autoSize
         ...
         *
         *  <dl>
         *      <dt>none<dt><dd>Do not force uniform scaling. Scale the graphic content of the given element
         * non-uniformly if necessary such that the element's bounding box exactly matches the viewport rectangle.</dd>
         *      <dt>xMinYMin</dt><dd>Force uniform scaling position along the top left of the Graphic's node.</dd>
         *      <dt>xMidYMin</dt><dd>Force uniform scaling horizontally centered and positioned at the top of the
         * Graphic's node.<dd>
         *      <dt>xMaxYMin</dt><dd>Force uniform scaling positioned horizontally from the right and vertically from
         * the top.</dd>
         *      <dt>xMinYMid</dt>Force uniform scaling positioned horizontally from the left and vertically
         * centered.</dd>
         *      <dt>xMidYMid (the default)</dt><dd>Force uniform scaling with the content centered.</dd>
         *      <dt>xMaxYMid</dt><dd>Force uniform scaling positioned horizontally from the right and vertically
         * centered.</dd>
         *      <dt>xMinYMax</dt><dd>Force uniform scaling positioned horizontally from the left and vertically from
         * the bottom.</dd>
         *      <dt>xMidYMax</dt><dd>Force uniform scaling horizontally centered and position vertically from the
         * bottom.</dd>
         *      <dt>xMaxYMax</dt><dd>Force uniform scaling positioned horizontally from the right and vertically from
         * the bottom.</dd>
         *  </dl>
         *
                    ...
                    if (preserveAspectRatio === "none") {
                        ...
                        if (contentWidth / contentHeight !== w / h) {
                            if (contentWidth * h / contentHeight > w) {
                                ...
                                translateY =
                                    this._calculateTranslate(preserveAspectRatio.slice(5).toLowerCase(), contentHeight
                                                                                                         * w
                                                                                                         / contentWidth,
                                                             h);
                            }
                                ...
                                translateX =
                                    this._calculateTranslate(preserveAspectRatio.slice(1, 4).toLowerCase(), contentWidth
                                                                                                            * h
                                                                                                            / contentHeight,
                                                             w);
                            }
