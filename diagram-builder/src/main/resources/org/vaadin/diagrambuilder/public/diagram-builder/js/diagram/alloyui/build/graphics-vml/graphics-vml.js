YUI.add('graphics-vml', function (Y, NAME) {
    ...
    /**
     * <a href="http://www.w3.org/TR/NOTE-VML">VML</a> implementation of the <a href="Drawing.html">`Drawing`</a>
     * class.
     * `VMLDrawing` is not intended to be used directly. Instead, use the <a href="Drawing.html">`Drawing`</a> class.
     * If the browser lacks <a href="http://www.w3.org/TR/SVG/">SVG</a> and <a
     * href="http://www.w3.org/TR/html5/the-canvas-element.html">Canvas</a> capabilities, the <a
     * href="Drawing.html">`Drawing`</a> class will point to the `VMLDrawing` class.
     *
     * @module graphics
     * @class VMLDrawing
     * @constructor
    ...
    VMLDrawing.prototype = {
        ...
        /**
         * Draws a line segment using the current line style from the current drawing position to the relative x and y
         * coordinates.
         *
     ...
     * If the browser lacks <a href="http://www.w3.org/TR/SVG/">SVG</a> and <a
     * href="http://www.w3.org/TR/html5/the-canvas-element.html">Canvas</a> capabilities, the <a
     * href="Shape.html">`Shape`</a> class will point to the `VMLShape` class.
     *
     * @module graphics
     * @class VMLShape
     * @constructor
    ...
    Y.extend(VMLShape, Y.GraphicBase, Y.mix({
                                                 ...
                                                 *
                                                 * @method _setGraphic
                                                 * @param {Graphic | Node | HTMLElement | String} render This param is
                                                 *     used to determine the graphic instance. If it is a
                                                 * `Graphic` instance, it will be assigned to the `graphic` attribute.
                                                 *     Otherwise, a new Graphic instance will be created and rendered
                                                 *     into the dom element that the render represents.
                                                 * @private
                                                 */
                                                ...
                                                createNode: function () {
                                                    ...
                                                    if (stroke && stroke.weight && stroke.weight > 0) {
                                                        ...
                                                        nodestring +=
                                                            ' stroked="t" strokecolor="' + stroke.color
                                                            + '" strokeWeight="' + stroke.weight + 'px"';
                                                 ...
                                                 *
                                                 * @method addClass
                                                 * @param {String} className the class name to add to the node's class
                                                 *     attribute
                                                 */
                                                 ...
                                                 *
                                                 * @method removeClass
                                                 * @param {String} className the class name to remove from the node's
                                                 *     class attribute
                                                 */
                                                ...
                                                /**
                                                 * Set the position of the shape in page coordinates, regardless of how
                                                 * the node is positioned.
                                                 *
                                                 * @method setXY
                                                 * @param {Array} Contains x & y values for new position (coordinates
                                                 *     are page-based)
                                                 *
                                                 */
                                                setXY: function (xy) {
                                                ...
                                                /**
                                                 * Determines whether the node is an ancestor of another HTML element
                                                 * in the DOM hierarchy.
                                                 *
                                                 * @method contains
                                                 * @param {VMLShape | HTMLElement} needle The possible node or
                                                 *     descendent
                                                 ...
                                                 * @method compareTo
                                                 * @param {HTMLElement | Node} refNode The reference node to compare to
                                                 *     the node.
                                                    ...
                                                    if (fill) {
                                                        ...
                                                        if (fill.type === "radial" || fill.type === "linear") {
                                                            ...
                                                            if (IS_NUM(fillOpacity)) {
                                                                ...
                                                                if (fillOpacity < 1) {
                                                                    props.node =
                                                                        '<fill xmlns="urn:schemas-microsft.com:vml"' +
                                                                        ' class="vmlfill" style="behavior:url(#default#VML);display:inline-block;"'
                                                                        +
                                                    ...
                                                    if (fill) {
                                                        if (fill.type === "radial" || fill.type === "linear") {
                                                            ...
                                                            if (IS_NUM(fillOpacity) && fillOpacity < 1) {
                                                                ...
                                                                if (this._fillNode) {
                                                                    if (this._fillNode.getAttribute("type")
                                                                        !== "solid") {
                                                ...
                                                /**
                                                 * Calculates and returns an object containing gradient properties for
                                                 * a fill node.
                                                 *
                                                ...
                                                _getGradientFill: function (fill) {
                                                    ...
                                                    if (type === "linear") {
                                                        ...
                                                        fx += cx;
                                                        fy += cy;
                                                        gradientProps.focussize =
                                                            (gradientBoxWidth / w) / 10 + "% " + (gradientBoxHeight / h)
                                                            / 10 + "%";
                                                        gradientProps.alignshape = false;
                                                        gradientProps.type = "gradientradial";
                                                        gradientProps.focus = "100%";
                                                        gradientProps.focusposition =
                                                ...
                                                _updateTransform: function () {
                                                    ...
                                                    if (this._transforms && this._transforms.length > 0) {
                                                        ...
                                                        //ensure the values are within the appropriate range to avoid
                                                        // errors
                                                        ...
                                                        for (i = 0; i < len; ++i) {
                                                            ...
                                                            if (key) {
                                                                normalizedMatrix[key].apply(normalizedMatrix,
                                                                                            this._transforms[i]);
                                                    ...
                                                    if (transform) {
                                                        ...
                                                        this._skew.on = true;
                                                        //this._skew.offset =
                                                        // this._getSkewOffsetValue(normalizedMatrix.dx) + "px, " +
                                                        // this._getSkewOffsetValue(normalizedMatrix.dy) + "px";
                                                    ...
                                                    node.style.left =
                                                        (x + this._getSkewOffsetValue(normalizedMatrix.dx)) + "px";
                                                    node.style.top =
                                                        (y + this._getSkewOffsetValue(normalizedMatrix.dy)) + "px";
                                                },
                                                ...
                                                /**
                                                 * Performs a translate on the y-coordinate. When translating x and y
                                                 * coordinates, use the `translate` method.
                                                 *
                                                 * @method translateY
                                                 ...
                                                 *     Alternatively, an object of key value pairs can be passed in to
                                                 *     set multiple attributes at once.
                                                 * @param {Any} value The value to set the attribute to. This value is
                                                 *     ignored if an object is received as the name param.
                                                 */
                                                set: function () {
                                                    var host = this;
     ...
     * If the browser lacks <a href="http://www.w3.org/TR/SVG/">SVG</a> and <a
     * href="http://www.w3.org/TR/html5/the-canvas-element.html">Canvas</a> capabilities, the <a
     * href="Path.html">`Path`</a> class will point to the `VMLPath` class.
     *
     * @module graphics
     * @class VMLPath
     * @extends VMLShape
     ...
     * If the browser lacks <a href="http://www.w3.org/TR/SVG/">SVG</a> and <a
     * href="http://www.w3.org/TR/html5/the-canvas-element.html">Canvas</a> capabilities, the <a
     * href="Rect.html">`Rect`</a> class will point to the `VMLRect` class.
     *
     * @module graphics
     * @class VMLRect
     * @constructor
    ...
    Y.VMLRect = VMLRect;
    /**
     * <a href="http://www.w3.org/TR/NOTE-VML">VML</a> implementation of the <a href="Ellipse.html">`Ellipse`</a>
     * class.
     * `VMLEllipse` is not intended to be used directly. Instead, use the <a href="Ellipse.html">`Ellipse`</a> class.
     * If the browser lacks <a href="http://www.w3.org/TR/SVG/">SVG</a> and <a
     * href="http://www.w3.org/TR/html5/the-canvas-element.html">Canvas</a> capabilities, the <a
     * href="Ellipse.html">`Ellipse`</a> class will point to the `VMLEllipse` class.
     *
     * @module graphics
     * @class VMLEllipse
     * @constructor
     ...
     * If the browser lacks <a href="http://www.w3.org/TR/SVG/">SVG</a> and <a
     * href="http://www.w3.org/TR/html5/the-canvas-element.html">Canvas</a> capabilities, the <a
     * href="Circle.html">`Circle`</a> class will point to the `VMLCircle` class.
     *
     * @module graphics
     * @class VMLCircle
     * @constructor
    ...
    /**
     * <a href="http://www.w3.org/TR/NOTE-VML">VML</a> implementation of the <a href="Graphic.html">`Graphic`</a>
     * class.
     * `VMLGraphic` is not intended to be used directly. Instead, use the <a href="Graphic.html">`Graphic`</a> class.
     * If the browser lacks <a href="http://www.w3.org/TR/SVG/">SVG</a> and <a
     * href="http://www.w3.org/TR/html5/the-canvas-element.html">Canvas</a> capabilities, the <a
     * href="Graphic.html">`Graphic`</a> class will point to the `VMLGraphic` class.
     *
     * @module graphics
     * @class VMLGraphic
     * @constructor
    ...
    Y.extend(VMLGraphic, Y.GraphicBase, {
                ...
                if (autoSize === "sizeContentToGraphic") {
                    ...
                    if (preserveAspectRatio === "none" || contentWidth / contentHeight === nodeWidth / nodeHeight) {
                        ...
                        if (contentWidth * nodeHeight / contentHeight > nodeWidth) {
                            ...
                            yCoordOrigin =
                                this._calculateCoordOrigin(preserveAspectRatio.slice(5).toLowerCase(), scaledHeight,
                                                           yCoordSize);
                            ...
                            xCoordOrigin =
                                this._calculateCoordOrigin(preserveAspectRatio.slice(1, 4).toLowerCase(), scaledWidth,
                                                           xCoordSize);
        ...
        /**
         * Determines the value for either an x or y coordinate to be used for the <code>coordOrigin</code> of the
         * Graphic.
         *
