        ...
        A.WidgetToggle
                                      ...
                                      _renderBoxClassNames: function () {
                                          ...
                                          var boundingBoxBuffer = (boundingBoxNodeClassName)
                                                                  ? boundingBoxNodeClassName.split(' ') : [];
                                          ...
                                          for (var i = classLength - 3; i >= 0; i--) {
                                              ...
                                              boundingBoxBuffer.push(classItem.CSS_PREFIX || _getClassName(
                                                  classItemName));
                                      ...
                                      _setRender: function (config) {
                                          ...
                                          if (render && render.constructor === _CONSTRUCTOR_OBJECT) {
                                              ...
                                              if (selector) {
                                                  ...
                                                  var renderInteraction = A.rbind(instance._renderInteraction, instance,
                                                                                  parentNode);
