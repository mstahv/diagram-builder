YUI.add('aui-rating-base', function (A, NAME) {
    ...
    var Rating = A.Component.create({
                                        ...
                                        prototype: {
                                            ...
                                            /**
                                             * Handle the keypress event. If the pressed key is Enter, fires
                                             * `itemClick` event, i.e. does the same as if the user has clicked with
                                             * the mouse.
                                             *
                                            ...
                                            _renderElements: function () {
                                                ...
                                                elements.each(
                                                    function (element, i) {
                                                        ...
                                                        if (!element.attr('href') && (element.get('nodeName')
                                                                                          .toLowerCase() === 'a')) {
