                ...
                Y.Base,
                {
                    ...
                    _bindHandle: function () {
                        ...
                        instance._eventHandles.push(
                            ...
                            wrapper.delegate('mouseenter', Y.bind(instance._onHandleMouseEnter, instance), DOT
                                                                                                           + CSS_RESIZE_HANDLE),
                            wrapper.delegate('mouseleave', Y.bind(instance._onHandleMouseLeave, instance), DOT
                                                                                                           + CSS_RESIZE_HANDLE)
                        );
                    },
                    ...
                    _checkSize: function (offset, size) {
                        ...
                        // predicting, based on the original information, the last left valid in case of reach the
                        // min/max dimension this calculation avoid browser event leaks when user interact very fast
                    ...
                    _getInfo: function (node, event) {
                        ...
                        if (event) {
                            // the xy that the node will be set to. Changing this will alter the position as it's
                            // dragged.
                    ...
                    _getBoxSurroundingInfo: function (node) {
                        ...
                        info.totalHPadding =
                            (toRoundNumber(info.padding.paddingLeft) + toRoundNumber(info.padding.paddingRight));
                        info.totalVBorder =
                            (toRoundNumber(info.border.borderBottomWidth) + toRoundNumber(info.border.borderTopWidth));
                        info.totalVPadding =
                            (toRoundNumber(info.padding.paddingBottom) + toRoundNumber(info.padding.paddingTop));
                    ...
                    /**
                     * Update <a href="Resize.html#property_info">info</a> values (bottom, actXY, left, top,
                     * offsetHeight, offsetWidth, right).
                     *
                     * @method _updateInfo
                     * @private
                     */
                    ...
                    /**
                     * Handles setting the activeHandle from a node, used from startDrag (for touch) and mouseenter
                     * (for mouse).
                     *
