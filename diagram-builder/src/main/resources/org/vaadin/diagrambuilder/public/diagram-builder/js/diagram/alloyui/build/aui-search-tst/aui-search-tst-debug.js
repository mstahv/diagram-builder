YUI.add('aui-search-tst', function (A, NAME) {
                                                   ...
                                                   prototype: {
                                                       ...
                                                       _insert: function (node, word, index) {
                                                           ...
                                                           if (Lang.isValue(node)) {
                                                               if (character === node.get('character')) {
                                                                   ...
                                                                   node.set('smallerNode',
                                                                            instance._insert(node.get('smallerNode'),
                                                                                             word, index));
                                                               }
                                                               else {
                                                                   node.set('largerNode',
                                                       ...
                                                       _patternMatch: function (node, pattern, index, results) {
                                                           ...
                                                           if (Lang.isValue(node)) {
                                                               ...
                                                               if (character === patternChar || character
                                                                   < nodeCharacter) {
                                                       ...
                                                       _search: function (node, word, index) {
                                                           ...
                                                           if (Lang.isValue(node)) {
                                                               ...
                                                               if (character === nodeCharacter) {
                                                                   ...
                                                                   result =
                                                                       instance._search(node.get('smallerNode'), word,
                                                                                        index);
                                                               }
                                                               else {
                                                                   result =
                                                                       instance._search(node.get('largerNode'), word,
                                                                                        index);
                                                               }
                                                           }
    ...
    var TernarySearchNode = A.Component.create({
                                                   ...
                                                   prototype: {
                                                       ...
                                                       /**
                                                        * Converts the `word` attribute value to a `Boolean` and
                                                        * ensures a
                                                        * `Boolean` type.
                                                        *
                                                        * @method isEndOfWord
                                                       ...
                                                       /**
                                                        * Checks if the argument is an instance of
                                                        * `A.TernarySearchNode`.
                                                        *
                                                       ...
                                                       /**
                                                        * Checks if the argument is a `String` and contains only one
                                                        * character.
                                                        *
