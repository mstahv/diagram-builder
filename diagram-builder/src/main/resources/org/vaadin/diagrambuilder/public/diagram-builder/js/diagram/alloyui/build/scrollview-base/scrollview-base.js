YUI.add('scrollview-base', function (Y, NAME) {
    ...
    var getClassName = Y.ClassNameManager.getClassName,
        ...
        vendorPrefix = Y.Transition._VENDOR_PREFIX, // Todo: This is a private property, and alternative approaches
    ...
    Y.ScrollView = Y.extend(ScrollView, Y.Widget, {
        ...
        /**
         * Flag driving whether or not we should try and force H/W acceleration when transforming. Currently enabled by
         * default for Webkit. Used by the _transform method.
         *
     ...
     * }
        ...
        _getScrollDims: function () {
            ...
            sv._forceHWTransforms = false; // the z translation was causing issues with picking up accurate
                                           // scrollWidths in Chrome/Mac.
            ...
            if (!flick) {
                ...
                if (gesture.deltaX !== null && gesture.deltaY !== null) {
                    ...
                    // Inbounds
                        ...
                        // Fire scrollEnd unless this is a paginated instance and the gesture axis is the same as
                        // paginator's Not totally confident this is ideal to access a plugin's properties from a host,
                        // @TODO revisit
        ...
        _isOutOfBounds: function (x, y) {
            ...
            return (svAxisX && (currentX < minX || currentX > maxX)) || (svAxisY && (currentY < minY || currentY
                                                                                     > maxY));
        },
        ...
        // End prototype properties
                                ...
                                ATTRS: {
                                    ...
                                    /**
                                     * Enable/Disable dragging the ScrollView content (note: flick support is
                                 ...
                                 * The configured property names are `_TRANSITION.DURATION` (e.g.
                                 * "WebkitTransitionDuration") and
                                 ...
                                 */
                                _TRANSITION: {
                                    DURATION: (vendorPrefix ? vendorPrefix + 'TransitionDuration'
                                                            : 'transitionDuration'),
                                    PROPERTY: (vendorPrefix ? vendorPrefix + 'TransitionProperty'
                                                            : 'transitionProperty')
                                },
