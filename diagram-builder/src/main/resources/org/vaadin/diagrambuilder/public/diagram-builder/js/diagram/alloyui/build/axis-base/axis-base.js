YUI.add('axis-base', function (Y, NAME) {
    ...
    Renderer.prototype = {
        ...
        _mergeStyles: function (a, b) {
            ...
            Y.Object.each(a, function (value, key) {
                if (b.hasOwnProperty(key) && Y_Lang.isObject(value) && !Y_Lang.isFunction(value) && !Y_Lang.isArray(
                    value)) {
    ...
    Y.AxisBase = Y.Base.create("axisBase", Y.Base, [Y.Renderer], {
        ...
        /**
         * Returns values based on key identifiers. When a string is passed as an argument, an array of values is
         * returned. When an array of keys is passed as an argument, an object literal with an array of values mapped
         * to each key is returned.
         *
         * @method getDataByKey
        ...
        _getSetMin: function () {
            return Y_Lang.isNumber(this._setMinimum);
                                   ...
                                   ATTRS: {
                                       /**
                                        * Determines whether and offset is automatically calculated for the edges of
                                        * the axis.
                                        *
