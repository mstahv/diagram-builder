                ...
                return (isFunction(fn)) ?
                       function (data) {
                           ...
                           if (isTimeout) {
                               ...
                               --self._requests[proxy];
                               Y.log(proxy + ' timed out - timeouts(' + self._timeouts[proxy] + ') failures('
                                     + self._failures[proxy] + ') requests(' + self._requests[proxy] + ')');
                           } else if (isFailure) {
                               ...
                               Y.log(proxy + ' failure - timeouts(' + self._timeouts[proxy] + ') failures('
                                     + self._failures[proxy] + ') requests(' + self._requests[proxy] + ')');
                           } else {
                               ...
                               --self[counter][proxy];
                               Y.log(proxy + ' response received - timeouts(' + self._timeouts[proxy] + ') failures('
                                     + self._failures[proxy] + ') requests(' + self._requests[proxy] + ')');
                           }
                           //}
