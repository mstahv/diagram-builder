YUI.add('aui-sortable-layout', function (A, NAME) {
    ...
    var SortableLayout = A.Component.create({
                                                ...
                                                ATTRS: {
                                                    ...
                                                    /**
                                                     * The CSS class name used to define which nodes serve as container
                                                     * to be dropped.
                                                     *
                                                     * @attribute dropNodes
                                                     */
                                                    ...
                                                    placeholder: {
                                                        ...
                                                        setter: function (val) {
                                                            ...
                                                            PLACEHOLDER_MARGIN_BOTTOM =
                                                                getNumStyle(placeholder, 'marginBottom');
                                                            PLACEHOLDER_MARGIN_TOP =
                                                                getNumStyle(placeholder, 'marginTop');

                                                            placeholder.addClass(CSS_DRAG_TARGET_INDICATOR);

                                                            PLACEHOLDER_TARGET_MARGIN_BOTTOM =
                                                                getNumStyle(placeholder, 'marginBottom');
                                                            PLACEHOLDER_TARGET_MARGIN_TOP =
                                                                getNumStyle(placeholder, 'marginTop');
                                                    ...
                                                    proxy: {
                                                        ...
                                                        setter: function (val) {
                                                            ...
                                                            // if proxyNode is set remove the border from the default
                                                            // proxy
                                                ...
                                                prototype: {
                                                    ...
                                                    /**
                                                     * Construction logic executed during `A.SortableLayout`
                                                    ...
                                                    /**
                                                     * Checks if the `Node` isn't a drop node. If not, creates a new
                                                     * Drop instance and adds to drop target group.
                                                     *
                                                     * @method addDropNode
                                                     * @param node
                                                     * @param config
                                                    ...
                                                    addDropNode: function (node, config) {
                                                        ...
                                                        if (!DDM.getDrop(node)) {
                                                            instance.addDropTarget(
                                                                ...
                                                                // this component, the ".drop" namespace is used to
                                                                // check for the DD.Delegate target nodes
                                                                new A.DD.Drop(
                                                                    A.merge({
                                                                                bubbleTargets: instance,
                                                                                groups: instance.get('groups'),
                                                    ...
                                                    getPlaceholderXY: function (region, isTarget) {
                                                        ...
                                                        if (isTarget) {
                                                            // update the margin values in case of the target
                                                            // placeholder has a different margin
                                                            marginBottom = PLACEHOLDER_TARGET_MARGIN_BOTTOM;
                                                            marginTop = PLACEHOLDER_TARGET_MARGIN_TOP;
                                                        }

                                                        // update the className of the placeholder when interact with
                                                        // target (drag/drop) elements
                                                        ...
                                                        var y = (instance.quadrant < 3) ?
                                                                (regionTop - (placeholder.get('offsetHeight')
                                                    ...
                                                    /**
                                                     * Checks if active drag and active drop satisfies the align
                                                     * condition.
                                                     *
                                                    ...
                                                    /**
                                                     * Creates `DD.Delegate` instance, plugs it to the `DDProxy`, and
                                                    ...
                                                    _bindDDEvents: function () {
                                                        ...
                                                        instance.on('drag:enter',
                                                                    A.bind(instance._onDragEnter, instance));
                                                        instance.on('drag:exit',
                                                                    A.bind(instance._onDragExit, instance));
                                                        instance.on('drag:over',
                                                                    A.bind(instance._onDragOver, instance));
                                                        instance.on('drag:start',
                                                                    A.bind(instance._onDragStart, instance));
                                                        instance.after('drag:start',
                                                                       A.bind(instance._afterDragStart, instance));
                                                    ...
                                                    _defPlaceholderAlign: function () {
                                                        ...
                                                        if (activeDrop && placeholder) {
                                                            ...
                                                            // DD.Delegate use the Drop Plugin on its "target" items.
                                                            // Using Drop Plugin a "node.drop" namespace is created.
                                                            // Using the .drop namespace to detect when the node is
                                                    ...
                                                    /**
                                                     * Gets a collection formed by `drag`, `drop`, `quadrant`,
                                                     * `XDirection`, and `YDirection` instances.
                                                     *
                                                     * @method _evOutput
                                                     * @protected
                                                     * @return {Object}
                                                    ...
                                                    _fireQuadrantEvents: function () {
                                                        ...
                                                        if (quadrant !== lastQuadrant) {
                                                            // only trigger exit if it has previously entered in any
                                                            // quadrant
                                                            if (lastQuadrant) {
                                                    ...
                                                    _positionNode: function () {
                                                        ...
                                                        if (activeDrop) {
                                                            ...
                                                            // detects if the activeDrop is a dd target (portlet) or a
                                                            // drop area only (column) DD.Delegate use the Drop Plugin
                                                            // on its "target" items. Using Drop Plugin a "node.drop"
                                                            // namespace is created. Using the .drop namespace to
                                                            // detect when the node is also a "target" DD.Delegate node
                                                            var isTarget = isValue(dropNode.drop);
                                                            var topQuadrants = (instance.quadrant < 3);

                                                            if (instance._alignCondition()) {
                                                                if (isTarget) {
                                                                    dropNode[topQuadrants ? 'placeBefore'
                                                                                          : 'placeAfter'](dragNode);
                                                                }
                                                                // interacting with the columns (drop areas only)
                                                                else {
                                                                    // find the dropContainer of the dropNode, the
                                                                    // default DROP_CONTAINER function returns the
                                                                    // dropNode
                                                                    var dropContainer = instance.get('dropContainer')
                                                                        .apply(instance, [dropNode]);

                                                                    dropContainer[topQuadrants ? 'prepend' : 'append'](
                                                                        dragNode);
                                                                }
                                                            }
                                                        }
                                                    ...
                                                    _onDragEnter: function (event) {
                                                        ...
                                                        // the checking for lastActiveDrop prevents fire the
                                                        // _syncPlaceholderUI when quadrant* events fires
                                                        ...
                                                        // lastActiveDrop is always updated by the drag exit, but if
                                                        // there is no lastActiveDrop update it on drag enter update it
