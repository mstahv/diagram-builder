...
if (!__coverage__['build/series-marker/series-marker.js']) {
    __coverage__['build/series-marker/series-marker.js'] =
        {
            ...
            "fnMap": {
                ...
                "2": {
                    "name": "(anonymous_2)",
                    "line": 30,
                    "loc": {"start": {"line": 30, "column": 16}, "end": {"line": 31, "column": 4}}
                }
            },
            "statementMap": {
                "1": {"start": {"line": 1, "column": 0}, "end": {"line": 89, "column": 72}},
                "2": {"start": {"line": 20, "column": 0}, "end": {"line": 85, "column": 3}},
                "3": {"start": {"line": 32, "column": 8}, "end": {"line": 35, "column": 9}},
                "4": {"start": {"line": 34, "column": 12}, "end": {"line": 34, "column": 31}},
                "5": {"start": {"line": 36, "column": 8}, "end": {"line": 36, "column": 43}},
                "6": {"start": {"line": 37, "column": 8}, "end": {"line": 37, "column": 99}}
            },
            "branchMap": {
                "1": {
                    "line": 32,
            ...
            "code": ["(function () { YUI.add('series-marker', function (Y, NAME) {", "", "/**",
                     " * Provides functionality for creating a marker series.", " *", " * @module charts",
                     " * @submodule series-marker", " */", "/**",
                     " * The MarkerSeries class renders quantitative data by plotting relevant data points",
                     " * on a graph.", " *", " * @class MarkerSeries", " * @extends CartesianSeries", " * @uses Plots",
                     ...
                     "         * @attribute type", "         * @type String", "         * @default marker",
                     "         */", "        type: {", "            value:\"marker\"", "        }", "", "        /**",
...
__cov_uNO8E1nYHnWykqyvxhjPcQ.s['1']++;
YUI.add('series-marker', function (Y, NAME) {
    __cov_uNO8E1nYHnWykqyvxhjPcQ.f['1']++;
    __cov_uNO8E1nYHnWykqyvxhjPcQ.s['2']++;
    Y.MarkerSeries = Y.Base.create('markerSeries', Y.CartesianSeries, [Y.Plots], {
        _setStyles: function (val) {
            __cov_uNO8E1nYHnWykqyvxhjPcQ.f['2']++;
            __cov_uNO8E1nYHnWykqyvxhjPcQ.s['3']++;
            if (!val.marker) {
                __cov_uNO8E1nYHnWykqyvxhjPcQ.b['1'][0]++;
                __cov_uNO8E1nYHnWykqyvxhjPcQ.s['4']++;
                val = {marker: val};
            } else {
                __cov_uNO8E1nYHnWykqyvxhjPcQ.b['1'][1]++;
            }
            __cov_uNO8E1nYHnWykqyvxhjPcQ.s['5']++;
            val = this._parseMarkerStyles(val);
            __cov_uNO8E1nYHnWykqyvxhjPcQ.s['6']++;
            return Y.MarkerSeries.superclass._mergeStyles.apply(this, [val, this._getDefaultStyles()]);
        }
    }, {ATTRS: {type: {value: 'marker'}}});
}, 'patched-v3.18.1', {'requires': ['series-cartesian', 'series-plot-util']});
