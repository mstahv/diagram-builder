YUI.add('aui-datatable-date-cell-editor', function (A, NAME) {
    ...
    DateCellEditor = A.Component.create({
                                            ...
                                            ATTRS: {
                                                ...
                                                /**
                                                 * Defines the `A.Calendar` object used for the `A.DateCellEditor`
                                                 * input.
                                                 *
                                                 * @attribute calendar
                                                 * @default null
                                                ...
                                                outputFormatter: {
                                                    value: function (val) {
                                                        ...
                                                        A.Array.each(val, function (date) {
                                                            values.push(
                                                                A.DataType.Date.parse(instance.get('dateFormat'),
                                                                                      date));
                                                        });
                                            ...
                                            prototype: {
                                                ELEMENT_TEMPLATE: '<input class="' + CSS_CELLEDITOR_ELEMENT
                                                                  + '" type="hidden" />',
                                                ...
                                                _afterDateSelect: function () {
                                                    ...
                                                    instance.elements.val(
                                                        A.Array.invoke(selectedDates, 'getTime').join(','));
                                                },
                                                ...
                                                _syncElementsFocus: function () {
                                                    ...
                                                    A.DateCellEditor.superclass._syncElementsFocus.apply(instance,
                                                                                                         arguments);
