        ...
        _uploadComplete: function (o, c) {
            ...
            try {
                if (b) {
                    ...
                    Y.log('The responseText value for transaction ' + o.id + ' is: ' + o.c.responseText + '.', 'info',
                                                                                                               'io');
                }
                else {
            ...
            return {
                ...
                abort: function () {
                    ...
                    if (Y.one('#io_iframe' + o.id)) {
                        ...
                        Y.log('Attempted to abort transaction ' + o.id + ' but transaction has completed.', 'warn',
                                                                                                            'io');
                        return false;
                    }
                },
