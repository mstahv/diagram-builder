    ...
    Y.mix(DtKeyNav.prototype, {
        ...
        _keyMoveFirst: function () {
            this.set('focusedCell',
                     (this.get('keyIntoHeaders') ? this._keyNavTHead.one('th') : this._tbodyNode.one('td')),
                     {src: 'keyNav'});
        },
        ...
        _keyMoveColTop: function (e) {
            ...
            if (this._keyNavNestedHeaders && this.get('keyIntoHeaders')) {
                ...
                cell =
                    (this.get('keyIntoHeaders') ? this._keyNavTHead : this._tbodyNode).get('firstChild').get('cells')
                        .item(cellIndex);
            }
            this.set('focusedCell', cell, {src: 'keyNav'});
        },
