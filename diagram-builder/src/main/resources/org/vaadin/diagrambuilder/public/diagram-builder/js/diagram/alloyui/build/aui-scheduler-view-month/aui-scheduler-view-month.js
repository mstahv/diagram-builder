YUI.add('aui-scheduler-view-month', function (A, NAME) {
    ...
    var SchedulerMonthView = A.Component.create({
                                                    ...
                                                    prototype: {
                                                        ...
                                                        /**
                                                         * Returns a date value of the first day of the month with its
                                                         * time adjusted to midnight.
                                                         *
                                                        ...
                                                        /**
                                                         * Returns the value of the date that follows the month view's
                                                         * current date.
                                                         *
                                                         * @method getNextDate
                                                         * @return {Date}
                                                        ...
                                                        /**
                                                         * Returns the value of the date that preceeds the month view's
                                                         * current date.
                                                         *
                                                         * @method getPrevDate
                                                         * @return {Date}
                                                        ...
                                                        plotEvents: function () {
                                                            ...
                                                            colTitleNodes.each(function (colTitleNode, index) {
                                                                ...
                                                                if (DateMath.before(celDate, monthStart)
                                                                    || DateMath.after(celDate, monthEnd)) {
                                                        ...
                                                        /**
                                                         * Returns the current interval start by finding the first day
                                                         * of the week with the `Scheduler`'s `viewDate`.
                                                         *
                                                         * @method _findCurrentIntervalStart
                                                         * @protected
                                                         * @return {Date} The current interval start from the first day
                                                         *     of the week with the `Scheduler`'s `viewDate`.
                                                         */
