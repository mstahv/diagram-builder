...
// http://jquery.bassistance.de/validate/
    ...
    var FormValidator = A.Component.create({
                                               ...
                                               prototype: {
                                                   ...
                                                   /**
                                                    * Construction logic executed during `A.FormValidator`
                                                   ...
                                                   getFieldErrorMessage: function (field, rule) {
                                                       ...
                                                       var message = (fieldStrings[rule] || strings[rule]
                                                                      || strings.DEFAULT);
                                                   ...
                                                   normalizeRuleValue: function (ruleValue, field) {
                                                       ...
                                                       return isFunction(ruleValue) ? ruleValue.apply(instance, [field])
                                                                                    : ruleValue;
                                                   },
                                                   ...
                                                   printStackError: function (field, container, errors) {
                                                       ...
                                                       A.Array.each(
                                                           errors,
                                                           function (error) {
                                                               var message = instance.getFieldErrorMessage(field,
                                                                                                           error),
                                                   ...
                                                   validatable: function (field) {
                                                       ...
                                                       if (fieldRules) {
                                                           validatable =
                                                               ...
                                                               ||
                                                               defaults.RULES.hasValue.apply(instance,
                                                                                             [field.val(), field]);
                                                       }
                                                   ...
                                                   _defValidateFieldFn: function (event) {
                                                       ...
                                                       A.each(
                                                           ...
                                                           function (ruleValue, ruleName) {
                                                               ...
                                                               ruleValue =
                                                                   instance.normalizeRuleValue(ruleValue, field);

                                                               if (isFunction(rule) && !rule.apply(instance,
                                                                                                   [fieldValue, field,
                                                                                                    ruleValue])) {
