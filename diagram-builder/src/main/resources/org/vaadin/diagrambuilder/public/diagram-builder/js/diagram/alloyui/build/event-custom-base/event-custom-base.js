...
// var onsubscribeType = "_event:onsub",
    ...
    Y.CustomEvent.prototype = {
         ...
         * @param [args] {Array} bound arguments that will be passed to the callback after the arguments generated by
         *     fire()
     ...
     *      });
        ...
        on: function (type, fn, context) {
            ...
            if (!handle) {
                ...
                handle =
                    ce._on(fn, context, (arguments.length > 3) ? nativeSlice.call(arguments, 3) : null,
                           (after) ? 'after' : true);
         ...
         * @param eventType {String|CustomEvent} The prefixed name of the event being monitored, or the CustomEvent
         *     object.
