YUI.add('aui-scheduler-base', function (A, NAME) {
    ...
    var SchedulerEvent = A.Component.create({
                                                ...
                                                ATTRS: {
                                                    ...
                                                    /**
                                                     * Determines whether a new event will take place all day. When
                                                     * enabled, the event will not contain 24-hour clock date inputs.
                                                     *
                                                     * @attribute allDay
                                                     * @default false
                                                     * @type {Boolean}
                                                    ...
                                                    /**
                                                     * Contains the formatted title date for this scheduler event,
                                                     * taking into account ISO time. The value will not contain an
                                                     * `endDate` if this event is `allDay`.
                                                     *
                                                    ...
                                                    titleDateFormat: {
                                                        ...
                                                        value: function () {
                                                            var instance = this,
                                                                ...
                                                                isoTime = scheduler && scheduler.get('activeView')
                                                                    .get('isoTime'),

                                                                format = {
                                                                    endDate: TPL_HTML_OPEN_SPAN + '&ndash;' + ' '
                                                                             + '%H:%M' + TPL_HTML_CLOSE_SPAN,
                                                                    startDate: '%H:%M'
                                                                };

                                                            if (!isoTime) {
                                                                format.endDate =
                                                                    TPL_HTML_OPEN_SPAN + '&ndash;' + ' '
                                                                    + getUSDateFormat(instance.get('endDate')) +
                                                                    TPL_HTML_CLOSE_SPAN;
                                                                format.startDate =
                                                                    getUSDateFormat(instance.get('startDate'));
                                                            }
                                                    ...
                                                    node: {
                                                        valueFn: function () {
                                                            return A.NodeList.create(
                                                                A.Node.create(this.EVENT_NODE_TEMPLATE)
                                                    ...
                                                    /**
                                                     * Contains the date corresponding to the current starting date of
                                                     * a
                                                     * scheduled event. By default, the value is the date set on the
                                                     * user's computer.
                                                     *
                                                     * @attribute startDate
                                                     * @type {Date}
                                                 ...
                                                 * @static
                                                 */
                                                PROPAGATE_ATTRS: ['allDay', 'startDate', 'endDate', 'content', 'color',
                                                                  'colorBrightnessFactor',
                                                                  'colorSaturationFactor', 'titleDateFormat', 'visible',
                                                                  'disabled'],
                                                ...
                                                prototype: {
                                                    EVENT_NODE_TEMPLATE: '<div class="' + CSS_SCHEDULER_EVENT + '">'
                                                                         ...
                                                                         '"></div>' + '<div class="'
                                                                         + CSS_SCHEDULER_EVENT_CONTENT + '"></div>' +
                                                                         '<div class="' + CSS_SCHEDULER_EVENT_ICONS
                                                                         + '">' + '<span class="' + [
                                                                             CSS_ICON,
                                                                             CSS_SCHEDULER_EVENT_ICON_DISABLED].join(
                                                        ' ') + '"></span>' + '<span class="' + [CSS_ICON,
                                                                                                CSS_SCHEDULER_EVENT_ICON_MEETING].join(
                                                        ' ') + '"></span>' + '<span class="' + [CSS_ICON,
                                                                                                CSS_SCHEDULER_EVENT_ICON_REMINDER].join(
                                                        ' ') + '"></span>' + '<span class="' + [CSS_ICON,
                                                                                                CSS_SCHEDULER_EVENT_ICON_REPEATED].join(
                                                        ' ') + '"></span>' + '</div>' + '</div>',

                                                    /**
                                                     * Construction logic executed during `SchedulerEvent`
                                                    ...
                                                    /**
                                                     * Destructor lifecycle implementation for the `SchedulerEvent`
                                                     * class. Removes the `node` from DOM.
                                                     *
                                                     * @method destroy
                                                     * @protected
                                                     */
                                                     ...
                                                     * behavior of the scheduler `event`'s `node`. This can occur in
                                                     * the
                                                     * week view when an event spans multiple days.
                                                     * For example, an event beginning at 10pm on January 1 and ending
                                                     * on
                                                     * 3am January 2nd would require a padding node. The `event`'s
                                                     * `node` appears from January 1 from 10:00pm to 11:59pm and the
                                                     * `paddingNode` is rendered on the table from January 2 from
                                                     * 12:00am to 3:00am.
                                                     *
                                                    ...
                                                    addPaddingNode: function () {
                                                        ...
                                                        instance.get('node').push(
                                                            A.Node.create(instance.EVENT_NODE_TEMPLATE)
                                                                .setData('scheduler-event', instance));
                                                    ...
                                                    /**
                                                     * Copies the dates from the `event` parameter to the instance
                                                     * `event`.
                                                     *
                                                     * @method copyDates
                                                    ...
                                                    copyDates: function (evt, options) {
                                                        ...
                                                        instance.setAttrs({
                                                                              endDate: DateMath.clone(
                                                                                  evt.get('endDate')),
                                                                              startDate: DateMath.clone(
                                                                                  evt.get('startDate'))
                                                                          },
                                                                          options);
                                                    },
                                                    ...
                                                    /**
                                                     * Copies the propagate attribute vales from an `event` to this
                                                     * `event`.
                                                     *
                                                    ...
                                                    copyPropagateAttrValues: function (evt, dontCopyMap, options) {
                                                        ...
                                                        A.Array.each(instance.constructor.PROPAGATE_ATTRS,
                                                                     function (attrName) {
                                                                         if (!((dontCopyMap || {}).hasOwnProperty(
                                                                             attrName))) {
                                                    ...
                                                    sameEndDate: function (evt) {
                                                        ...
                                                        return DateMath.compare(instance.get('endDate'),
                                                                                evt.get('endDate'));
                                                    },

                                                    /**
                                                     * Determines if an `event`'s start date is this same as this
                                                     * `event`.
                                                     *
                                                    ...
                                                    intersectHours: function (evt) {
                                                        ...
                                                        return (DateMath.compare(startDate, evtModifiedStartDate) ||
                                                                DateMath.between(evtModifiedStartDate, startDate,
                                                                                 endDate));
                                                    },

                                                    /**
                                                     * Determines if a this `event` starts or ends at the beginning or
                                                     * end of a day.
                                                     *
                                                    ...
                                                    /**
                                                     * Clears the time fields from the `endDate`, effectively setting
                                                     * the time to 12 noon.
                                                     *
                                                    ...
                                                    /**
                                                     * Clears the time fields from the `startDate`, effectively setting
                                                     * the time to 12 noon.
                                                     *
                                                    ...
                                                    move: function (date, options) {
                                                        ...
                                                        instance.setAttrs({
                                                                              endDate: DateMath.add(
                                                                                  DateMath.clone(date),
                                                                                  DateMath.MINUTES, duration),
                                                                              startDate: date
                                                                          },
                                                                          options);
                                                    },
                                                    ...
                                                    setContent: function (content) {
                                                        ...
                                                        instance.get('node').each(function (node) {
                                                            var contentNode = node.one('.'
                                                                                       + CSS_SCHEDULER_EVENT_CONTENT);
                                                    ...
                                                    /**
                                                     * Splits an event into multiple days. Since an event can span
                                                     * across multiple days in the week view, this event will be split
                                                     * into chunks for each day column.
                                                     *
                                                     * @method split
                                                     * @return {Array}
                                                     */
                                                    split: function () {
                                                        ...
                                                        if (instance.isDayOverlapEvent()
                                                            && !instance.isDayBoundaryEvent()) {
                                                            var s2 = DateMath.clone(s1);
                                                            s2.setHours(24, 0, 0, 0);

                                                            return [[s1, DateMath.toMidnight(DateMath.clone(s1))],
                                                                [s2, DateMath.clone(e1)]];
                                                        }
                                                    ...
                                                    _uiSetAllDay: function (val) {
                                                        ...
                                                        instance.get('node')
                                                            .toggleClass(CSS_SCHEDULER_EVENT_ALL_DAY, !!val);
                                                    },
                                                    ...
                                                    _uiSetColor: function (val) {
                                                        ...
                                                        backgroundColor =
                                                            Color.fromArray(backgroundColor, Color.TYPES.HSL);
                                                    ...
                                                    _uiSetDisabled: function (val) {
                                                        ...
                                                        instance.get('node')
                                                            .toggleClass(CSS_SCHEDULER_EVENT_DISABLED, !!val);
                                                    },
                                                    ...
                                                    _uiSetEndDate: function () {
                                                        ...
                                                        instance.get('node').toggleClass(
                                                            CSS_SCHEDULER_EVENT_SHORT, instance.getMinutesDuration()
                                                                                       <= 30);
                                                    },
                                                    ...
                                                    _uiSetMeeting: function (val) {
                                                        ...
                                                        instance.get('node')
                                                            .toggleClass(CSS_SCHEDULER_EVENT_MEETING, !!val);
                                                    },
                                                    ...
                                                    _uiSetPast: function (val) {
                                                        ...
                                                        instance.get('node')
                                                            .toggleClass(CSS_SCHEDULER_EVENT_PAST, !!val);
                                                    },
                                                    ...
                                                    _uiSetReminder: function (val) {
                                                        ...
                                                        instance.get('node')
                                                            .toggleClass(CSS_SCHEDULER_EVENT_REMINDER, !!val);
                                                    },
                                                    ...
                                                    _uiSetRepeated: function (val) {
                                                        ...
                                                        instance.get('node')
                                                            .toggleClass(CSS_SCHEDULER_EVENT_REPEATED, !!val);
                                                    },
                                                    ...
                                                    _uiSetVisible: function (val) {
                                                        ...
                                                        instance.get('node')
                                                            .toggleClass(CSS_SCHEDULER_EVENT_HIDDEN, !val);
                                                    }
                                                }
                                            });
                                              ...
                                              ATTRS: {
                                                  ...
                                                  color: {
                                                      valueFn: function () {
                                                          ...
                                                          var randomIndex = Math.ceil(Math.random() * palette.length)
                                                                            - 1;
                                                   ...
                                                   */
                                                  palette: {
                                                      value: ['#d93636', '#e63973', '#b22eb3', '#6e36d9', '#2d70b3',
                                                              '#376cd9', '#25998c', '#249960',
                                                              '#24992e', '#6b9926', '#999926', '#a68f29', '#b3782d',
                                                              '#bf6030', '#bf6060', '#997399', '#617181',
                                                              '#6b7a99', '#548c85', '#747446', '#997e5c', '#b34d1b',
                                                              '#993d48', '#802d70'],
                                                      validator: isArray
                                                  },
    ...
    var CSS_SCHEDULER_VIEW_ = A.getClassName('scheduler-base', 'view', ''),
        ...
        TPL_SCHEDULER_ICON_NEXT = '<button aria-label="{ariaLabel}"" role="button" type="button" class="'
                                  + [CSS_SCHEDULER_ICON_NEXT, CSS_BTN,
                                     CSS_BTN_DEFAULT].join(' ') + '"><span class="' + [CSS_ICON,
                                                                                       CSS_ICON_CHEVRON_RIGHT].join(' ')
                                  + '"></span></button>',
        TPL_SCHEDULER_ICON_PREV = '<button aria-label="{ariaLabel}"" role="button" type="button" class="'
                                  + [CSS_SCHEDULER_ICON_PREV, CSS_BTN,
                                     CSS_BTN_DEFAULT].join(' ') + '"><span class="' + [CSS_ICON,
                                                                                       CSS_ICON_CHEVRON_LEFT].join(' ')
                                  + '"></span></button>',
        ...
        TPL_SCHEDULER_VIEW_BUTTON = '<button aria-label="{ariaLabel}" aria-pressed="false" type="button" class="hidden-xs '
                                    +
                                    [CSS_SCHEDULER_VIEW, CSS_SCHEDULER_VIEW_].join(' ')
    ...
    var SchedulerBase = A.Component.create({
                                               ...
                                               ATTRS: {
                                                    ...
                                                    * @default { agenda: 'View Agenda', day: 'View by Day', month:
                                                    *     'View by Month', next: 'Go to Next', previous: 'Go to
                                                    *     Previous', today: 'Go to Today', week: 'View by Week' }
                                                    * @type {Object}
                                                    */
                                                   ariaLabels: {
                                                       value: {
                                                   ...
                                                   /**
                                                    * Contains a function to call a callback with a date object. The
                                                    * date should represent the current time.
                                                    *
                                                    ...
                                                    * @default { descendants: 'button', keys: { next: 'down:39',
                                                    *     previous:
         *     'down:37' }, circular: false }
                                                   ...
                                                   /**
                                                    * Contains the collection of strings used to label elements of the
                                                    * UI.
                                                    *
                                                    * @attribute strings
                                                    * @type {Object}
                                                   ...
                                                   /**
                                                    * If the model items should be lazily loaded through pagination or
                                                    * not.
                                                    *
                                                   ...
                                                   /**
                                                    * Contains the `Scheduler`'s current date. If there is an
                                                    * `activeView`, this attribute will contain the `activeView`'s
                                                    * current date.
                                                    *
                                                    * @attribute viewDate
                                                    * @type {Date}
         ...
         */
                                                   ...
                                                   /**
                                                    * Contains the node that displays `Scheduler`'s current date in the
                                                    * `SchedulerView`. This node is only visible on mobile.
                                                    *
                                                   ...
                                                   /**
                                                    * Contains the node that goes to the previous date in the
                                                    * `activeView`.
                                                    *
                                                   ...
                                                   /**
                                                    * Contains the node that displays `Scheduler`'s current date in
                                                    * `Scheduler`'s header. This node is hidden on mobile.
                                                    *
                                                   ...
                                                   /**
                                                    * Contains the node container that holds the nodes to change
                                                    * `Scheduler`'s
                                                    * `activeView`.
                                                    *
                                                    * @attribute viewsNode
                                               ...
                                               prototype: {
                                                   ...
                                                   getViewTriggerNode: function (view) {
                                                       ...
                                                       if (viewportWidth >= 768) {
                                                           return instance.viewsNode.one('.' + CSS_SCHEDULER_VIEW_
                                                                                         + name);
                                                       }
                                                    ...
                                                    * instances as a property `instance.buttonGroup`. It is rendered
                                                    * under the `Scheduler` instance's `viewsNode`.
                                                    *
                                                           ...
                                                           instance.buttonGroup = new A.ButtonGroup({
                                                                                                        ...
                                                                                                        on: {
                                                                                                            selectionChange: A.bind(
                                                                                                                instance._onButtonGroupSelectionChange,
                                                                                                                instance)
                                                                                                        }
                                                                                                    }).render();
                                                       }
                                                   ...
                                                   /**
                                                    * Renders a dropdown list under the `Scheduler` instance's
                                                    * `viewsNode`.
                                                    *
                                                   ...
                                                   renderDropdownList: function () {
                                                       ...
                                                       instance.viewsSelectNode.on('change',
                                                                                   A.bind(instance._onSelectionChange,
                                                                                          instance));
                                                   },
                                                   ...
                                                   _bindDelegate: function () {
                                                       ...
                                                       instance.controlsNode.delegate('click',
                                                                                      instance._onClickPrevIcon, '.'
                                                                                                                 + CSS_SCHEDULER_ICON_PREV,
                                                                                      instance);
                                                       instance.controlsNode.delegate('click',
                                                                                      instance._onClickNextIcon, '.'
                                                                                                                 + CSS_SCHEDULER_ICON_NEXT,
                                                                                      instance);
                                                       instance.controlsNode.delegate('click',
                                                                                      instance._onClickToday, '.'
                                                                                                              + CSS_SCHEDULER_TODAY,
                                                                                      instance);
                                                   },
                                                   ...
                                                   _onButtonGroupSelectionChange: function (event) {
                                                       ...
                                                       instance.viewsSelectNode.one('[data-view-name=' + viewName + ']')
                                                           .set('selected', true);
                                                   ...
                                                   _onSelectionChange: function (event) {
                                                       var instance = this,
                                                           ...
                                                           viewName = target.get('options').item(index)
                                                               .attr('data-view-name');
                                                    ...
                                                    * nodes.
                                                    *
                                                    * The scheduler can display its events in many views - day view,
                                                    * week view etc. These views are selected through a set of buttons
                                                    * at the top left of the scheduler (if it is being viewed in
                                                    * desktop mode) or from a select (if it is being viewed from a
                                                    * mobile device). This method checks which views the scheduler is
                                                    * expected to render, and adds elements both options (i.e. adds
                                                    * buttons to the button group and options to the select).
                                                    *
                                                   ...
                                                   _populateViewNodes: function () {
                                                       ...
                                                       A.Array.each(views, function (view) {
                                                           instance.viewsSelectNode.append(
                                                               instance._createViewTriggerNode(view,
                                                                                               TPL_SCHEDULER_VIEW_LIST));
                                                           instance.viewsNode.append(
                                                               instance._createViewTriggerNode(view,
                                                                                               TPL_SCHEDULER_VIEW_BUTTON));
                                                       });
                                                   },
                                                   ...
                                                   _plugFocusManager: function () {
                                                       ...
                                                       instance.viewsNode.plug(A.Plugin.NodeFocusManager,
                                                                               this.get('focusmanager'));
                                                       instance.navNode.plug(A.Plugin.NodeFocusManager,
                                                                             this.get('focusmanager'));
                                                   },
                                                   ...
                                                   /**
                                                    * Replaces this `SchedulerBase`'s `views` with the given `views`
                                                    * value.
                                                    *
                                                    * @method _setViews
                                                   ...
                                                   _uiSetActiveView: function (val) {
                                                       ...
                                                       if (val) {
                                                           var activeView = val.get('name'),
                                                               activeNav = instance.viewsNode.one('.'
                                                                                                  + CSS_SCHEDULER_VIEW_
                                                                                                  + activeView);

                                                           if (activeNav) {
                                                               instance.viewsNode.all('button')
                                                                   .removeClass(CSS_SCHEDULER_VIEW_SELECTED)
                                                                   .setAttribute('aria-pressed', false);
                                                               instance.viewsSelectNode.one('[data-view-name='
                                                                                            + activeView + ']')
                                                                   .set('selected', true);
    ...
    var SchedulerView = A.Component.create({
                                               ...
                                               prototype: {
                                                   ...
                                                   getDateInterval: function () {
                                                       return {
                                                           endDate: DateMath.toLastHour(
                                                               DateMath.subtract(this.getNextDate(), DateMath.DAY, 1)),
                                                           startDate: this.getAdjustedViewDate(
                                                               this.get('scheduler').get('viewDate'))
                                                       };
                                                   },
                                                   ...
                                                   /**
                                                    * Returns a clone of a given `date` that will adjust to the
                                                    * `maxDate` if it occurs after `maxDate`.
                                                    *
                                                    * @method limitDate
                                                    * @param {Date} date
                                                    * @param {Date} maxDate
                                                   ...
                                                   /**
                                                    * Syncs the UI according to the value of the `initialScroll`
                                                    * attribute.
                                                    *
                                                   ...
                                                   _afterBasePlotEvents: function () {
                                                       ...
                                                       if (initialScroll !== false && this.get('rendered') && this.get(
                                                           'visible') && !this._scrollDone) {
                                                           this.scrollToDate(
                                                               initialScroll === true ? new Date() : initialScroll);
                                                   ...
                                                   _setScheduler: function (val) {
                                                       ...
                                                       if (val) {
                                                           ...
                                                           val.after(['*:add', '*:remove', '*:reset'],
                                                                     A.bind(instance.flushViewCache, instance));
                                                       }
