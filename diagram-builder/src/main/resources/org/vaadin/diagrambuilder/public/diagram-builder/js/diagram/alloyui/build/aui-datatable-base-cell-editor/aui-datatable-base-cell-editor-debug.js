                                            ...
                                            prototype: {
                                                ...
                                                _initEvents: function () {
                                                    ...
                                                    instance.after({
                                                                       ...
                                                                       visibleChange: A.debounce(
                                                                           instance._debounceVisibleChange, 350,
                                                                           instance)
                                                                   });

                                                    instance.on({
                                                                    'form-validator:submit': A.bind(instance._onSubmit,
                                                                                                    instance)
                                                                });
                                                },
                                                ...
                                                /**
                                                 * Default callback for the `cancel` event. Hides the
                                                 * `A.BaseCellEditor`.
                                                 *
                                                 * @method _defCancelFn
                                                    ...
                                                    if (event.newVal) {
                                                        if (!hDocEscKey) {
                                                            instance._hDocEscKeyEv =
                                                                A.getDoc()
                                                                    .on('key', A.bind(instance._onEscKey, instance),
                                                                        'down:27');
                                                        }

                                                        if (!hDocMouseDown) {
                                                            instance._hDocMouseDownEv =
                                                                A.getDoc().on('mousedown',
                                                                              A.bind(instance._onDocMouseDownExt,
                                                                                     instance));
                                                        }
                                                    }
                                                    else {
                                                                ...
                                                                [
                                                                    {
                                                                        ...
                                                                        on: {
                                                                            click: A.bind(instance._handleEditEvent,
                                                                                          instance)
                                                                        }
                                                                    }
                                                                ], 1
