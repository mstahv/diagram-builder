YUI.add('series-cartesian', function (Y, NAME) {
    ...
    Y.CartesianSeries = Y.Base.create("cartesianSeries", Y.SeriesBase, [], {
         ...
         * If the input data is an array, an array is returned. If the input data is an object, an object will be
         * returned.
         *
         * @method _getCoords
         ...
         */
                                          ...
                                          ATTRS: {
                                              /**
                                               * An array of all series of the same type used within a chart
                                               * application.
                                               *
                                              ...
                                              categoryDisplayName: {
                                                  ...
                                                  getter: function () {
                                                      return this.get("direction") === "vertical" ? this.get(
                                                          "yDisplayName") : this.get("xDisplayName");
                                                  },
                                              ...
                                              valueDisplayName: {
                                                  ...
                                                  getter: function () {
                                                      return this.get("direction") === "vertical" ? this.get(
                                                          "xDisplayName") : this.get("yDisplayName");
                                                  },
                                              ...
                                              /**
                                               * Collection of area maps along the xAxis. Used to determine mouseover
                                               * for multiple series.
                                               *
                                              ...
                                              /**
                                               * Collection of area maps along the yAxis. Used to determine mouseover
                                               * for multiple series.
                                               *
                                              ...
                                              /**
                                               * Distance from a data coordinate to the left/right for setting a
                                               * hotspot.
                                               *
                                              ...
                                              /**
                                               * Distance from a data coordinate to the top/bottom for setting a
                                               * hotspot.
                                               *
