                                                           ...
                                                           prototype: {
                                                               FIELD_ITEM_TEMPLATE: '<li class="'
                                                                   ...
                                                                   ' ') +
                                                                                    ' {iconClass}"></span>'
                                                                                    + '<div class="'
                                                                                    + CSS_PROPERTY_BUILDER_FIELD_LABEL
                                                                                    + '"></div>' + '</li>',

                                                               /**
                                                                * Construction logic executed during
                                                                * `A.PropertyBuilderAvailableField` instantiation.
                                                                * Lifecycle.
                                                                *
                                                                * @method initializer
                                                                * @protected
                                                               ...
                                                               initializer: function () {
                                                                   ...
                                                                   instance.labelNode =
                                                                       node.one('.' + CSS_PROPERTY_BUILDER_FIELD_LABEL);
                                                                ...
                                                                */
                                                               _setId: function (val) {
                                                                   return A.PropertyBuilderAvailableField.buildNodeId(
                                                                       val);
                                                               },
                                                               ...
                                                               _uiSetDraggable: function (val) {
                                                                   ...
                                                                   instance.get('node').toggleClass(
                                                                       CSS_PROPERTY_BUILDER_FIELD_DRAGGABLE, val);
                                                               },
