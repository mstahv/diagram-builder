YUI.add('axis', function (Y, NAME) {
    ...
    RightAxisLayout.prototype = {
        ...
        setCalculatedSize: function () {
            var host = this,
                ...
                totalTitleSize = this._totalTitleSize,
                ttl = Math.round(host.get("rightTickOffset") + host._maxLabelSize + totalTitleSize
    ...
    BottomAxisLayout.prototype = {
        ...
        setCalculatedSize: function () {
            var host = this,
                ...
                labelStyle = styles.label,
                totalTitleSize = host._totalTitleSize,
                ttl = Math.round(host.get("bottomTickOffset") + host._maxLabelSize + labelStyle.margin.top
                                 + totalTitleSize);
    ...
    /**
     * An abstract class that provides the core functionality for draw a chart axis. Axis is used by the following
     * classes:
     * <ul>
    ...
    Y.Axis = Y.Base.create("axis", Y.Widget, [Y.AxisBase], {
                ...
                if (len < 1) {
                    ...
                    for (i = 0; i < len; i = i + 1) {
                        ...
                        if (point) {
                            ...
                            this.get("appendLabelFunction")(label, labelFunction.apply(labelFunctionScope,
                                                                                       [labelValues[i], labelFormat]));
        ...
        _rotate: function (label, props) {
            ...
            if (DOCUMENT.createElementNS) {
                ...
                if (Y_Lang.isNumber(textAlpha) && textAlpha < 1 && textAlpha > -1 && !isNaN(textAlpha)) {
                    filterString =
                        "progid:DXImageTransform.Microsoft.Alpha(Opacity=" + Math.round(textAlpha * 100) + ")";
                }
                if (rot !== 0) {
                    ...
                    matrix.translate(x, y);
                    this._simulateRotateWithTransformOrigin(matrix, rot, transformOrigin, props.labelWidth,
                                                            props.labelHeight);
                    if (filterString) {
                        filterString += " ";
                    }
        ...
        _getLabelBounds: function (val) {
            ...
            label = this.getLabel(labelStyles);
            this.get("appendLabelFunction")(label,
                                            this.get("labelFunction").apply(this, [val, this.get("labelFormat")]));
            ...
            this._simulateRotateWithTransformOrigin(matrix, props.rot, props.transformOrigin, props.labelWidth,
                                                    props.labelHeight);
        ...
        getMaximumValue: function () {
            return this.get("maximum");
                               ...
                               ATTRS:
                                   {
                                       /**
                                        * When set, defines the width of a vertical axis instance. By default, vertical
                                        * axes automatically size based on their contents. When the width attribute is
                                        * set, the axis will not calculate its width. When the width attribute is
                                        * explicitly set, axis labels will postion themselves off of the the inner edge
                                        * of the axis and the title, if present, will position itself off of the outer
                                        * edge. If a specified width is less than the sum of the axis' contents, excess
                                       ...
                                       /**
                                        * When set, defines the height of a horizontal axis instance. By default,
                                        * horizontal axes automatically size based on their contents. When the height
                                        * attribute is set, the axis will not calculate its height. When the height
                                        * attribute is explicitly set, axis labels will postion themselves off of the
                                        * the inner edge of the axis and the title, if present, will position itself
                                        * off of the outer edge. If a specified height is less than the sum of the
                                        * axis' contents, excess content will overflow.
                                        *
                                        * @attribute height
                                        * @type Number
                                        */
                                       ...
                                       /**
                                        * Calculated value of an axis' width. By default, the value is used internally
                                        * for vertical axes. If the `width` attribute is explicitly set, this value
                                        * will be ignored.
                                        *
                                       ...
                                       /**
                                        * Calculated value of an axis' height. By default, the value is used internally
                                        * for horizontal axes. If the `height` attribute is explicitly set, this value
                                        * will be ignored.
                                        *
                                       ...
                                       /**
                                        * Distance determined by the tick styles used to calculate the distance between
                                        * the axis line in relation to the top of the axis.
                                        *
                                       ...
                                       /**
                                        * Distance determined by the tick styles used to calculate the distance between
                                        * the axis line in relation to the bottom of the axis.
                                        *
                                       ...
                                       /**
                                        * Distance determined by the tick styles used to calculate the distance between
                                        * the axis line in relation to the left of the axis.
                                        *
                                       ...
                                       /**
                                        * Distance determined by the tick styles used to calculate the distance between
                                        * the axis line in relation to the right side of the axis.
                                        *
                                       ...
                                       /**
                                        * Indicates whether the axis overlaps the graph. If an axis is the inner most
                                        * axis on a given position and the tick position is inside or cross, the axis
                                        * will need to overlap the graph.
                                        *
                                       ...
                                       /**
                                        * Length in pixels of largest text bounding box. Used to calculate the height
                                        * of the axis.
                                        *
                                       ...
                                       /**
                                        *  Title for the axis. When specified, the title will display. The position of
                                        * the title is determined by the axis position.
                                        *  <dl>
                                        *      <dt>top</dt><dd>Appears above the axis and it labels. The default
                                        * rotation is 0.</dd>
                                        *      <dt>right</dt><dd>Appears to the right of the axis and its labels. The
                                        * default rotation is 90.</dd>
                                        *      <dt>bottom</dt><dd>Appears below the axis and its labels. The default
                                        * rotation is 0.</dd>
                                        *      <dt>left</dt><dd>Appears to the left of the axis and its labels. The
                                        * default rotation is -90.</dd>
                                        *  </dl>
                                        *
                                        *  @attribute title
                                       ...
                                       /**
                                        * Function used to append an axis value to an axis label. This function has the
                                        * following signature:
                                        *  <dl>
                                        *      <dt>textField</dt><dd>The axis label to be appended.
                                        * (`HTMLElement`)</dd>
                                        *      <dt>val</dt><dd>The value to attach to the text field. This method will
                                        * accept an `HTMLELement` or a `String`. This method does not use
                                        * (`HTMLElement` | `String`)</dd>
                                        *  </dl>
                                        * The default method appends a value to the `HTMLElement` using the
                                        * `appendChild` method. If the given value is a `String`, the method will
                                        * convert the the value to a `textNode` before appending to the
                                        * `HTMLElement`. This method will not convert an `HTMLString` to an
                                        * `HTMLElement`.
                                        *
                                       ...
                                       /**
                                        * Function used to append a title value to the title object. This function has
                                        * the following signature:
                                        *  <dl>
                                        *      <dt>textField</dt><dd>The title text field to be appended.
                                        * (`HTMLElement`)</dd>
                                        *      <dt>val</dt><dd>The value to attach to the text field. This method will
                                        * accept an `HTMLELement` or a `String`. This method does not use
                                        * (`HTMLElement` | `String`)</dd>
                                        ...
                                        * `appendChild` method. If the given value is a `String`, the method will
                                        * convert the the value to a `textNode` before appending to the
                                        * `HTMLElement` element. This method will not convert an `HTMLString` to an
                                        * `HTMLElement`.
                                        *
                                       ...
                                       /**
                                        * An array containing the unformatted values of the axis labels. By default,
                                        * TimeAxis, NumericAxis and StackedAxis labelValues are determined by the
                                        * majorUnit style. By default, CategoryAxis labels are determined by the values
                                        * of the dataProvider.
                                        * <p>When the labelValues attribute is explicitly set, the labelValues are
                                        * dictated by the set value and the position of ticks and labels are determined
                                        * by where those values would fall on the axis. </p>
                                        *
                                       ...
                                       /**
                                        * Style properties used for drawing an axis. This attribute is inherited from
                                        * `Renderer`. Below are the default values:
                                        *  <dl>
                                        *      <dt>majorTicks</dt><dd>Properties used for drawing ticks.
                                        *          <dl>
                                        *              <dt>display</dt><dd>Position of the tick. Possible values are
                                        * `inside`, `outside`, `cross` and `none`. The default value is `inside`.</dd>
                                        *              <dt>length</dt><dd>The length (in pixels) of the tick. The
                                        * default value is 4.</dd>
                                        *              <dt>color</dt><dd>The color of the tick. The default value is
                                        * `#dad8c9`</dd>
                                        *              <dt>weight</dt><dd>Number indicating the width of the tick. The
                                        * default value is 1.</dd>
                                        *              <dt>alpha</dt><dd>Number from 0 to 1 indicating the opacity of
                                        * the tick. The default value is 1.</dd>
                                        *          </dl>
                                        *      </dd>
                                        *      <dt>line</dt><dd>Properties used for drawing the axis line.
                                        *          <dl>
                                        *              <dt>weight</dt><dd>Number indicating the width of the axis line.
                                        * The default value is 1.</dd>
                                        *              <dt>color</dt><dd>The color of the axis line. The default value
                                        * is `#dad8c9`.</dd>
                                        *              <dt>alpha</dt><dd>Number from 0 to 1 indicating the opacity of
                                        * the tick. The default value is 1.</dd>
                                        *          </dl>
                                        *      </dd>
                                        *      <dt>majorUnit</dt><dd>Properties used to calculate the `majorUnit` for
                                        * the axis.
                                        *          <dl>
                                        *              <dt>determinant</dt><dd>The algorithm used for calculating
                                        * distance between ticks. The possible options are
                                        *              `count` and `distance`. If the `determinant` is `count`, the
                                        * axis ticks will spaced so that a specified number of ticks appear on the
                                        * axis. If the `determinant` is `distance`, the axis ticks will spaced out
                                        * according to the specified distance. The default value is `count`.</dd>
                                        *              <dt>count</dt><dd>Number of ticks to appear on the axis when the
                                        * `determinant` is `count`. The default value is 11.</dd>
                                        *              <dt>distance</dt><dd>The distance (in pixels) between ticks when
                                        * the `determinant` is `distance`. The default value is 75.</dd>
                                        *          </dl>
                                        *      </dd>
                                        *      <dt>label</dt><dd>Properties and styles applied to the axis labels.
                                        *          <dl>
                                        *              <dt>color</dt><dd>The color of the labels. The default value is
                                        * `#808080`.</dd>
                                        *              <dt>alpha</dt><dd>Number between 0 and 1 indicating the opacity
                                        * of the labels. The default value is 1.</dd>
                                        *              <dt>fontSize</dt><dd>The font-size of the labels. The default
                                        * value is 85%</dd>
                                        *              <dt>rotation</dt><dd>The rotation, in degrees (between -90 and
                                        * 90) of the labels. The default value is 0.</dd>
                                        *              <dt>offset</td><dd>A number between 0 and 1 indicating the
                                        * relationship of the label to a tick. For a horizontal axis label, a value of
                                        * 0 will position the label's left side even to the the tick. A position of 1
                                        * would position the right side of the label with the tick. A position of 0.5
                                        * would center the label horizontally with the tick. For a vertical axis, a
                                        * value of 0 would position the top of the label with the tick, a value of 1
                                        * would position the bottom of the label with the tick and a value 0 would
                                        * center the label vertically with the tick. The default value is 0.5.</dd>
                                        *              <dt>margin</dt><dd>The distance between the label and the
                                        * axis/tick. Depending on the position of the `Axis`, only one of the
                                        * properties used.
                                        *                  <dl>
                                        *                      <dt>top</dt><dd>Pixel value used for an axis with a
                                        * `position` of `bottom`. The default value is 4.</dd>
                                        *                      <dt>right</dt><dd>Pixel value used for an axis with a
                                        * `position` of `left`. The default value is 4.</dd>
                                        *                      <dt>bottom</dt><dd>Pixel value used for an axis with a
                                        * `position` of `top`. The default value is 4.</dd>
                                        *                      <dt>left</dt><dd>Pixel value used for an axis with a
                                        * `position` of `right`. The default value is 4.</dd>
                                        *                  </dl>
                                        *              </dd>
                                        *          </dl>
                                        *      </dd>
