YUI.add('dd-delegate', function (Y, NAME) {
    ...
    /**
     * Provides the ability to drag multiple nodes under a container element using only one Y.DD.Drag instance as a
     * delegate.
     * @module dd
        ...
        destructor: function () {
            ...
            Y.Array.each(this._handles, function (v) {
                v.detach();
                 ...
                 ATTRS: {
                     /**
                      * A selector query to get the container to listen for mousedown events on. All "nodes" should be
