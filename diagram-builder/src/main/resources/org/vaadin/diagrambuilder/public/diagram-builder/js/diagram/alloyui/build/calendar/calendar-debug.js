            ...
            switch (this.get("selectionMode")) {
                ...
                case("multiple"):
                    if (clickedCellIsDay) {
                        ...
                        } else if (((os === 'macintosh' && ev.metaKey) || (os !== 'macintosh' && ev.ctrlKey))
                                   && !ev.shiftKey) {
                            if (clickedCellIsSelected) {
                                this._removeDateFromSelection(this._nodeToDate(clickedCell));
                                this._lastSelectedDate = null;
        ...
        addYear: function (e) {
            ...
            return this;
                              ...
                              ATTRS: {
                                   ...
                                   *   <li>`multiple-sticky` - Multiple dates, selected one at a time (the dates
                                   * "stick"). This option is appropriate for mobile devices, where function keys from
                                   * the keyboard are not available.</li>
                                   *   <li>`multiple` - Multiple dates, selected with Ctrl/Meta keys for additional
                                   * single dates, and Shift key for date ranges.</li>
                                   *
                                  ...
                                  date: {
                                      ...
                                      setter: function (val) {
                                          ...
                                          if ((!minDate || ydate.isGreaterOrEqual(newDate, minDate)) &&
                                              ...
                                              return ydate.addMonths(this._normalizeDate(maxDate), 1
                                                                                                   - this._paneNumber);
                                          }
                                      }
                                  },
                                  ...
                                  /**
                                   * Unless minimumDate is null, it will not be possible to display and select dates
                                  ...
                                  /**
                                   * Unless maximumDate is null, it will not be possible to display and select dates
                                   * later than this one.
                                   *
                                  ...
                                  maximumDate: {
                                      ...
                                      setter: function (val) {
                                          if (Y.Lang.isDate(val)) {
                                              ...
                                              if (curDate && !ydate.isGreaterOrEqual(val, ydate.addMonths(
                                                  curDate, this._paneNumber - 1))) {
                                                  this.set('date', ydate.addMonths(this._normalizeDate(val), 1
                                                                                                             - this._paneNumber));
                                              }
