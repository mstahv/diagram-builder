        ...
        _getPlotDefaults: function () {
            ...
            return defs;
                                    ...
                                    ATTRS: {
                                         ...
                                         *          <dl>
                                         *              <dt>colors</dt><dd>An array of colors to be used for the marker
                                         * fills. The color for each marker  is retrieved from the array below:<br/>
                                         *              `["#66007f", "#a86f41", "#295454", "#996ab2", "#e8cdb7",
                                         * "#90bdbd","#000000","#c3b8ca", "#968373", "#678585"]`
                                         *              </dd>
                                         *              <dt>alphas</dt><dd>An array of alpha references (Number from 0
                                         * to 1) indicating the opacity of each marker fill. The default value is
                                         * [1].</dd>
                                         *          </dl>
                                         *      </dd>
                                         *      <dt>border</dt><dd>A hash containing the following values:
                                         *          <dl>
                                         *              <dt>color</dt><dd>An array of colors to be used for the marker
                                         * borders. The color for each marker is retrieved from the array below:<br/>
