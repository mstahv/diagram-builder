 ...
 *       });
    ...
    Y.Node.prototype.show = function (name, config, callback) {
        ...
        else if (name && !Y.Transition) {
            Y.log('unable to transition show; missing transition module', 'warn', 'node');
        }
        return this;
    };
    ...
    Y.Node.prototype.hide = function (name, config, callback) {
        if (name && Y.Transition) {
            ...
            Y.log('unable to transition hide; missing transition module', 'warn', 'node');
        } else {
            this._hide();
        }
        return this;
