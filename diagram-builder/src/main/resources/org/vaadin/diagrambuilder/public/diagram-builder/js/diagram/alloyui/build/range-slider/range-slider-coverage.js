...
if (!__coverage__['build/range-slider/range-slider.js']) {
    __coverage__['build/range-slider/range-slider.js'] =
        {
            ...
            "statementMap": {
                "1": {"start": {"line": 1, "column": 0}, "end": {"line": 28, "column": 87}},
                "2": {"start": {"line": 24, "column": 0}, "end": {"line": 25, "column": 46}}
            },
            "branchMap": {},
            "code": ["(function () { YUI.add('range-slider', function (Y, NAME) {", "", "/**",
                     " * Create a sliding value range input visualized as a draggable thumb on a",
                     " * background rail element.", " *", " * @module slider", " * @main slider",
                     ...
                     " * <code>axis</code> configuration.", " *", " * @class Slider", " * @constructor",
                     " * @extends SliderBase", " * @uses SliderValueRange", " * @uses ClickableRail",
...
__cov_YEVObAz5rR5pcGkNfVHtzA.s['1']++;
YUI.add('range-slider', function (Y, NAME) {
    __cov_YEVObAz5rR5pcGkNfVHtzA.f['1']++;
    __cov_YEVObAz5rR5pcGkNfVHtzA.s['2']++;
    Y.Slider = Y.Base.build('slider', Y.SliderBase, [Y.SliderValueRange, Y.ClickableRail]);
}, 'patched-v3.18.1', {'requires': ['slider-base', 'slider-value-range', 'clickable-rail']});
