...
//	avoid mistakenly interacting with the <iframe> shim.
    ...
    Y.extend(NodeMenuNav, Y.Plugin.Base, {
        ...
        initializer: function (config) {
            ...
            Y.log(
                "WARNING: Node-MenuNav is a deprecated module as of YUI 3.9.0. This module will be removed from a later version of the library.",
                "warn");
                    ...
                    if (nHashPos === 0 && nLen > 1) {
                        ...
                        if (oSubmenu && (oSubmenu.get(ID) === sId)) {
                            ...
                            if (sType === MOUSEDOWN || sType === KEYDOWN) {
                                ...
                                if ((UA.opera || UA.gecko || UA.ie) && sType === KEYDOWN
                                    && !menuNav._preventClickHandle) {
