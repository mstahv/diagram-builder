YUI.add('charts-legend', function (Y, NAME) {
    ...
    var TOP = "top",
        ...
        HorizontalLegendLayout = {
             ...
             * @protected
             */
            _positionLegendItems: function (items, maxWidth, maxHeight, totalWidth, totalHeight, padding, horizontalGap,
                                            verticalGap, hAlign) {
                var i = 0,
                    rowIterator = 0,
                    item,
                ...
                for (; rowIterator < rowsLen; ++rowIterator) {
                    ...
                    len = row.length;
                    legendWidth =
                        HorizontalLegendLayout.getStartPoint(width, totalWidthArray[rowIterator], hAlign, padding);
                    for (i = 0; i < len; ++i) {
                        item = row[i];
                        node = item.node;
        ...
        VerticalLegendLayout = {
            ...
            _positionLegendItems: function (items, maxWidth, maxHeight, totalWidth, totalHeight, padding, horizontalGap,
                ...
                for (; columnIterator < columnsLen; ++columnIterator) {
                    ...
                    len = column.length;
                    legendHeight =
                        VerticalLegendLayout.getStartPoint(height, totalHeightArray[columnIterator], vAlign, padding);
                    legendWidth = 0;
                    for (i = 0; i < len; ++i) {
                        item = column[i];
                        node = item.node;
                        ...
                        bottom =
                            !isNaN(bottom) ? Math.max(legendHeight + itemHeight, bottom) : legendHeight + itemHeight;
        ...
        CartesianChartLegend = Y.Base.create("cartesianChartLegend", Y.CartesianChart, [], {
            ...
            /**
             * Destructor implementation for the CartesianChart class. Calls destroy on all axes, series, legend (if
             * available) and the Graph instance. Removes the tooltip and overlay HTML elements.
             *
             * @method destructor
             * @protected
             */
    ...
    Y.ChartLegend = Y.Base.create("chartlegend", Y.Widget, [Y.Renderer], {
        ...
        _drawLegend: function () {
            ...
            if (chart instanceof Y.PieChart) {
                ...
                for (; i < len; ++i) {
                    ...
                    item =
                        this._getLegendItem(node, this._getShapeClass(shape), fill, border, labelStyles, markerWidth,
                                            markerHeight, displayName);
                    itemWidth = item.width;
                    itemHeight = item.height;
        ...
        /**
         * Retrieves the marker styles based on the type of series. For series that contain a marker, the marker styles
         * are returned.
         *
                ...
                if (backgroundGraphic) {
                    ...
                    background.destroy();
                                      ...
                                      ATTRS: {
                                          ...
                                          /**
                                           * Indicates the direction in relation of the legend's layout. The
                                           * `direction` of the legend is determined by its
                                           * `position` value.
                                           *
                                           * @attribute direction
                                           * @type String
                                          ...
                                          /**
                                           * Indicates the position and direction of the legend. Possible values are
                                           * `left`, `top`, `right` and `bottom`. Values of `left` and `right` values
                                           * have a `direction` of `vertical`. Values of `top` and `bottom` values have
                                          ...
                                          /**
                                           * The width of the legend. Depending on the implementation of the
                                           * ChartLegend, this value is `readOnly`. By default, the legend is included
                                           * in the layout of the `Chart` that it references. Under this circumstance,
                                           * `width` is always `readOnly`. When the legend is rendered in its own dom
                                           * element, the `readOnly` status is determined by the direction of the
                                           * legend. If the `position` is `left` or `right` or the `direction` is
                                           * `vertical`, width is `readOnly`. If the position is `top` or `bottom` or
                                           * the `direction` is `horizontal`, width can be explicitly set. If width is
                                           * not explicitly set, the width will be determined by the width of the
                                          ...
                                          /**
                                           * The height of the legend. Depending on the implementation of the
                                           * ChartLegend, this value is `readOnly`. By default, the legend is included
                                           * in the layout of the `Chart` that it references. Under this circumstance,
                                           * `height` is always `readOnly`. When the legend is rendered in its own dom
                                           * element, the `readOnly` status is determined by the direction of the
                                           * legend. If the `position` is `top` or `bottom` or the `direction` is
                                           * `horizontal`, height is `readOnly`. If the position is `left` or `right`
                                           * or the `direction` is `vertical`, height can be explicitly set. If height
                                           * is not explicitly set, the height will be determined by the width of the
                                           * legend's parent element.
                                           *
                                           * @attribute height
                                           * @type Number
                                          ...
                                          /**
                                           * Array of items contained in the legend. Each item is an object containing
                                          ...
                                          /**
                                           * Properties used to display and style the ChartLegend.  This attribute is
                                           * inherited from `Renderer`. Below are the default values:
                                           *
                                           *  <dl>
                                           *      <dt>gap</dt><dd>Distance, in pixels, between the `ChartLegend`
                                           * instance and the chart's content. When `ChartLegend` is rendered within a
                                           * `Chart` instance this value is applied.</dd>
                                           *      <dt>hAlign</dt><dd>Defines the horizontal alignment of the `items` in
                                           * a `ChartLegend` rendered in a horizontal direction. This value is applied
                                           * when the instance's `position` is set to top or bottom. This attribute can
                                           * be set to left, center or right. The default value is center.</dd>
                                           *      <dt>vAlign</dt><dd>Defines the vertical alignment of the `items` in a
                                           * `ChartLegend` rendered in vertical direction. This value is applied when
                                           * the instance's `position` is set to left or right. The attribute can be
                                           * set to top, middle or bottom. The default value is middle.</dd>
                                           *      <dt>item</dt><dd>Set of style properties applied to the `items` of
                                           * the `ChartLegend`.
                                           *          <dl>
                                           *              <dt>hSpacing</dt><dd>Horizontal distance, in pixels, between
                                           * legend `items`.</dd>
                                           *              <dt>vSpacing</dt><dd>Vertical distance, in pixels, between
                                           * legend `items`.</dd>
                                           *              <dt>label</dt><dd>Properties for the text of an `item`.
                                           *                  <dl>
                                           *                      <dt>color</dt><dd>Color of the text. The default
                                           * values is "#808080".</dd>
                                           *                      <dt>fontSize</dt><dd>Font size for the text. The
                                           * default value is "85%".</dd>
                                           *                  </dl>
                                           *              </dd>
                                           *              <dt>marker</dt><dd>Properties for the `item` markers.
                                           *                  <dl>
                                           *                      <dt>width</dt><dd>Specifies the width of the
                                           * markers.</dd>
                                           *                      <dt>height</dt><dd>Specifies the height of the
                                           * markers.</dd>
                                           *                  </dl>
                                           *              </dd>
                                           *          </dl>
                                           ...
                                           *                  <dl>
                                           *                      <dt>color</dt><dd>Color for the fill. The default
                                           * value is "#faf9f2".</dd>
                                           *                  </dl>
                                           *              </dd>
                                           *              <dt>border</dt><dd>Properties for the background border.
                                           *                  <dl>
                                           *                      <dt>color</dt><dd>Color for the border. The default
                                           * value is "#dad8c9".</dd>
                                           *                      <dt>weight</dt><dd>Weight of the border. The default
                                           * values is 1.</dd>
                                           *                  </dl>
                                           *              </dd>
                                           *          </dl>
