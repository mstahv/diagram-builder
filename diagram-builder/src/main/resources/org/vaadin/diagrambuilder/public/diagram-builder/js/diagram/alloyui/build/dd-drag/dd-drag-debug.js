YUI.add('dd-drag', function (Y, NAME) {
    ...
    Drag.ATTRS = {
        ...
        /**
         * If this is false, the drag element will not move with the cursor: default true. Can be used to "resize" the
         * element.
         * @attribute move
         * @type Boolean
         */
        ...
        /**
         * Config option is set by Drag to inform you of which handle fired the drag event (in the case that there are
         * several handles): default false.
        ...
        /**
         * This attribute is not meant to be used by the implementor, it is meant to be used as an Event tracker so you
         * can listen for it to change.
         * @attribute dragging
         * @type Boolean
         */
        dragging: {
        ...
        /**
         * This attribute only works if the dd-drop module has been loaded. It will make this node a drop target as
         * well as draggable.
         * @attribute target
         * @type Boolean
         */
        ...
        /**
         * This attribute only works if the dd-drop module is active. It will set the dragMode (point, intersect,
         * strict) of this Drag instance.
         * @attribute dragMode
         * @type String
         */
        dragMode: {
        ...
        /**
         * Array of valid handles to add. Adding something here will set all handles, even if previously added with
         * addHandle
         * @attribute handles
         * @type Array
         */
        ...
        /**
         * Controls the default bubble parent for this Drag instance. Default: Y.DD.DDM. Set to false to disable
         * bubbling. Use bubbleTargets in config
         * @deprecated
         * @attribute bubbles
         * @type Object
         */
    ...
    Y.extend(Drag, Y.Base, {
        ...
        /**
         * This will be a reference to the Drop instance associated with this drag if the target: true config attribute
         * is set..
         * @property target
         * @type {Object}
         */
        ...
        _invalids: null,
        /**
         * A private hash of the default invalid selector strings: {'textarea': true, 'input': true, 'a': true,
        ...
        /**
         * We will hold a copy of the current "onselectstart" method on this property, and reset it after we are done
         * using it.
         * @private
        ...
        /**
         * Method will forcefully stop a drag operation. For example calling this from inside an ESC keypress handler
         * will stop this drag.
         * @method stopDrag
         * @chainable
         */
