YUI.add('datatype-date-format', function (Y, NAME) {
    ...
    var Dt = {
         ...
         *   <dd>
         *   <p>
         *   Any strftime string is supported, such as "%I:%M:%S %p". strftime has several format specifiers defined by
         *     the Open group at
         *   <a
         *     href="http://www.opengroup.org/onlinepubs/007908799/xsh/strftime.html">http://www.opengroup.org/onlinepubs/007908799/xsh/strftime.html</a>
         *     PHP added a few of its own, defined at <a
         *     href="http://www.php.net/strftime">http://www.php.net/strftime</a>
         *   </p>
         *   <p>
         ...
         *  <dt>%e</dt> <dd>day of the month as a decimal number, a single digit is preceded by a space (range " 1" to
         *     "31")</dd>
         ...
         *  <dt>%k</dt> <dd>hour as a decimal number using a 24-hour clock (range 0 to 23); single digits are preceded
         *     by a blank. (See also %H.)</dd>
         *  <dt>%l</dt> <dd>hour as a decimal number using a 12-hour clock (range 1 to 12); single digits are preceded
         *     by a blank. (See also %I.) </dd>
         *  <dt>%m</dt> <dd>month as a decimal number (range 01 to 12)</dd>
         *  <dt>%M</dt> <dd>minute as a decimal number</dd>
         *  <dt>%n</dt> <dd>newline character</dd>
         *  <dt>%p</dt> <dd>either "AM" or "PM" according to the given time value, or the corresponding strings for the
         *     current locale</dd>
        ...
        format: function (oDate, oConfig) {
            ...
            var replace_formats = function (m0, m1) {
                ...
                switch (Y.Lang.type(f)) {
                    ...
                    default:
                        Y.log("unrecognised replacement type, please file a bug (format: " + oConfig.format + ")",
                            "WARN", "date");
                        return m1;
                }
            };
