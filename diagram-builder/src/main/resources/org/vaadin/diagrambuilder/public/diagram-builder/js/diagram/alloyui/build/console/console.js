    ...
    Y.Console = Y.extend(Console, Y.Widget,
                         ...
                         // Y.Console prototype
                         {
                             ...
                             initializer: function () {
                                  ...
                                  *
                                  * @event entry
                                  * @param event {EventFacade} An Event Facade object with the following attribute
                                  *     specific properties added:
                                  *  <dl>
                                  *      <dt>message</dt>
                                  *          <dd>The message data normalized into an object literal (see
                                  *     _normalizeMessage)</dd>
                                  *  </dl>
                             ...
                             _encodeHTML: function (s) {
                                 return isString(s) ?
                                        s.replace(RE_AMP, ESC_AMP).replace(RE_LT, ESC_LT).replace(RE_GT, ESC_GT) :
                                        s;
                             },
